...
public final class SdoR2UiConstantSmallClaim {
    ...
    public static final String PPI_DESCRIPTION = "send to the Claimant(s):  \na) A schedule of the following " +
        "amounts itemised by date;  \ni) PPI premium charged,  \nii) Commission receivable by the Defendant(s),  \niii) Rate " +
        "of commission as a percentage of the premium charged, " +
        " \niv) Totals and average commission rates, in respect of the whole period to which the claim relates,  \nv) Contractual " +
        "interest associated with each such premium charged." +
        ...
        "\nThe parties shall endeavour to agree a calculation of the sums in issue and upload to the Digital Portal " +
        ...
        "The calculation must show the amount which is intended to remove any unfairness from the relationship, " +
        "broken down into:\n" +
