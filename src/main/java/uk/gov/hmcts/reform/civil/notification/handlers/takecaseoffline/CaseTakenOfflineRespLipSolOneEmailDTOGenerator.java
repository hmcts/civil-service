...
@Component
public class CaseTakenOfflineRespLipSolOneEmailDTOGenerator extends DefendantEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "case-taken-offline-respondent-notification-%s";
    private final NotificationsProperties notificationsProperties;

    public CaseTakenOfflineRespLipSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties) {
