...
public class ClaimDetailsNotifiedTransitionBuilder extends MidTransitionBuilder {
    ...
    void setUpTransitions(List<Transition> transitions) {
        this.moveTo(CLAIM_DETAILS_NOTIFIED_TIME_EXTENSION, transitions)
            ...
            .onlyWhen(awaitingResponsesFullAdmitReceived
            ...
            .onlyWhen(awaitingResponsesNonFullDefenceOrFullAdmitReceived
                .and(not(notificationAcknowledged)).and(not(respondentTimeExtension)), transitions)
            .moveTo(NO_DEFENDANT_RESPONSE, transitions)
            .onlyWhen(not(notificationAcknowledged)
                .and(not(respondentTimeExtension)).and(responseDeadlinePassed), transitions)
