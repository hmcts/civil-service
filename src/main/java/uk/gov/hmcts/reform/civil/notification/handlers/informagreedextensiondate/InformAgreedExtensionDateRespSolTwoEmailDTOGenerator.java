...
@Component
public class InformAgreedExtensionDateRespSolTwoEmailDTOGenerator extends RespSolTwoEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "agreed-extension-date-applicant-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected InformAgreedExtensionDateRespSolTwoEmailDTOGenerator(NotificationsProperties notificationsProperties,
