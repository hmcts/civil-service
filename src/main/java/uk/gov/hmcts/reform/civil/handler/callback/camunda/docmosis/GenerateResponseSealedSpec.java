...
public class GenerateResponseSealedSpec extends CallbackHandler {
    ...
    private CallbackResponse prepareSealedForm(CallbackParams callbackParams) {
        ...
        CaseDocument copy = assignCategoryId.copyCaseDocumentWithCategoryId(sealedForm, "");
        ...
        if (stitchEnabled) {
            ...
            log.info("Calling civil stitch service for generate response sealed form generation for caseId {}", caseId);
