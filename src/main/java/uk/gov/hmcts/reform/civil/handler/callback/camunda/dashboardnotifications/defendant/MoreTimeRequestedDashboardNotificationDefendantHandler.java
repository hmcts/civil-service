...
public class MoreTimeRequestedDashboardNotificationDefendantHandler extends CallbackHandler {
    ...
    private CallbackResponse configureScenarioForClaimSubmission(CallbackParams callbackParams) {
        ...
        dashboardApiClient.recordScenario(caseData.getCcdCaseReference().toString(),
                                          SCENARIO_AAA7_DEFRESPONSE_MORETIMEREQUESTED_DEFENDANT.getScenario(),
                                          authToken,
