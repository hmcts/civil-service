...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.NOTIFY_RESPONDENT_SOLICITOR2_FOR_AGREED_EXTENSION_DATE;
...
public class AgreedExtensionDateApplicantNotificationHandler extends CallbackHandler implements NotificationData {
    ...
    private static Map<CaseEvent, String> EVENT_TASK_ID_MAP = Map.ofEntries(
        ...
        new AbstractMap.SimpleEntry<>(
            NOTIFY_RESPONDENT_SOLICITOR2_FOR_AGREED_EXTENSION_DATE, "AgreedExtensionDateNotifyRespondentSolicitor2CC")
    );
    ...
    private String getRespondentSolicitorEmailAddress(CallbackParams callbackParams) {
        ...
        if (eventId.equals(NOTIFY_RESPONDENT_SOLICITOR2_FOR_AGREED_EXTENSION_DATE.name())) {
