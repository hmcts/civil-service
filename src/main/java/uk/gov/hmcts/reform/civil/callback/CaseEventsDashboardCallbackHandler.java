...
public abstract class CaseEventsDashboardCallbackHandler extends DashboardCallbackHandler {
    ...
    protected CaseEventsDashboardCallbackHandler(DashboardApiClient dashboardApiClient, DashboardNotificationsParamsMapper mapper, FeatureToggleService featureToggleService) {
