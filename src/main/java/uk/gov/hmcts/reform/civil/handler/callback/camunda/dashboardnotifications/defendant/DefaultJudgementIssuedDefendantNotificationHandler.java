...
@Service
public class DefaultJudgementIssuedDefendantNotificationHandler extends DashboardCallbackHandler {
    ...
    public DefaultJudgementIssuedDefendantNotificationHandler(DashboardApiClient dashboardApiClient,
    ...
    public String getScenario(CaseData caseData) {
        return SCENARIO_AAA6_JUDGEMENTS_ONLINE_DEFAULT_JUDGEMENT_ISSUED_DEFENDANT.getScenario();
    }
