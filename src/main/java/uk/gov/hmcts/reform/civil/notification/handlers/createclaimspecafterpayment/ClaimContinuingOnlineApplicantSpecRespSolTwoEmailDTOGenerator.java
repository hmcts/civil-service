...
@Component
public class ClaimContinuingOnlineApplicantSpecRespSolTwoEmailDTOGenerator extends RespSolTwoEmailDTOGenerator {
    ...
    public ClaimContinuingOnlineApplicantSpecRespSolTwoEmailDTOGenerator(
