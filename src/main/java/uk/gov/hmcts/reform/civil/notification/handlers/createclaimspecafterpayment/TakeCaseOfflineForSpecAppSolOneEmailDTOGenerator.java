...
@Component
public class TakeCaseOfflineForSpecAppSolOneEmailDTOGenerator extends AppSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "case-taken-offline-spec-applicant-notification-%s";
    private final NotificationsProperties notificationsProperties;

    public TakeCaseOfflineForSpecAppSolOneEmailDTOGenerator(
