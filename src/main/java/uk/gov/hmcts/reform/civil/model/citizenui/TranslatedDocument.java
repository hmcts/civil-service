...
import static uk.gov.hmcts.reform.civil.documentmanagement.model.DocumentType.TRANSLATED_DEFENCE_DOCUMENT;
...
public class TranslatedDocument {
    ...
    public DocumentType getCorrespondingDocumentType() {
        switch (documentType) {
            case DEFENDANT_RESPONSE : return TRANSLATED_DEFENCE_DOCUMENT;
