...
import uk.gov.hmcts.reform.civil.ccd.event.page.DEFENDANTRESPONSESPECProdScopes1;
import uk.gov.hmcts.reform.civil.ccd.event.page.DEFENDANTRESPONSESPECProdScopes2;
...
public class DEFENDANTRESPONSESPECProd implements CCDConfig<CaseData, CaseState, UserRole> {
    ...
    public void configure(ConfigBuilder<CaseData, CaseState, UserRole> builder) {
        ...
        DEFENDANTRESPONSESPECProdScopes1.apply(fields);
        DEFENDANTRESPONSESPECProdScopes2.apply(fields);
    }
}
