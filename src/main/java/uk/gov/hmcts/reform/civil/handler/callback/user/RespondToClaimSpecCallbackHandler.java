...
import static uk.gov.hmcts.reform.civil.utils.RequestedCourtForClaimDetailsTab.updateRequestCourtClaimTabRespondent1Spec;
import static uk.gov.hmcts.reform.civil.utils.RequestedCourtForClaimDetailsTab.updateRequestCourtClaimTabRespondent2Spec;
...
public class RespondToClaimSpecCallbackHandler extends CallbackHandler
    ...
    private CallbackResponse setApplicantResponseDeadline(CallbackParams callbackParams) {
        ...
        if (solicitorRepresentsOnlyOneOfRespondents(callbackParams, respondentTwoCaseRoleToCheck)) {
            ...
            updateRequestCourtClaimTabRespondent2Spec(updatedData);
            ...
            updateRequestCourtClaimTabRespondent1Spec(updatedData);
            // resetting statement of truth to make sure it's empty the next time it appears in the UI.
            updatedData.uiStatementOfTruth(StatementOfTruth.builder().build());
        }
