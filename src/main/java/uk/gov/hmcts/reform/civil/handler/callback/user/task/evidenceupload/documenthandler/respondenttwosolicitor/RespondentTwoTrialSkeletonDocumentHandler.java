...
public class RespondentTwoTrialSkeletonDocumentHandler extends
    ...
    public RespondentTwoTrialSkeletonDocumentHandler(UploadEvidenceDocumentRetriever uploadDocumentRetriever) {
        super(DocumentCategory.RESPONDENT_TWO_TRIAL_SKELETON, EvidenceUploadType.TRIAL_SKELETON, uploadDocumentRetriever);
    }
