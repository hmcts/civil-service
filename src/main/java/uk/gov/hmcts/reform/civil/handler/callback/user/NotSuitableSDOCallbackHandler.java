...
public class NotSuitableSDOCallbackHandler extends CallbackHandler {
    ...
    private boolean isTransferOnlineCase(CaseData caseData) {
        return toggleService.isTransferOnlineCaseEnabled()
            && caseData.getNotSuitableSdoOptions()
            == uk.gov.hmcts.reform.civil.model.transferonlinecase.NotSuitableSdoOptions.CHANGE_LOCATION;
    }
