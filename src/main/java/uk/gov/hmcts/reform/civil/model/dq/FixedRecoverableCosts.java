...
public class FixedRecoverableCosts {
  ...
  /** Retained so a subclass's positional super(...) call still binds. */
  public FixedRecoverableCosts(YesOrNo isSubjectToFixedRecoverableCostRegime,
                               ComplexityBand band,
                               YesOrNo complexityBandingAgreed,
                               String reasons,
                               Document frcSupportingDocument) {
    this(isSubjectToFixedRecoverableCostRegime, band, complexityBandingAgreed, reasons, frcSupportingDocument, null);
  }
}
