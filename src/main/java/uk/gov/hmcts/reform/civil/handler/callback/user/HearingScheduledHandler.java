...
public class HearingScheduledHandler extends CallbackHandler {
    ...
    private CallbackResponse handleAboutToSubmit(CallbackParams callbackParams) {
        ...
        System.out.println("testttt   " + caseData.getCaseAccessCategory());
        System.out.println("track   " + caseData.getAllocatedTrack());
        System.out.println("track   " + caseData.getResponseClaimTrack());
