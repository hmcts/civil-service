 ...
 *
 * <p>For each intention, a different sub-interface or this one should be created. That allows to declare a
 * List&lt;ThatInterface> dependency in the user class so that Spring can populate it with the generators relevant
 * to that intention.
 *
 * <p>Within each intention, each kind of case is addressed by a different subclass of ThatInterface.
 */
