...
public abstract class ProceedOfflineCallbackHandler extends CallbackHandler {
    ...
    protected CallbackResponse captureTakenOfflineDate(CallbackParams callbackParams) {
