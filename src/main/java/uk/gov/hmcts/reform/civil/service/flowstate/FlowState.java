...
public interface FlowState {
    ...
    enum Main implements FlowState {
        ...
        CONTACT_DETAILS_CHANGE_FULL_DEFENCE,
        CONTACT_DETAILS_NOT_CHANGE_FULL_DEFENCE,
        CONTACT_DETAILS_CHANGE_FULL_ADMISSION,
        CONTACT_DETAILS_NOT_CHANGE_FULL_ADMISSION,
        CONTACT_DETAILS_CHANGE_PART_ADMISSION,
        CONTACT_DETAILS_NOT_CHANGE_PART_ADMISSION,
        RESPONSE_PROCEED_FULL_DEFENCE,
        RESPONSE_PROCEED_FULL_ADMISSION,
        RESPONSE_PROCEED_PART_ADMISSION
        ;
