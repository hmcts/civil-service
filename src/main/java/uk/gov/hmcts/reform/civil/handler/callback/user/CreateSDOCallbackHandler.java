...
public class CreateSDOCallbackHandler extends CallbackHandler {
    ...
    protected Map<String, Callback> callbacks() {
        return new ImmutableMap.Builder<String, Callback>()
            ...
            .put(callbackKey(MID, "small-claims"), this::setSmallClaimsFlag)
    ...
    private CallbackResponse setSmallClaimsFlag(CallbackParams callbackParams) {
        System.out.println("hitting mid event");

        CaseData caseData = callbackParams.getCaseData();
        CaseData.CaseDataBuilder updatedData =
            caseData.toBuilder().setSmallClaimsFlag(YesOrNo.NO);
