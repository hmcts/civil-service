...
@Component
public class RecordJudgementNotificationRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "record-judgment-determination-means-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected RecordJudgementNotificationRespSolOneEmailDTOGenerator(OrganisationService organisationService,
