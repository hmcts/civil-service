...
@Component
public class GenerateDJFormApprovedAppSolOneEmailDTOGenerator extends AppSolOneEmailDTOGenerator {
    ...
    public GenerateDJFormApprovedAppSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties,
