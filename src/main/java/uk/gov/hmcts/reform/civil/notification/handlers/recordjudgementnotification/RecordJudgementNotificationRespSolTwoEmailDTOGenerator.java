...
@Component
public class RecordJudgementNotificationRespSolTwoEmailDTOGenerator extends RespSolTwoEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "record-judgment-determination-means-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected RecordJudgementNotificationRespSolTwoEmailDTOGenerator(OrganisationService organisationService,
