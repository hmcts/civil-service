...
public class ClaimSettledDefendantNotificationsHandler extends CallbackHandler {

    private static final List<CaseEvent> EVENTS = List.of(CREATE_DASHBOARD_NOTIFICATION_CLAIM_SETTLED_RESPONDENT1);
    ...
    protected Map<String, Callback> callbacks() {
        return Map.of(
            callbackKey(ABOUT_TO_SUBMIT), this::createDashboardNotificationsForClaimSettled
        );
    }
    ...
    public CallbackResponse createDashboardNotificationsForClaimSettled(CallbackParams callbackParams) {
