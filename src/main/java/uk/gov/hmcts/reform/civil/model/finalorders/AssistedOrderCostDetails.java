...
import uk.gov.hmcts.reform.civil.model.ClaimantOrDefendant;
import uk.gov.hmcts.reform.civil.model.FinalOrderMakeAnOrderTopList;
import uk.gov.hmcts.reform.civil.model.FinalOrderMakeAnOrderClaimantSecondList;
import uk.gov.hmcts.reform.civil.model.FinalOrderMakeAnOrderClaimantThirdList;
...
public class AssistedOrderCostDetails {
    ...
    @CCD(
            label = " ",
            searchable = false,
            typeParameterOverride = "ClaimantOrDefendant",
            typeParameterClass = ClaimantOrDefendant.class
    )
    ...
    @CCD(
            ...
            typeParameterClass = FinalOrderMakeAnOrderTopList.class
    )
    ...
    @CCD(
            ...
            typeParameterClass = FinalOrderMakeAnOrderClaimantSecondList.class
    )
    ...
    @CCD(
            ...
            typeParameterClass = FinalOrderMakeAnOrderClaimantThirdList.class
    )
