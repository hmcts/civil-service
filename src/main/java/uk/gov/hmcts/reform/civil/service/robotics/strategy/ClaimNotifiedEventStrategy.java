...
public class ClaimNotifiedEventStrategy implements EventHistoryStrategy {
    ...
    public boolean supports(CaseData caseData) {
        return caseData != null && hasClaimNotifiedState(caseData);
    }
    ...
    public void contribute(EventHistory eventHistory, CaseData caseData, String authToken) {
        ...
        log.info(
                "Building claim notified robotics events for caseId {}", caseData.getCcdCaseReference());
        ...
        updatedMiscellaneousEvents1.add(
                buildMiscEvent(
                        eventHistory, sequenceGenerator, MESSAGE, caseData.getClaimNotificationDate()));
