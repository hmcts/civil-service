...
public class PartAdmissionAgreeRepaymentTransitionBuilder extends MidTransitionBuilder {

    public PartAdmissionAgreeRepaymentTransitionBuilder(FeatureToggleService featureToggleService) {
