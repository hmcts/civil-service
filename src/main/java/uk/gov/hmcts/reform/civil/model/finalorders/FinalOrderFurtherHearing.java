...
import uk.gov.hmcts.reform.civil.model.FinalOrderFurtherHearingDatesAvoid;
...
public class FinalOrderFurtherHearing {
    ...
    @CCD(
            label = " ",
            showCondition = "datesToAvoidYesNo=\"Yes\"",
            searchable = false,
            typeParameterClass = FinalOrderFurtherHearingDatesAvoid.class
    )
