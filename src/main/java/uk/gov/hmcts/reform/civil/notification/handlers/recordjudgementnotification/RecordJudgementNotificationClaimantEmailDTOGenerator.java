...
@Component
public class RecordJudgementNotificationClaimantEmailDTOGenerator extends ClaimantEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "record-judgment-determination-means-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected RecordJudgementNotificationClaimantEmailDTOGenerator(NotificationsProperties notificationsProperties) {
