...
public class RespondentTwoTrialCorrespondenceDocumentHandler extends
    ...
    public RespondentTwoTrialCorrespondenceDocumentHandler(UploadEvidenceDocumentRetriever uploadEvidenceDocumentRetriever) {
        super(DocumentCategory.RESPONDENT_TWO_TRIAL_DOC_CORRESPONDENCE,
            EvidenceUploadType.TRIAL_CORRESPONDENCE, uploadEvidenceDocumentRetriever);
    }
