...
@Component
public class TranslatedDocumentApplicantDashboardTask extends GaDashboardServiceTask {

    private final TranslatedDocumentApplicantDashboardService dashboardService;

    public TranslatedDocumentApplicantDashboardTask(TranslatedDocumentApplicantDashboardService dashboardService) {
