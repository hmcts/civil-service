...
public class CoverLetterAppendService {
    ...
    public byte[] makeDocumentMailable(CaseData caseData, String authorisation,
        ...
        log.info("Calling civil stitch service from cover letter append service for caseId {}", caseId);
        ...
        log.info("Civil stitch service cover letter append service response {} for caseId {}", mailableDocument, caseId);
