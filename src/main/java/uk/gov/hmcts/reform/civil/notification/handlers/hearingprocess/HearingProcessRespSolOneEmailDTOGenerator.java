...
public class HearingProcessRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {
    ...
    protected HearingProcessRespSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties,
    ...
    protected Map<String, String> addCustomProperties(Map<String, String> properties, CaseData caseData) {
        ...
        properties.put(DEFENDANT_REFERENCE_NUMBER, getRespSolOneReference(caseData));
        return properties;
    }
}
