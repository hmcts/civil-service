...
@Component
public class NotifyDecisionOnReconsiderationRequestDefendantEmailDTOGenerator extends DefendantEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "reconsideration-upheld-applicant-notification-%s";
    private final NotificationsProperties notificationsProperties;

    public NotifyDecisionOnReconsiderationRequestDefendantEmailDTOGenerator(NotificationsProperties notificationsProperties) {
