...
public class EmailFooterUtils {
    ...
    private static boolean queryNotAllowedCaseStates(GeneralApplicationCaseData mainCaseData) {
        return qmNotAllowedStates.contains(mainCaseData.getCcdState());
    }

    public static Map<String, String> addAllFooterItems(GeneralApplicationCaseData caseData, GeneralApplicationCaseData mainCaseData, Map<String, String> properties,
    ...
    public static void addSpecAndUnspecContact(GeneralApplicationCaseData caseData, GeneralApplicationCaseData mainCaseData, Map<String, String> properties,
                                               NotificationsSignatureConfiguration configuration,
                                               boolean isPublicQMEnabled) {
    ...
    public static void addLipContact(GeneralApplicationCaseData caseData, GeneralApplicationCaseData mainCaseData, Map<String, String> properties,
                                     NotificationsSignatureConfiguration configuration,
                                     boolean isPublicQMEnabled) {
    ...
    public static void addWelshLipContact(GeneralApplicationCaseData caseData, GeneralApplicationCaseData mainCaseData, Map<String, String> properties,
                                          NotificationsSignatureConfiguration configuration,
                                          boolean isPublicQMEnabled) {
