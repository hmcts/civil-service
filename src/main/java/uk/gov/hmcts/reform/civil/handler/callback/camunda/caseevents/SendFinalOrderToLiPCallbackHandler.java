...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.SEND_TRANSLATED_FINAL_ORDER_TO_LIP_CLAIMANT;
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.SEND_TRANSLATED_FINAL_ORDER_TO_LIP_DEFENDANT;
...
public class SendFinalOrderToLiPCallbackHandler extends CallbackHandler {
    ...
    private static final List<CaseEvent> EVENTS = List.of(SEND_FINAL_ORDER_TO_LIP_DEFENDANT,
                                                          ...
                                                          SEND_TRANSLATED_FINAL_ORDER_TO_LIP_DEFENDANT,
                                                          SEND_TRANSLATED_FINAL_ORDER_TO_LIP_CLAIMANT);
    ...
    public String camundaActivityId(CallbackParams callbackParams) {
        ...
        if (SEND_FINAL_ORDER_TO_LIP_DEFENDANT.equals(caseEvent)
            || SEND_TRANSLATED_FINAL_ORDER_TO_LIP_DEFENDANT.equals(caseEvent)) {
    ...
    private CallbackResponse sendFinalOrderLetter(CallbackParams callbackParams) {
        ...
        CaseEvent caseEvent = CaseEvent.valueOf(callbackParams.getRequest().getEventId());
        if (SEND_TRANSLATED_FINAL_ORDER_TO_LIP_CLAIMANT.equals(caseEvent)
            || SEND_TRANSLATED_FINAL_ORDER_TO_LIP_DEFENDANT.equals(caseEvent)) {
