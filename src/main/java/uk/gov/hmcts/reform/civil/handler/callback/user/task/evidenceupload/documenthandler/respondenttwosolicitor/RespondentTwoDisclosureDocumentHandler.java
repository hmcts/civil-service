...
public class RespondentTwoDisclosureDocumentHandler extends
    ...
    public RespondentTwoDisclosureDocumentHandler(UploadEvidenceDocumentRetriever uploadDocumentRetriever) {
        super(RESPONDENT_TWO_DISCLOSURE, EvidenceUploadType.DOCUMENTS_FOR_DISCLOSURE, uploadDocumentRetriever);
    }
