...
public class DocUploadDashboardNotificationService {
    ...
    public void createDashboardNotification(GeneralApplicationCaseData caseData, String role, String authToken, boolean itsUploadAddlDocEvent) {

        if (isWithNoticeOrConsent(caseData)) {
            log.info(
                "Case {} is with notice or consent and the dashboard service is enabled",
    ...
    private List<String> getDashboardScenario(String role, GeneralApplicationCaseData caseData, boolean itsUploadAddlDocEvent) {
