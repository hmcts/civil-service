...
import uk.gov.hmcts.reform.civil.model.FixedRecoverableCostsIntermediate;
import uk.gov.hmcts.reform.civil.model.DisclosureOfElectronicDocumentsLRspec;
import uk.gov.hmcts.reform.civil.model.DisclosureOfNonElectronicDocumentsLRspec;
import uk.gov.hmcts.reform.civil.model.HearingSupportRequirements;
import uk.gov.hmcts.reform.civil.model.Language2;
import uk.gov.hmcts.reform.civil.model.HomeDetailsLRspec;
import uk.gov.hmcts.reform.civil.model.HearingLRspec;
import uk.gov.hmcts.reform.civil.model.RequestedCourtLocationLRspec;
...
public class Respondent2DQ implements DQ {
    ...
    @CCD(
            label = "Defendant 2 Fixed Recoverable Costs",
            searchable = false,
            typeParameterClass = FixedRecoverableCostsIntermediate.class,
    ...
    @CCD(
            label = "Defendant 2 Disclosure of electronic documents",
            searchable = false,
            typeParameterClass = DisclosureOfElectronicDocumentsLRspec.class,
    ...
    @CCD(
            label = "Defendant 2 Disclosure of non-electronic documents",
            searchable = false,
            typeParameterClass = DisclosureOfNonElectronicDocumentsLRspec.class,
            access = {DefaultAccess.class, APPSOLSPECPROFILERRESSOLONESPECPROFILECruRESSOLTWOSPECPROFILECruAccess.class, CITIZENCLAIMANTPROFILERAccess.class}
    )
    ...
    @CCD(
            ...
            searchable = false,
            typeParameterClass = HearingSupportRequirements.class,
    ...
    @CCD(
            ...
            searchable = false,
            typeParameterClass = Language2.class,
    ...
    @CCD(
            label = " ",
            searchable = false,
            typeParameterClass = HomeDetailsLRspec.class,
    ...
    @CCD(
            label = "Respondent 1 Hearing",
            searchable = false,
            typeParameterClass = HearingLRspec.class,
            access = {DefaultAccess.class, RESSOLONESPECPROFILERESSOLTWOSPECPROFILECruAccess.class, APPSOLSPECPROFILECITIZENCLAIMANTPROFILECruAccess.class}
    )
    ...
    @CCD(
            ...
            searchable = false,
            typeParameterClass = RequestedCourtLocationLRspec.class,
