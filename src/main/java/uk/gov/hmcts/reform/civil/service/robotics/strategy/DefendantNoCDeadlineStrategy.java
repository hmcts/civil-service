...
public class DefendantNoCDeadlineStrategy implements EventHistoryStrategy {
    ...
    public void contribute(EventHistory eventHistory, CaseData caseData, String authToken) {
        ...
        log.info(
                "Building defendant notice-of-change deadline robotics event for caseId {}",
        ...
        RoboticsEventSupport.addRespondentMiscEvent(eventHistory, sequenceGenerator, details, takenOfflineDate);
    }
