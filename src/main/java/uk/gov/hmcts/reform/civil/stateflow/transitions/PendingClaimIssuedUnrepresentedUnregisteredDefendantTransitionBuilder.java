...
public class PendingClaimIssuedUnrepresentedUnregisteredDefendantTransitionBuilder extends MidTransitionBuilder {
    ...
    void setUpTransitions(List<Transition> transitions) {
        this.moveTo(TAKEN_OFFLINE_UNREPRESENTED_UNREGISTERED_DEFENDANT, transitions)
            .onlyWhen(TakenOfflinePredicate.bySystem.and(ClaimPredicate.changeOfRepresentation.negate()), transitions);
    }
}
