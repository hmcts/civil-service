...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.SELECT_DEFENDANT_LITIGATION_FRIEND;


@Service
@RequiredArgsConstructor
public class SelectDefendantLitigationFriendCallbackHandler extends CallbackHandler {

    private static final List<CaseEvent> EVENTS = List.of(SELECT_DEFENDANT_LITIGATION_FRIEND);
    ...
    private CallbackResponse aboutToSubmit(CallbackParams callbackParams) {
        CaseData caseDataUpdated = callbackParams.getCaseData().toBuilder()
            .businessProcess(BusinessProcess.ready(SELECT_DEFENDANT_LITIGATION_FRIEND))
