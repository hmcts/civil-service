...
@Component
public class NotifyDecisionOnReconsiderationRequestAppSolEmailDTOGenerator extends AppSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "reconsideration-upheld-applicant-notification-%s";

    private final NotificationsProperties notificationsProperties;

    public NotifyDecisionOnReconsiderationRequestAppSolEmailDTOGenerator(OrganisationService organisationService,
    ...
    protected Map<String, String> addCustomProperties(Map<String, String> properties, CaseData caseData) {
        ...
        result.put(PARTY_NAME, caseData.getApplicant1().getPartyName());
        return result;
    }
}
