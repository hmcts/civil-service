...
@Service
public class NotifyLipClaimantHwfOutcomeDashboardService extends DashboardScenarioService {
    ...
    public NotifyLipClaimantHwfOutcomeDashboardService(DashboardScenariosService dashboardScenariosService, DashboardNotificationsParamsMapper mapper) {
        super(dashboardScenariosService, mapper);
    }

    public void notifyNotifyLipClaimantHwfOutcome(CaseData caseData, String authToken) {
