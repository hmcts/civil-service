...
@Service
public class CaseStateSearchService extends ElasticSearchGeneralApplicationService {
    ...
    public Query query(int startIndex, CaseState caseState) {
        System.out.println(">>> DEBUG: Real CaseStateSearchService#query called with " + caseState);
        return new Query(
    ...
    Query queryForOrderMade(int startIndex, CaseState caseState, GeneralApplicationTypes gaType) {
        System.out.println(">>> DEBUG: Real CaseStateSearchService#queryForOrderMade called with "
                + caseState + ", gaType=" + gaType);
        ...
        return new Query(query, emptyList(), startIndex);
    }

    @Override
    public Query queryForBusinessProcessStatus(int startIndex, BusinessProcessStatus processStatus) {
        System.out.println(">>> DEBUG: Real CaseStateSearchService#queryForBusinessProcessStatus called with "
                + processStatus);
        return new Query(
