...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.NOTIFY_RPA_GENERAL_APPLICATION;

@Service
public class NotifyRoboticsGeneralApplicationHandler extends NotifyRoboticsHandler {

    private static final List<CaseEvent> EVENTS = List.of(NOTIFY_RPA_GENERAL_APPLICATION);
    public static final String TASK_ID = "NotifyRoboticsGeneralApplication";

    public NotifyRoboticsGeneralApplicationHandler(
