...
public class SetApplicantResponseDeadlineSpec implements CaseTask {
    ...
    public CallbackResponse execute(CallbackParams callbackParams) {
        ...
        updateRespondent2(caseData, updatedData);
        handlePaymentTimeRoute(caseData, updatedData);
    ...
    private void updateRespondent2(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
    ...
    private void handlePaymentTimeRoute(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
    ...
    private void handleExpertsAndWitnesses(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
        handleRespondent1Witnesses(caseData, updatedData);
        handleRespondent2Witnesses(caseData, updatedData);
        handleRespondent1Experts(caseData, updatedData);
        handleRespondent2Experts(caseData, updatedData);
    }

    private void handleRespondent1Witnesses(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
    ...
    private void handleRespondent2Witnesses(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
    ...
    private void handleRespondent1Experts(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
    ...
    private void handleRespondent2Experts(CaseData caseData, CaseData.CaseDataBuilder<?, ?> updatedData) {
