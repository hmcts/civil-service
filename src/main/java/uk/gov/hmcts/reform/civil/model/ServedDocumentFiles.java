...
public class ServedDocumentFiles {
    ...
    private static String bothParticularsOfClaimError = "You need to either upload 1 Particulars of claim "
        + "only or enter the Particulars of claim text in the field provided. You cannot do both.";
    private static String emptyError = "You must add Particulars of claim details";
