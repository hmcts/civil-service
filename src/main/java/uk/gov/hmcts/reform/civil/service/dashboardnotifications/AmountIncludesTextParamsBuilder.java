...
public class AmountIncludesTextParamsBuilder extends DashboardNotificationsParamsBuilder {
    ...
    public void addParams(CaseData caseData, HashMap<String, Object> params) {
        if (caseData.isFullAdmitPayImmediatelyClaimSpec() || (caseData.isFullAdmitClaimSpec()
        ...
        } else if (caseData.isPartAdmitPayImmediatelyClaimSpec() || (caseData.isPartAdmitClaimSpec() && caseData.isPayBySetDate())) {
