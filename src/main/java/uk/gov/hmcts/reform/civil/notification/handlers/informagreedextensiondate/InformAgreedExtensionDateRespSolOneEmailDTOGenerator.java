...
@Component
public class InformAgreedExtensionDateRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "agreed-extension-date-applicant-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected InformAgreedExtensionDateRespSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties,
