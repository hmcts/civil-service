...
public class RespondentResponseDeadlineCheckCallbackHandler extends CallbackHandler {
    ...
    protected Map<String, Callback> callbacks() {
        return Map.of(
            callbackKey(ABOUT_TO_SUBMIT), this::setRespondentResponseDeadlineChecked
        );
    }

    private CallbackResponse setRespondentResponseDeadlineChecked(CallbackParams callbackParams) {
        CaseData caseData = callbackParams.getCaseData().toBuilder()
            .businessProcess(BusinessProcess.ready(RESPONDENT_RESPONSE_DEADLINE_CHECK))
