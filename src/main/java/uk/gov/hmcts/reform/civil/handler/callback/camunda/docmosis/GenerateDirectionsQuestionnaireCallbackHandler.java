    ...
    private CallbackResponse prepareDirectionsQuestionnaire(CallbackParams callbackParams) {
        ...
        if (!SPEC_CLAIM.equals(caseData.getCaseAccessCategory())
            ...
            */
            ...
            assignCategoryId.setCategoryIdCaseDocument(caseData.getRespondent2GeneratedResponseDocument(), "defendant2CounterScheduleOfLoss");
            assignCategoryId.setCategoryIdCaseDocument(caseData.getRespondent1GeneratedResponseDocument(), "defendant1CounterScheduleOfLoss");
