...
public class CaseData implements MappableObject {
    ...
    public CaseDataBuilder toBuilder() {
        return new CaseDataBuilder().ccdCaseReference(this.ccdCaseReference).ccdState(this.ccdState).generalAppType(this.generalAppType).generalAppRespondentAgreement(
            ...
            this.specRespondentCorrespondenceAddressRequired).specRespondentCorrespondenceAddressdetails(this.specRespondentCorrespondenceAddressdetails).specAoSRespondent2HomeAddressRequired(
            this.specAoSRespondent2HomeAddressRequired).specAoSRespondent2HomeAddressDetails(this.specAoSRespondent2HomeAddressDetails).respondentSolicitor1AgreedDeadlineExtension(
            ...
            this.specRespondentSolicitor1EmailAddress).specAoSApplicantCorrespondenceAddressRequired(this.specAoSApplicantCorrespondenceAddressRequired).specAoSApplicantCorrespondenceAddressdetails(
            this.specAoSApplicantCorrespondenceAddressdetails).specAoSRespondentCorrespondenceAddressRequired(this.specAoSRespondentCorrespondenceAddressRequired).specAoSRespondentCorrespondenceAddressdetails(
            this.specAoSRespondentCorrespondenceAddressdetails).specRespondent1Represented(this.specRespondent1Represented).specRespondent2Represented(
            ...
            this.isRespondent2).isApplicant1(this.isApplicant1).claimStarted(this.claimStarted);
    }
