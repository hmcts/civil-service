...
@Slf4j
public class CaseDismissedScheduledTask implements ScheduledTask<CaseDetails, Long> {
    ...
    public void accept(CaseDetails caseDetails) {
        ...
        log.info("CaseDismissedScheduledTask::accept case {}", caseId);
        applicationEventPublisher.publishEvent(new DismissClaimEvent(caseId));
    }
