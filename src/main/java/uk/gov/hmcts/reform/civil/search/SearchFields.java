...
@Component
public class SearchFields implements CCDConfig<CaseData, CaseState, UserRole> {
    ...
    @Override
    public void configure(final ConfigBuilder<CaseData, CaseState, UserRole> builder) {
