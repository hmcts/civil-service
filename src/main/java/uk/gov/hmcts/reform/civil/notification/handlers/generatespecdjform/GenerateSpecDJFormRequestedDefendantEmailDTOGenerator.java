...
@Component
public class GenerateSpecDJFormRequestedDefendantEmailDTOGenerator extends DefendantEmailDTOGenerator {
    ...
    public GenerateSpecDJFormRequestedDefendantEmailDTOGenerator(NotificationsProperties notificationsProperties) {
