 ...
 *
 * <p>Event {@code END_BUSINESS_PROCESS} for case type {@code CIVIL}.
 */
@Component
public class ENDBUSINESSPROCESS implements CCDConfig<CaseData, CaseState, UserRole> {
    /**
     * The CCD event ID.
     */
