...
public class TrialReadyFormGenerator {
    ...
    private TrialReadyForm getTemplateData(CaseData caseData, String camundaActivity) {
        ...
        trialReadyForm.setIsClaimant2(nonNull(caseData.getApplicant2()));
        trialReadyForm.setIsDefendant2(nonNull(caseData.getRespondent2()));
        trialReadyForm.setIsDefendant2RefDiff(checkReference(caseData)
