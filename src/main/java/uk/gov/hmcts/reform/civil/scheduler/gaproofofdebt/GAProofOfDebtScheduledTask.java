...
@Slf4j
public class GAProofOfDebtScheduledTask implements ScheduledTask<CaseDetails, Long> {
    ...
    public void accept(CaseDetails caseDetails) {
        ...
        log.info("GAProofOfDebtScheduledTask::accept case {}", caseId);
        applicationEventPublisher.publishEvent(new CoscApplicationProcessorEvent(caseId));
    }
