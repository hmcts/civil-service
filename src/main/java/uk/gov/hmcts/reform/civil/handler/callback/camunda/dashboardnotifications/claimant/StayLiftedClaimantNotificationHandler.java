...
@Service
public class StayLiftedClaimantNotificationHandler extends DashboardCallbackHandler {
    ...
    public StayLiftedClaimantNotificationHandler(DashboardScenariosService dashboardScenariosService,
