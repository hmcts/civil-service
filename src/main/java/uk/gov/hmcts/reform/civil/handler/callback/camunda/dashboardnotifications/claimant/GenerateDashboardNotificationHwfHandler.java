...
import static uk.gov.hmcts.reform.civil.handler.callback.camunda.dashboardnotifications.DashboardScenarios.SCENARIO_AAA7_CLAIM_ISSUE_HWF_REQUESTED;
...
public class GenerateDashboardNotificationHwfHandler extends CallbackHandler {
    ...
    protected Map<String, Callback> callbacks() {
        return Map.of(
            callbackKey(ABOUT_TO_SUBMIT), this::configureScenarioForHelpWithFees
        );
    }
    ...
    private CallbackResponse configureScenarioForHelpWithFees(CallbackParams callbackParams) {
        ...
        dashboardApiClient.recordScenario(caseData.getCcdCaseReference().toString(),
                                          SCENARIO_AAA7_CLAIM_ISSUE_HWF_REQUESTED.getScenario(), authToken,
