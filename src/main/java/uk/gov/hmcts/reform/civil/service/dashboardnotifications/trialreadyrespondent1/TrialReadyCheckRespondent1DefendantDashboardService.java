...
@Service
public class TrialReadyCheckRespondent1DefendantDashboardService extends DashboardScenarioService {

    private final DashboardNotificationService dashboardNotificationService;
    private final TaskListService taskListService;

    public TrialReadyCheckRespondent1DefendantDashboardService(DashboardScenariosService dashboardScenariosService,
    ...
    public void notifyCaseTrialReadyCheckRespondent1(CaseData caseData, String authToken) {
