...
public class PartialAdmitPayImmediatelyConfirmationText implements RespondToClaimConfirmationTextSpecGenerator {
    ...
    public Optional<String> generateTextFor(CaseData caseData, FeatureToggleService featureToggleService) {
        ...
        sb.append("<br>We've emailed ")
                ...
                .append("<ul>")
                .append("<li><p class=\"govuk-!-margin-0\">pay ")
                .append(applicantName)
                .append(" By ")
                .append(formattedWhenBePaid)
                .append("</p></li>")
                .append("<li><p class=\"govuk-!-margin-0\">keep proof of any payments you make</p></li>")
                .append("<li><p class=\"govuk-!-margin-0\">make sure ")
                .append(applicantName)
                .append(" tells the court that you've paid")
                .append("</p></li>")
                .append("</ul>");
        ...
        sb.append("<p>Contact ").append(applicantName);
    ...
    private BigDecimal getClaimOwingAmount(CaseData caseData, boolean isPartLRAdmission) {
        ...
        if (isPartLRAdmission) {
            if ((ONE_V_TWO_TWO_LEGAL_REP.equals(multiPartyScenario)
                    && YesOrNo.YES.equals(caseData.getIsRespondent2()))) {
    ...
    private String getPartAdmitLrAdmissionBulkConfirmationText(CaseData caseData, BigDecimal claimOwingAmount) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("<br>You believe you owe &#163;")
                .append(claimOwingAmount)
                .append(". <br>We've emailed ")
                .append(applicantName)
                .append(" to say you will pay immediately. ");

        sb.append("<br><br>")
                .append("The claimant has until 4pm on ")
        ...
        sb.append("<ul>")
                .append("<li><p class=\"govuk-!-margin-0\">pay ")
                .append(applicantName)
                .append(" within 5 days of the response")
                .append("</p></li>")
                .append(
                        "<li><p class=\"govuk-!-margin-0\">make sure any cheques or bank transfers are clear in their account by the deadline</p></li>")
                .append("<li><p class=\"govuk-!-margin-0\">keep proof of any payments you make</p></li>")
                .append("</ul>");
        ...
        sb.append(headingThreeText)
                ...
                .append(
                        "<p>If you do not pay within 5 days of the response, the claimant can request a County Court Judgment against you.")
                .append("<br><br>")
                .append("Contact ")
                .append(applicantName)
