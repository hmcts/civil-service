...
public class AwaitingResponsesNotFullDefenceOrFullAdmitReceivedTransitionBuilder extends MidTransitionBuilder {

    public AwaitingResponsesNotFullDefenceOrFullAdmitReceivedTransitionBuilder(FeatureToggleService featureToggleService) {
        super(FlowState.Main.AWAITING_RESPONSES_NOT_FULL_DEFENCE_OR_FULL_ADMIT_RECEIVED, featureToggleService);
    }
