...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowFlag.QM_LIP_ENABLED;
        ...
        this.moveTo(CLAIM_SUBMITTED, transitions)
            ...
            .set((c, flags) -> flags.putAll(
                ...
                Map.ofEntries(
                    ...
                    Map.entry(QM_LIP_ENABLED.name(), featureToggleService.isLipQueryManagementEnabled(c))
                )), transitions)
