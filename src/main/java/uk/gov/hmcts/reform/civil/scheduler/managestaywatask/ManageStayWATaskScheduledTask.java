...
@Slf4j
public class ManageStayWATaskScheduledTask implements ScheduledTask<CaseDetails, Long> {
    ...
    public void accept(CaseDetails caseDetails) {
        ...
        log.info("ManageStayWATaskScheduledTask::accept case {}", caseId);
        applicationEventPublisher.publishEvent(new ManageStayWATaskEvent(caseId));
    }
