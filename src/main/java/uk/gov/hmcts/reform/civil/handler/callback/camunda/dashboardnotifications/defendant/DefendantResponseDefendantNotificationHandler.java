...
import static uk.gov.hmcts.reform.civil.handler.callback.camunda.dashboardnotifications.DashboardScenarios.SCENARIO_AAA7_DEFENDANT_FULL_DEFENCE_NO_MEDIATION_DEFENDANT;
...
public class DefendantResponseDefendantNotificationHandler extends CallbackHandler {
    ...
    private String getScenario(CaseData caseData) {
        ...
        if (caseData.isFullAdmitPayImmediatelyClaimSpec()
            ...
            return SCENARIO_AAA7_DEFENDANT_FULL_DEFENCE_NO_MEDIATION_DEFENDANT.getScenario();
        }
