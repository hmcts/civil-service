...
import static uk.gov.hmcts.reform.civil.handler.callback.camunda.dashboardnotifications.DashboardScenarios.SCENARIO_AAA7_DEFENDANT_ADMIT_PAY_INSTALLMENTS_DEFENDANT;
...
public class DefendantResponseDefendantNotificationHandler extends CallbackHandler {
    ...
    private String getScenario(CaseData caseData) {
        ...
        if (caseData.isFullAdmitPayImmediatelyClaimSpec()
            ...
            return SCENARIO_AAA7_DEFENDANT_ADMIT_PAY_INSTALLMENTS_DEFENDANT.getScenario();
        }
