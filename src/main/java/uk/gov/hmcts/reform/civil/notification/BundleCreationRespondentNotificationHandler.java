...
public class BundleCreationRespondentNotificationHandler implements NotificationData {

    private static final String REFERENCE_TEMPLATE = "evidence-upload-notification-%s";
    private final NotificationService notificationService;
    private final NotificationsProperties notificationsProperties;

    public void notifyRespondentBundleCreation(CaseData caseData, boolean isForRespondentSolicitor1) throws NotificationException {
        String email = null;
