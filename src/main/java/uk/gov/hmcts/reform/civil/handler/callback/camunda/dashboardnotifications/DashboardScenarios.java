...
public enum DashboardScenarios {
    ...
    SCENARIO_AAA7_SETTLEMENT_AGREEMENT_DEFENDANT_REJECTED_CLAIMANT(
        "Scenario.AAA7.ClaimantIntent.SettlementAgreement.DefendantRejected.Claimant"),
    SCENARIO_AAA7_CLAIMANT_INTENT_SETTLEMENT_DEFENDANT_RESPONSE_ACCEPTS_CLAIMANT(
        "Scenario.AAA7.ClaimantIntent.Settlement.DefendantResponseAccepts.Claimant"),
    SCENARIO_AAA7_CLAIMANT_INTENT_CCJ_REQUESTED_CLAIMANT("Scenario.AAA7.ClaimantIntent.CCJ.Requested.Claimant"),
    SCENARIO_AAA7_SETTLEMENT_AGREEMENT_DEFENDANT_ACCEPTED_DEFENDANT("Scenario.AAA7.ClaimantIntent.SettlementAgreement.DefendantAccepted.Defendant"),
    ...
    SCENARIO_AAA7_CLAIM_ISSUE_HWF_PHONE_PAYMENT("Scenario.AAA7.ClaimIssue.HWF.PhonePayment"),
    ...
    SCENARIO_AAA7_DEFENDANT_ADMIT_PAY_IMMEDIATELY_DEFENDANT("Scenario.AAA7.DefResponse.FullOrPartAdmit.PayImmediately.Defendant"),
