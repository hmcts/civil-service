...
public enum DashboardScenarios {
    ...
    SCENARIO_AA6_APPLICATIONS_TO_THE_COURT("Scenario.AAA6.Applications.to.the.court"),
    SCENARIO_AA6_MESSAGES_TO_THE_COURT("Scenario.AAA6.Messages.to.the.court"),
    SCENARIO_AA6_VIEW_AVAILABLE_MESSAGES_TO_THE_COURT("Scenario.AAA6.ViewAvailableMessages"),
