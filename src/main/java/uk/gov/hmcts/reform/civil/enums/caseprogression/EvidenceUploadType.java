...
public enum EvidenceUploadType {
    ...
    EXPERT_REPORT("Expert Report", "%s - Answer to questions asked"),
    PRE_TRIAL_SUMMARY("Pre Trial Summary", "%s - Case Summary"),
    JOINT_STATEMENT("Joint Statement", "%s - Joint Statement of Experts / Single Joint Expert Report"),
    QUESTIONS_FOR_EXPERTS("Expert Questions", " - Questions for other party's expert or joint experts"),
    ...
    COSTS("Costs", "%s - Costs"),
    TRIAL_CORRESPONDENCE("Trial Correspondence", "%s - Documentary evidence for trial"),
