...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.NOTIFY_RPA_ON_BREATHING_SPACE_ENTERED;
...
@Service
public class NotifyRoboticsOnBreathingSpaceEnteredHandler extends NotifyRoboticsHandler {

    private static final List<CaseEvent> EVENTS = List.of(
        NOTIFY_RPA_ON_BREATHING_SPACE_ENTERED
    );
    public static final String TASK_ID = "NotifyRoboticsBreathingSpaceEnter";

    public NotifyRoboticsOnBreathingSpaceEnteredHandler(
