...
public class JudgementService {
    ...
    private static final String JUDGEMENT_ORDER_V2 = "The judgment will order the defendant to pay £%s, including the claim fee, any fixed costs if claimed and interest if applicable, as shown:";
