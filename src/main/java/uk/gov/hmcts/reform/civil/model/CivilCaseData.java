...
public class CivilCaseData extends BaseCaseData implements MappableObject {
    ...
    @CCD(
            ...
            typeParameterClass = DisposalHearingMethodInPerson.class,
            access = {CaseworkerCivilSystemFieldReaderRJudgeProfileCruLegalAdviserCruAccess.class}
    )
    ...
    @CCD(
            ...
            typeParameterClass = FastTrackMethodInPerson.class,
    ...
    @CCD(
            ...
            typeParameterClass = SmallClaimsMethodInPerson.class,
            access = {CaseworkerCivilSystemFieldReaderRJudgeProfileCruLegalAdviserCruAccess.class}
    )
