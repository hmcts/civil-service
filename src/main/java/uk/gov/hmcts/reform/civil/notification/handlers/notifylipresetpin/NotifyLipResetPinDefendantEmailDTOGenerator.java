...
@Component
public class NotifyLipResetPinDefendantEmailDTOGenerator extends DefendantEmailDTOGenerator {
    ...
    public NotifyLipResetPinDefendantEmailDTOGenerator(NotificationsProperties notificationsProperties, PinInPostConfiguration pipInPostConfiguration) {
    ...
    protected Map<String, String> addCustomProperties(Map<String, String> properties, CaseData caseData) {
        ...
        properties.put(RESPOND_URL, pipInPostConfiguration.getRespondToClaimUrl());
        ...
        properties.put(RESPONSE_DEADLINE, formatLocalDate(caseData.getRespondent1ResponseDeadline()
                                                               .toLocalDate(), DATE));
