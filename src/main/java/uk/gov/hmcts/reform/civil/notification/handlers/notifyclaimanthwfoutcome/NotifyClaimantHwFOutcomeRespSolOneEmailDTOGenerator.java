...
public class NotifyClaimantHwFOutcomeRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {
    ...
    public NotifyClaimantHwFOutcomeRespSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties) {
        super(null);
