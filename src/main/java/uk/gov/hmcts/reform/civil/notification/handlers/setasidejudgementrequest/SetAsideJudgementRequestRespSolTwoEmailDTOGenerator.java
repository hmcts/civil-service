...
@Component
public class SetAsideJudgementRequestRespSolTwoEmailDTOGenerator extends RespSolTwoEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "set-aside-judgment-defendant-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected SetAsideJudgementRequestRespSolTwoEmailDTOGenerator(NotificationsProperties notificationsProperties,
