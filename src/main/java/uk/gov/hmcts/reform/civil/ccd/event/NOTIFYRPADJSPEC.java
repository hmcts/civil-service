 ...
 *
 * <p>Event {@code NOTIFY_RPA_DJ_SPEC} for case type {@code CIVIL}.
 */
@Component
public class NOTIFYRPADJSPEC implements CCDConfig<CaseData, CaseState, UserRole> {
    /**
     * The CCD event ID.
     */
