...
@Component
public class SetAsideJudgementRequestAppSolOneEmailDTOGenerator extends AppSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "set-aside-judgment-applicant-notification-%s";

    private final NotificationsProperties notificationsProperties;

    protected SetAsideJudgementRequestAppSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties,
