package uk.gov.hmcts.reform.civil.service.dashboardnotifications.trailreadyservice;
...
@Service
public class TrailReadyCheckClaimantDashboardService extends DashboardScenarioService {

    private final DashboardNotificationService dashboardNotificationService;
    private final TaskListService taskListService;

    public TrailReadyCheckClaimantDashboardService(DashboardScenariosService dashboardScenariosService,
    ...
    public void notifyTrailReadyCheck(CaseData caseData, String authToken) {
