...
public enum CaseEvent {
    ...
    CREATE_DASHBOARD_NOTIFICATION_DECISION_OUTCOME(CAMUNDA),
    UPDATE_DASHBOARD_DEFENDANT_TASK_LIST_UPLOAD_DOCUMENTS_FINAL_ORDERS(CAMUNDA),
    UPDATE_DASHBOARD_CLAIMANT_TASK_LIST_UPLOAD_DOCUMENTS_FINAL_ORDERS(CAMUNDA);
