...
public enum CaseEvent {
    ...
    DEFAULT_JUDGEMENT_GRANTED_SPEC(USER),
    DEFAULT_JUDGEMENT_NON_DIVERGENT_SPEC(CAMUNDA),
    JUDGMENT_REQUESTED_SPEC(CAMUNDA),
    ...
    INITIATE_GENERAL_APPLICATION_COSC(USER),
    ...
    REMOVE_DOCUMENT(USER),
    CANCEL_DOCUMENT_TRANSLATION_TASK(CAMUNDA),
    ...
    NOTIFY_LIP_APPLICANT_BREATHING_SPACE_ENTER(CAMUNDA),
    NOTIFY_LIP_RESPONDENT1_BREATHING_SPACE_ENTER(CAMUNDA),
    ...
    NOTIFY_LIP_RESPONDENT1_BREATHING_SPACE_LIFTED(CAMUNDA),
    ...
    NOTIFY_INTERIM_JUDGMENT(CAMUNDA),
    ...
    RECORD_NOTIFICATIONS(CAMUNDA),
    DASHBOARD_NOTIFICATION_EVENT(CAMUNDA),
    ...
    CLEAR_FORMER_SOLICITOR_INFO_AFTER_NOTIFY_NOC(CAMUNDA),

    UPDATE_CASE_DATA(TESTING_SUPPORT),
    UPDATE_GA_CASE_DATA(TESTING_SUPPORT),
    LINK_DEFENDANT_TO_CLAIM(TESTING_SUPPORT),
    ...
    POST_DJ_NON_DIVERGENT_COVER_LETTER_CLAIMANT(CAMUNDA),
    POST_DJ_NON_DIVERGENT_PIN_IN_LETTER_DEFENDANT1(CAMUNDA),
    POST_CLAIMANT_LIP_JBA_LETTER(CAMUNDA),
    ...
    RETRIGGER_MEDIATION_UNSUCCESSFUL(CAMUNDA),
    ...
    GENERATE_QUERY_DOCUMENT(CAMUNDA),
    DELETE_QUERY_DOCUMENT(CAMUNDA),
    NOTIFY_RAISED_QUERY(CAMUNDA),
    NOTIFY_RESPONSE_TO_QUERY(CAMUNDA),
    UPDATE_DASHBOARD_NOTIFICATIONS_RAISED_QUERY(CAMUNDA),
    UPDATE_DASHBOARD_NOTIFICATIONS_RESPONSE_TO_QUERY(CAMUNDA),
    UPDATE_DASHBOARD_NOTIFICATIONS_JUDGMENT_PAID_CLAIMANT(CAMUNDA),
    UPDATE_DASHBOARD_NOTIFICATIONS_JUDGMENT_PAID_DEFENDANT(CAMUNDA),
    NOTIFY_OTHER_PARTY_FOR_RAISED_QUERY(CAMUNDA),
    NOTIFY_OTHER_PARTY_QUERY_HAS_RESPONSE(CAMUNDA),
    CHANGE_LANGUAGE_PREFERENCE(USER),
    NOTIFY_LIP_RESPONDENT1_FOR_RESET_PIN(CAMUNDA),
    UPDATE_GA_LANGUAGE_PREFERENCE(CAMUNDA),
    TRIGGER_GA_LANGUAGE_UPDATE(CAMUNDA),
    UPLOAD_TRANSLATED_DOCUMENT_SDO(USER),
    UPLOAD_TRANSLATED_DOCUMENT_SETTLEMENT_AGREEMENT(USER),
    UPLOAD_TRANSLATED_DOCUMENT_CLAIMANT_REJECTS_REPAYMENT_PLAN(USER),
    UPLOAD_TRANSLATED_DOCUMENT_HEARING_NOTICE(USER),
    UPLOAD_TRANSLATED_DISCONTINUANCE_DOC(USER),
    UPLOAD_TRANSLATED_DEFENDANT_SEALED_FORM(CAMUNDA),
    SEND_DRO_ORDER_TO_LIP_CLAIMANT(CAMUNDA),
    SEND_DRO_ORDER_TO_LIP_DEFENDANT(CAMUNDA),
    UPLOAD_TRANSLATED_DOCUMENT_ORDER(USER),
    UPLOAD_TRANSLATED_DOCUMENT_CLAIMANT_LR_INTENTION(USER),
    UPDATE_CLAIM_STATE_AFTER_CLAIMANT_INTENTION_LR_DOC_UPLOADED(CAMUNDA),
    GENERATE_PIP_LETTER(CAMUNDA),
    CLAIM_CONTINUING_ONLINE_SPEC_STATE_TRANSITION(CAMUNDA),
    CREATE_MESSAGES_TASK_CATEGORIES(CAMUNDA),
    REMOVE_PAYMENT_DASHBOARD_NOTIFICATION(CAMUNDA),
    REMOVE_CLAIMANT_DJ_DASHBOARD_NOTIFICATION(CAMUNDA),
    NOTIFY_RESPONDENT1_PART_ADMIT_PAY_IMMEDIATELY_AGREED(CAMUNDA),
    NOTIFY_APPLICANT_PART_ADMIT_PAY_IMMEDIATELY_AGREED(CAMUNDA),
    RESET_LANGUAGE_PREFERENCE(CAMUNDA),
    ...
    UPLOAD_TRANSLATED_DOCUMENT_JUDGE_DECISION(CAMUNDA),
    CREATE_APPLICATION_RESPONDED_DASHBOARD_NOTIFICATION(CAMUNDA),
    DELETE_APPLICATION_PAYMENT_DASHBOARD_NOTIFICATION(CAMUNDA),
