...
public enum CaseEvent {
    ...
    CREATE_DASHBOARD_NOTIFICATION_FOR_MEDIATION_UNSUCCESSFUL_FOR_APPLICANT(CAMUNDA),
    CREATE_DASHBOARD_NOTIFICATION_FOR_MEDIATION_UNSUCCESSFUL_FOR_RESPONDENT(CAMUNDA),
