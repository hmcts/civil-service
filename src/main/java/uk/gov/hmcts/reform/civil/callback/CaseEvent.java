...
public enum CaseEvent {
    ...
    PREPARE_FOR_HEARING_CONDUCT_HEARING(USER),
    ...
    NOTIFY_RESPONDENT_SOLICITOR1_FOR_BUNDLE_CREATION(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR2_FOR_BUNDLE_CREATION(CAMUNDA),
    NOTIFY_APPLICANT_SOLICITOR1_FOR_BUNDLE_CREATION(CAMUNDA),
