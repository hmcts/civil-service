...
public enum CaseEvent {
    ...
    CREATE_DASHBOARD_NOTIFICATION_APPLICATION_PROCEED_OFFLINE_APPLICANT(CAMUNDA),
    CREATE_DASHBOARD_NOTIFICATION_APPLICATION_PROCEED_OFFLINE_RESPONDENT(CAMUNDA);
