...
public enum CaseEvent {
    ...
    NOTIFY_CLAIM_CAA_RESPONDENT_1_ORG(CAMUNDA),
    NOTIFY_CLAIM_CAA_RESPONDENT_2_ORG(CAMUNDA),
    NOTIFY_CLAIM_DETAILS_CAA_RESPONDENT_1_ORG(CAMUNDA),
    NOTIFY_CLAIM_DETAILS_CAA_RESPONDENT_2_ORG(CAMUNDA),
    ...
    GENERATE_DIRECTIONS_QUESTIONNAIRE_SPEC(CAMUNDA),
