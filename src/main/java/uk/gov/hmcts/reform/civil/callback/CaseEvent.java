...
public enum CaseEvent {
    ...
    NOTIFY_APPLICANT_SOLICITOR1_FOR_FINAL_ORDER(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR1_FOR_FINAL_ORDER(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR2_FOR_FINAL_ORDER(CAMUNDA),
