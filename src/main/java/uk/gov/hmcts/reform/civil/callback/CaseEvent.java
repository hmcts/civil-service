...
public enum CaseEvent {
    ...
    REQUEST_FOR_RECONSIDERATION_NOTIFICATION_CUI(USER),
    ...
    GEN_JUDGMENT_BY_ADMISSION_DOC(CAMUNDA),
    ...
    DELETE_NOTIFICATION_REQUEST_FOR_RECONSIDERATION_CLAIMANT(CAMUNDA),
    DELETE_NOTIFICATION_REQUEST_FOR_RECONSIDERATION_DEFENDANT(CAMUNDA);
