...
public enum CaseEvent {
    ...
    NOTIFY_EVENT_FOR_LITIGATION_FRIEND_ADDED(CAMUNDA),
    APPLICANT_NOTIFY_OTHERS_TRIAL_READY(CAMUNDA),
    RESPONDENT1_NOTIFY_OTHERS_TRIAL_READY(CAMUNDA),
    RESPONDENT2_NOTIFY_OTHERS_TRIAL_READY(CAMUNDA),
