...
public enum CaseEvent {
    ...
    EVIDENCE_UPLOAD_OTHER_PARTY(USER),
    EVIDENCE_UPLOAD_CHECK(USER),
    EVIDENCE_UPLOAD_NOTIFICATION(USER),
    ...
    NOTIFY_RESPONDENT_SOLICITOR1_FOR_EVIDENCE_UPLOAD(CAMUNDA),
    NOTIFY_RESPONDENT_SOLICITOR2_FOR_EVIDENCE_UPLOAD(CAMUNDA),
    NOTIFY_APPLICANT_SOLICITOR_FOR_EVIDENCE_UPLOAD(CAMUNDA),
    ...
    NOTIFY_DEFENDANT_HEARING(CAMUNDA);
