...
public class RespondToClaimSpecResponseTypeHandlerClaims {
    ...
    CallbackResponse handleDefendAllClaim(CallbackParams callbackParams) {
    ...
    CallbackResponse handleAdmitPartOfClaim(CallbackParams callbackParams) {
        CaseData caseData = callbackParams.getCaseData();
        List<String> errors = paymentDateValidator.validate(
