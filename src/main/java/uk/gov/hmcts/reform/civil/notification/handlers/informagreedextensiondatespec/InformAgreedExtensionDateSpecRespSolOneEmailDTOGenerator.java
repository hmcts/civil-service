...
@Component
public class InformAgreedExtensionDateSpecRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE = "agreed-extension-date-applicant-notification-spec-%s";

    private final NotificationsProperties notificationsProperties;

    protected InformAgreedExtensionDateSpecRespSolOneEmailDTOGenerator(NotificationsProperties notificationsProperties,
