...
@Component
public class GenerateDJFormRespSolTwoEmailDTOGenerator extends RespSolTwoEmailDTOGenerator {
    ...
    public GenerateDJFormRespSolTwoEmailDTOGenerator(NotificationsProperties notificationsProperties,
