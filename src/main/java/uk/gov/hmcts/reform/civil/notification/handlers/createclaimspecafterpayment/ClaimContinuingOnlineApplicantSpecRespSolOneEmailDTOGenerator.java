...
@Component
public class ClaimContinuingOnlineApplicantSpecRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {
    ...
    public ClaimContinuingOnlineApplicantSpecRespSolOneEmailDTOGenerator(
