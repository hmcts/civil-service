...
public class RespondentOneTrialCorrespondenceDocumentHandler extends
    ...
    protected static final String RESPONDENT_TWO_TRIAL_DOC_CORRESPONDENCE_CATEGORY_ID = "RespondentTwoTrialDocCorrespondence";
    protected static final String RESPONDENT_ONE_TRIAL_DOC_CORRESPONDENCE_CATEGORY_ID = "RespondentOneTrialDocCorrespondence";
    ...
    public RespondentOneTrialCorrespondenceDocumentHandler(DocumentTypeBuilder<UploadEvidenceDocumentType> documentTypeBuilder) {
        super(RESPONDENT_ONE_TRIAL_DOC_CORRESPONDENCE_CATEGORY_ID, RESPONDENT_TWO_TRIAL_DOC_CORRESPONDENCE_CATEGORY_ID,
            "%s - Documentary evidence for trial", documentTypeBuilder);
    }
    ...
    protected void renameDocuments(List<Element<UploadEvidenceDocumentType>> documentUploads) {
        renameUploadEvidenceDocumentType(documentUploads, "Documentary Evidence");
    }
