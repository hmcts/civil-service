...
@Slf4j
public class RequestForReconsiderationNotificationScheduledTask implements ScheduledTask<CaseDetails, Long> {
    ...
    public void accept(CaseDetails caseDetails) {
        ...
        log.info("RequestForReconsiderationNotificationScheduledTask::accept case {}", caseId);
        applicationEventPublisher.publishEvent(new RequestForReconsiderationNotificationDeadlineEvent(caseId));
    }
