...
@Component
public class AmendRestitchBundleRespSolOneEmailDTOGenerator extends RespSolOneEmailDTOGenerator {

    private static final String REFERENCE_TEMPLATE_RESPONDENT_1 = "amend-restitch-bundle-defendant-notification-%s";
