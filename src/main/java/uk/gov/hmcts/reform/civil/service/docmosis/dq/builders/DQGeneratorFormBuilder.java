...
public class DQGeneratorFormBuilder {
    ...
    public DirectionsQuestionnaireForm.DirectionsQuestionnaireFormBuilder getDirectionsQuestionnaireFormBuilder(CaseData caseData, String authorisation) {
        ...
        builder.fileDirectionsQuestionnaire(dq.getFileDirectionQuestionnaire())
            ...
            .deterWithoutHearingYesNo((specAndSmallClaim && claimantResponseLRspec) ? dq.getDeterWithoutHearing().getDeterWithoutHearingYesNo() : null)
            .deterWithoutHearingWhyNot((specAndSmallClaim && claimantResponseLRspec) ? dq.getDeterWithoutHearing().getDeterWithoutHearingWhyNot() : null)
