...
public class ClaimDetailsNotifiedEventStrategy implements EventHistoryStrategy {
    ...
    public boolean supports(CaseData caseData) {
        return caseData != null && hasClaimDetailsNotifiedState(caseData);
    }
    ...
    public void contribute(EventHistory eventHistory, CaseData caseData, String authToken) {
        ...
        log.info(
                "Building claim details notified robotics events for caseId {}",
        ...
        updatedMiscellaneousEvents1.add(
                buildMiscEvent(
                        eventHistory, sequenceGenerator, MESSAGE, caseData.getClaimDetailsNotificationDate()));
