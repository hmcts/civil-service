...
public class UploadTranslatedDocumentService {
    ...
    private void updateCaseDataBuilderByType(GeneralApplicationCaseData caseData,
    ...
    public void sendUserUploadNotification(GeneralApplicationCaseData caseData,
    ...
    private boolean isFreeFeeApplicationSummary(GeneralApplicationCaseData caseData,
                                                TranslatedDocumentType translatedDocumentType) {
