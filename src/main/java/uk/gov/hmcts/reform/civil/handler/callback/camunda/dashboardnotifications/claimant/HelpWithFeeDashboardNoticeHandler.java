...
@Service
public class HelpWithFeeDashboardNoticeHandler  extends DashboardCallbackHandler {
    ...
    public HelpWithFeeDashboardNoticeHandler(DashboardApiClient dashboardApiClient,
