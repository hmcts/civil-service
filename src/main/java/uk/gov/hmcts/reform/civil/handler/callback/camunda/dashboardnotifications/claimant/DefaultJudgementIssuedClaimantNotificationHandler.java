...
@Service
public class DefaultJudgementIssuedClaimantNotificationHandler extends DashboardJudgmentOnlineCallbackHandler {
    ...
    public DefaultJudgementIssuedClaimantNotificationHandler(DashboardApiClient dashboardApiClient,
