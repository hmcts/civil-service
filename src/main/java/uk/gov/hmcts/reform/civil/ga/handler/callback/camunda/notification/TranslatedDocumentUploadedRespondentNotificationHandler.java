...
public class TranslatedDocumentUploadedRespondentNotificationHandler extends CallbackHandler
    ...
    public Map<String, String> addPropertiesForRespondent(GeneralApplicationCaseData caseData, GeneralApplicationCaseData mainCaseData,
    ...
    private CallbackResponse notifyRespondent(CallbackParams callbackParams) {
        ...
        GeneralApplicationCaseData validatedCaseData = solicitorEmailValidation.validateSolicitorEmail(civilCaseData, caseData);
