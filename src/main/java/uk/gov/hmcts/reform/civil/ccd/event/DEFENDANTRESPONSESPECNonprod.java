...
import uk.gov.hmcts.reform.civil.ccd.event.page.DEFENDANTRESPONSESPECNonprodScopes1;
import uk.gov.hmcts.reform.civil.ccd.event.page.DEFENDANTRESPONSESPECNonprodScopes2;
...
public class DEFENDANTRESPONSESPECNonprod implements CCDConfig<CaseData, CaseState, UserRole> {
    ...
    public void configure(ConfigBuilder<CaseData, CaseState, UserRole> builder) {
        ...
        DEFENDANTRESPONSESPECNonprodScopes1.apply(fields);
        DEFENDANTRESPONSESPECNonprodScopes2.apply(fields);
    }
}
