...
public class JudgmentPaidClaimantNotificationHandler extends DashboardCallbackHandler {
    ...
    private static final List<CaseEvent> EVENTS = List.of(UPDATE_DASHBOARD_NOTIFICATIONS_JUDGMENT_PAID_CLAIMANT);
    public static final String TASK_ID = "UpdateJudgmentPaidDashboardNotificationsClaimant";

    public JudgmentPaidClaimantNotificationHandler(DashboardScenariosService dashboardScenariosService,
