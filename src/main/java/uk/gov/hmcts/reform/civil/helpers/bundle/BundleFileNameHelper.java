        ...
        switch (evidenceUploadFiles) {
            case WITNESS_STATEMENT : {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentWitnessStatement() != null
                        ? caseData.getDocumentWitnessStatement() : null;
            ...
            case WITNESS_SUMMARY : {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentWitnessSummary() != null
                        ? caseData.getDocumentWitnessSummary() : null;
            ...
            case NOTICE_OF_INTENTION : {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentHearsayNotice() != null
                        ? caseData.getDocumentHearsayNotice() : null;
        ...
        switch (evidenceUploadFiles) {
            case EXPERT_REPORT : {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentExpertReport() != null
                        ? caseData.getDocumentExpertReport() : null;
            ...
            case QUESTIONS_FOR_EXPERTS: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentQuestions() != null
                        ? caseData.getDocumentQuestions() : null;
            ...
            case ANSWERS_FOR_EXPERTS: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentAnswers() != null
                        ? caseData.getDocumentAnswers() : null;
        ...
        switch (evidenceUploadFiles) {
            case DOCUMENTS_FOR_DISCLOSURE: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentForDisclosure() != null
                        ? caseData.getDocumentForDisclosure() : null;
            ...
            case DISCLOSURE_LIST: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentDisclosureList() != null
                        ? caseData.getDocumentDisclosureList() : null;
            ...
            case DOCUMENTS_REFERRED: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentReferredInStatement() != null
                        ? caseData.getDocumentReferredInStatement() : null;
            ...
            case DOCUMENTARY: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentEvidenceForTrial() != null
                        ? caseData.getDocumentEvidenceForTrial() : null;
            ...
            case CASE_SUMMARY: {
                return switch (partyType) {
                    ...
                    case CLAIMANT2 -> caseData.getDocumentCaseSummary() != null
                        ? caseData.getDocumentCaseSummary() : null;
