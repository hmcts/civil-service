...
public class BundleFileNameHelper {
    ...
    private static <T> List<Element<T>> getDocsByParty(PartyType partyType,
                                                       Supplier<List<Element<T>>> claimant1Docs,
                                                       Supplier<List<Element<T>>> claimant2Docs,
                                                       Supplier<List<Element<T>>> defendant1Docs,
                                                       Supplier<List<Element<T>>> defendant2Docs) {
        return emptyIfNull(switch (partyType) {
            case CLAIMANT1 -> claimant1Docs.get();
            case CLAIMANT2 -> claimant2Docs.get();
            case DEFENDANT1 -> defendant1Docs.get();
            case DEFENDANT2 -> defendant2Docs.get();
        });
    }
