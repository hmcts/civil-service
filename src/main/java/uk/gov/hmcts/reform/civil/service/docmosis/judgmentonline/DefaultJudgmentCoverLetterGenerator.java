...
public class DefaultJudgmentCoverLetterGenerator {
    ...
    public byte[] generateAndPrintDjCoverLettersPlusDocument(CaseData caseData, String authorisation, boolean toSecondLegalOrg) {
        ...
        if (stitchEnabled) {
            ...
            log.info("Calling civil stitch service from judgement cover letter generator for caseId {}", caseId);
            ...
            log.info("Response judgement cover letter generator {} for caseId {}", stitchedDocuments, caseId);
