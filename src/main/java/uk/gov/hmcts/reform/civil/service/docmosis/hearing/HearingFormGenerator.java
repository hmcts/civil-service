...
public class HearingFormGenerator implements TemplateDataGenerator<HearingForm> {
    ...
    public HearingForm getTemplateData(CaseData caseData, String authorisation) {
        ...
        return new HearingForm()
            ...
            .setHearingTime(getHearingTimeFormatted(caseData.getHearingTimeHourMinute()))
            .setHearingType(getHearingType(caseData))
            .setApplicationDate(getDateFormatted(caseData.getDateOfApplication()))
            .setHearingDuration(getHearingDuration(caseData))
            .setAdditionalInfo(caseData.getInformation())
            .setFeeAmount(HearingUtils.formatHearingFee(caseData.getHearingFee()))
            .setHearingDueDate(getDateFormatted(caseData.getHearingDueDate()))
