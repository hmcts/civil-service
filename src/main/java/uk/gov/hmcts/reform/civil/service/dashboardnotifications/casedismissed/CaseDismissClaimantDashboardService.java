...
@Service
public class CaseDismissClaimantDashboardService extends DashboardScenarioService {

    private final DashboardNotificationService dashboardNotificationService;
    private final TaskListService taskListService;
    private final FeatureToggleService featureToggleService;

    public CaseDismissClaimantDashboardService(DashboardScenariosService dashboardScenariosService,
    ...
    protected void beforeRecordScenario(CaseData caseData, String authToken) {
        ...
        dashboardNotificationService.deleteByReferenceAndCitizenRole(caseId, "CLAIMANT");
        taskListService.makeProgressAbleTasksInactiveForCaseIdentifierAndRole(caseId, "CLAIMANT");
    }
