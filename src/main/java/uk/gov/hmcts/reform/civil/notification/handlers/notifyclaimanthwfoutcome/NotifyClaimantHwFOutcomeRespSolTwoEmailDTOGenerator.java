...
public class NotifyClaimantHwFOutcomeRespSolTwoEmailDTOGenerator extends RespSolTwoEmailDTOGenerator {
    ...
    public NotifyClaimantHwFOutcomeRespSolTwoEmailDTOGenerator(NotificationsProperties notificationsProperties) {
        super(null);
