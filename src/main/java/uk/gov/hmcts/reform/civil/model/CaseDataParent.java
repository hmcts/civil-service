...
public class CaseDataParent extends CaseDataCaseProgression implements MappableObject {
    ...
    @CCD(
            ...
            typeParameterClass = PaymentOrder.class,
            access = {DefaultAccess.class, APPSOLSPECPROFILERRESSOLONESPECPROFILECruRESSOLTWOSPECPROFILECruAccess.class, CITIZENCLAIMANTPROFILERCITIZENDEFENDANTPROFILECuAccess.class}
    )
    ...
    private  List<Element<PaymentOrder>> respondent2CourtOrderDetails;
    @CCD(
    ...
    private  List<Element<PaymentOption2>> respondent1LoanCreditDetails;
    @CCD(
            label = "Does your client have any loans, or credit card debts?",
            searchable = false,
            typeOverride = FieldType.YesOrNo,
    ...
    private  List<Element<PaymentOption2>> respondent2LoanCreditDetails;
    ...
    @CCD(
            ...
            typeParameterClass = ShowConditionFlags.class,
    ...
    @CCD(
            label = " ",
            searchable = false,
            typeParameterClass = NotifyClaimDetailsCoS.class,
    ...
    @CCD(
            label = " ",
            searchable = false,
            typeParameterClass = NotifyClaimCoS.class,
            access = {DefaultAccess.class, CITIZENCLAIMANTPROFILECuPlus3RolesTjnmxuAccess.class}
    )
