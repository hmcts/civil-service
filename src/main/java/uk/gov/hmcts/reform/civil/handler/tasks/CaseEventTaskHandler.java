...
public class CaseEventTaskHandler implements BaseExternalTaskHandler {
    ...
    public void handleTask(ExternalTask externalTask) {
        try {
            ...
            log.info("CaseID ({})  caseEvent ({}) from CaseEventTaskHandler -- ", caseId, variables.getCaseEvent());
            ...
            log.error("CAMUNDA EXCEPTION CaseEventTaskHandler process ----  ({}) )", e.getMessage());
        }
    }
            ...
            switch (flowState) {
                ...
                case PENDING_CLAIM_ISSUED_UNREGISTERED_DEFENDANT:
                    return format(
                        ...
                        StringUtils.join(
                            getDefendantNames(
                                featureToggleService.isNoticeOfChangeEnabled()
