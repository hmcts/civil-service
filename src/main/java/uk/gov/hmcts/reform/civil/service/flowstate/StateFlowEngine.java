...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.caseDismissed;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.caseDismissedAfterClaimAcknowledged;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.caseProceedsInCaseman;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.claimDetailsNotified;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.claimDiscontinued;
...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.claimTakenOffline;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.claimWithdrawn;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.failToNotifyClaim;
...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.pendingCaseIssued;
...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.respondentAcknowledgeClaim;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.respondentAgreedExtension;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.respondentCounterClaim;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.respondentFullAdmission;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.respondentFullDefence;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowPredicate.respondentPartAdmission;
...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.CASE_PROCEEDS_IN_CASEMAN;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.CLAIM_ACKNOWLEDGED;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.CLAIM_DISCONTINUED;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.CLAIM_DISMISSED_DEFENDANT_OUT_OF_TIME;
...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.CLAIM_WITHDRAWN;
...
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.PENDING_CASE_ISSUED;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.PENDING_CLAIM_ISSUED_UNREGISTERED_DEFENDANT;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.PROCEEDS_OFFLINE_ADMIT_OR_COUNTER_CLAIM;
import static uk.gov.hmcts.reform.civil.service.flowstate.FlowState.Main.PROCEEDS_OFFLINE_UNREPRESENTED_DEFENDANT;
