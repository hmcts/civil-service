...
public class StateFlowEngine {
    ...
    protected final StateFlowBuilder<FlowState.Main> stateFlowBuilder;
    ...
    public StateFlow build(FlowState.Main initialState) {
        return stateFlowBuilder.flow(FLOW_NAME)
            ...
            .state(CLAIM_SUBMITTED).transitionTo(CLAIM_ISSUED_PAYMENT_SUCCESSFUL).onlyIf(paymentSuccessful)
            ...
            .transitionTo(FULL_DEFENCE_PROCEED)
            .onlyIf((fullDefenceProceed.or(isClaimantNotSettleFullDefenceClaim).or(isDefendantNotPaidFullDefenceClaim))
