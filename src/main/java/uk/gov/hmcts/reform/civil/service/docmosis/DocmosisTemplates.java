...
public enum DocmosisTemplates {
    ...
    DQ_RESPONSE_1V1("CV-UNS-HRN-ENG-01271-testSpec.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_1V2_DS("CV-UNS-HRN-ENG-01269-testSpec.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_1V2_SS("CV-UNS-HRN-ENG-01270-testSpec.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_2V1("CV-UNS-HRN-ENG-01272-testSpec.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DEFENDANT_RESPONSE_SPEC_FAST_TRACK_INT("CV-SPC-HRN-ENG-01282.docx", "%s_directions_questionnaire_form_%s.pdf"),
    CLAIMANT_RESPONSE_SPEC_FAST_TRACK_INT("CV-SPC-HRN-ENG-01283.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_1V1_FAST_TRACK_INT("CV-UNS-HRN-ENG-01273.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_1V2_DS_FAST_TRACK_INT("CV-UNS-HRN-ENG-01274.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_1V2_SS_FAST_TRACK_INT("CV-UNS-HRN-ENG-01275.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DQ_RESPONSE_2V1_FAST_TRACK_INT("CV-UNS-HRN-ENG-01276.docx", "%s_directions_questionnaire_form_%s.pdf"),
