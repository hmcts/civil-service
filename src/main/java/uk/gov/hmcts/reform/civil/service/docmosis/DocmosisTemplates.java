...
public enum DocmosisTemplates {
    ...
    N181("CV-UNS-HRN-ENG-01157.docx", "%s_directions_questionnaire_form_%s.pdf"),
    N181_MULTIPARTY_SAME_SOL("CV-UNS-HRN-ENG-01156.docx", "%s_directions_questionnaire_form_%s.pdf"),
    ...
    N181_2V1("CV-UNS-HRN-ENG-01154.docx", "%s_directions_questionnaire_form_%s.pdf"),
    N181_CLAIMANT_MULTIPARTY_DIFF_SOLICITOR("CV-UNS-HRN-ENG-01155.docx",
