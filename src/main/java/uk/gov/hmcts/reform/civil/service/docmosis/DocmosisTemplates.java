...
public enum DocmosisTemplates {
    ...
    SDO_DISPOSAL("CV-UNS-STD-ENG-99964.docx", "disposal_hearing_sdo_%s.pdf"),
    DJ_SDO_DISPOSAL("CV-UNS-DEC-ENG-99988.docx", "Order_disposal_%s.pdf"),
    DJ_SDO_TRIAL("CV-UNS-DEC-ENG-99993.docx", "Order_trial_%s.pdf"),
    SDO_SMALL("CV-UNS-STD-ENG-99989.docx", "small_claims_sdo_%s.pdf"),
    SDO_FAST("CV-UNS-STD-ENG-99994.docx", "fast_track_sdo_%s.pdf"),
    ...
    SDO_HNL_DISPOSAL("CV-UNS-STD-ENG-99964.docx", "disposal_hearing_sdo_%s.pdf"),
