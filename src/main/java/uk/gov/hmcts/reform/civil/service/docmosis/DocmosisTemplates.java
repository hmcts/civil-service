...
public enum DocmosisTemplates {
    ...
    DEFENDANT_RESPONSE_SPEC_SEALED_1v1("CV-SPC-HRN-ENG-01361-CIV-12072.docx", "%s_response_sealed_form.pdf"),
    DEFENDANT_RESPONSE_SPEC_SEALED_1v2("CV-SPC-HRN-ENG-01360-CIV-12072.docx", "%s_response_sealed_form.pdf"),
    DEFENDANT_RESPONSE_SPEC_SEALED_1V1_INSTALLMENTS("CV-SPC-HRN-ENG-01362-CIV-12072.docx", "%s_response_sealed_form.pdf"),
