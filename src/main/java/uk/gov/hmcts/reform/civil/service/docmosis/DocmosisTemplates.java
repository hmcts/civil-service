...
import static uk.gov.hmcts.reform.civil.constants.EnumDuplicateLiteralConstants.UNSPEC_CLAIM_SETTLED_LETTER;
...
public enum DocmosisTemplates {
    ...
    N10("CV-SPC-ACK-ENG-00001-v01.docx", "acknowledgement_of_service_form_spec_%s.pdf"),
    ...
    CLAIM_SETTLED_LIP_DEFENDANT_LETTER("CV-UNS-LET-ENG-LIP-SD0002.docx", UNSPEC_CLAIM_SETTLED_LETTER),
