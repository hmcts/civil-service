...
public enum DocmosisTemplates {
    ...
    SDO_DISPOSAL("CV-UNS-STD-ENG-01324_10335.docx", "disposal_hearing_sdo_%s.pdf"),
    DJ_SDO_DISPOSAL("CV-UNS-DEC-ENG-01323_10335.docx", "Order_disposal_%s.pdf"),
    DJ_SDO_TRIAL("CV-UNS-DEC-ENG-01322_10335.docx", "Order_trial_%s.pdf"),
    SDO_SMALL("CV-UNS-STD-ENG-01325_10335.docx", "small_claims_sdo_%s.pdf"),
    SDO_FAST("CV-UNS-STD-ENG-01326_10335.docx", "fast_track_sdo_%s.pdf"),
    SDO_FAST_FAST_TRACK_INT("CV-UNS-STD-ENG-01308_10335.docx", "fast_track_sdo_%s.pdf"),
    ...
    SDO_HNL_DISPOSAL("CV-UNS-STD-ENG-01305_10335.docx", "disposal_hearing_sdo_%s.pdf"),
