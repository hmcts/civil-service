...
public enum DocmosisTemplates {
    ...
    DRAFT_CLAIM_FORM("CV-SPC-CLM-ENG-00001-DRAFT-DTSCCI-1495.docx", "draft_claim_form_%s.pdf"),
    ...
    GENERATE_LIP_CLAIMANT_CLAIM_FORM("CV-SPC-CLM-ENG-CLAIMANT-CLAIM-FORM-DTSCCI-1495.docx", "%s-claim-form-claimant-copy.pdf"),
    GENERATE_LIP_DEFENDANT_CLAIM_FORM("CV-SPC-CLM-ENG-DEFENDANT-CLAIM-FORM-DTSCCI-1495.docx", "%s-sealed-claim-form.pdf"),
