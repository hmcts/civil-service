...
public enum DocmosisTemplates {
    ...
    DEFENDANT_RESPONSE_SPEC("CV-SPC-HRN-ENG-01209.docx", "%s_response_sealed_form.pdf"),
    CLAIMANT_RESPONSE_SPEC("CV-SPC-HRN-ENG-01246.docx", "%s_directions_questionnaire_form_%s.pdf"),
