...
public enum DocmosisTemplates {
    N1("CV-UNS-CLM-ENG-01126-other-remedy.docx", "sealed_claim_form_%s.pdf"),
    N1_MULTIPARTY_SAME_SOL("CV-UNS-CLM-ENG-01125-other-remedy.docx", "sealed_claim_form_%s.pdf"),
