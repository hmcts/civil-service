...
public enum DocmosisTemplates {
    ...
    SDO_DISPOSAL("CV-UNS-STD-ENG-01368.docx", "disposal_hearing_sdo_%s.pdf"),
    DJ_SDO_DISPOSAL("CV-UNS-DEC-ENG-01329.docx", "Order_disposal_%s.pdf"),
    DJ_SDO_TRIAL("CV-UNS-DEC-ENG-01369.docx", "Order_trial_%s.pdf"),
    SDO_SMALL("CV-UNS-STD-ENG-01370.docx", "small_claims_sdo_%s.pdf"),
    SDO_FAST("CV-UNS-STD-ENG-01367.docx", "fast_track_sdo_%s.pdf"),
    SDO_FAST_FAST_TRACK_INT("CV-UNS-STD-ENG-01365.docx", "fast_track_sdo_%s.pdf"),
    ...
    SDO_HNL_DISPOSAL("CV-UNS-STD-ENG-01363.docx", "disposal_hearing_sdo_%s.pdf"),
