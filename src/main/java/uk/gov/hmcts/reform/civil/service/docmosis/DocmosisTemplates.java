...
public enum DocmosisTemplates {
    ...
    N181("CV-UNS-HRN-ENG-00911.docx", "%s_directions_questionnaire_form_%s.pdf"),
    N181_MULTIPARTY_SAME_SOL("CV-UNS-HRN-ENG-00912.docx", "%s_directions_questionnaire_form_%s.pdf"),
    ...
    N181_2V1("CV-UNS-HRN-ENG-00913.docx", "%s_directions_questionnaire_form_%s.pdf"),
    N181_CLAIMANT_MULTIPARTY_DIFF_SOLICITOR("CV-UNS-HRN-ENG-00914.docx",
