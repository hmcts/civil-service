...
public enum DocmosisTemplates {
    ...
    DEFENDANT_RESPONSE_SPEC("CV-SPC-HRN-ENG-01338.docx", "%s_directions_questionnaire_form_%s.pdf"),
    DEFENDANT_RESPONSE_SPEC_FAST_TRACK_INT("CV-SPC-HRN-ENG-01339.docx", "%s_directions_questionnaire_form_%s.pdf"),
    CLAIMANT_RESPONSE_SPEC("CV-SPC-HRN-ENG-01337.docx", "%s_directions_questionnaire_form_%s.pdf"),
    CLAIMANT_RESPONSE_SPEC_FAST_TRACK_INT("CV-SPC-HRN-ENG-01340.docx", "%s_directions_questionnaire_form_%s.pdf"),
