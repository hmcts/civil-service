...
public enum DocmosisTemplates {
    ...
    N2_LIP("CV-SPC-CLM-ENG-01181.docx.docx", "sealed_claim_form_spec%s.pdf"),
    ...
    N2_1V2_DIFFERENT_SOL_LIP("CV-SPC-CLM-ENG-01082.docx", "sealed_claim_form_spec%s.pdf"),
    N2_2V1("CV-SPC-CLM-ENG-01077.docx", "sealed_claim_form_spec%s.pdf"),
    N2_2V1_LIP("CV-SPC-CLM-ENG-01080.docx", "sealed_claim_form_spec%s.pdf"),
