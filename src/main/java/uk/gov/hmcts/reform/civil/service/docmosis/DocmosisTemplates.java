...
public enum DocmosisTemplates {
    ...
    SDO_DISPOSAL("CV-UNS-STD-ENG-01385.docx", "disposal_hearing_sdo_%s.pdf"),
    DJ_SDO_DISPOSAL("CV-UNS-DEC-ENG-01330.docx", "Order_disposal_%s.pdf"),
    DJ_SDO_TRIAL("CV-UNS-DEC-ENG-01377.docx", "Order_trial_%s.pdf"),
    SDO_SMALL("CV-UNS-STD-ENG-01386.docx", "small_claims_sdo_%s.pdf"),
    SDO_FAST("CV-UNS-STD-ENG-01384.docx", "fast_track_sdo_%s.pdf"),
    SDO_FAST_FAST_TRACK_INT("CV-UNS-STD-ENG-01383.docx", "fast_track_sdo_%s.pdf"),
    ...
    SDO_HNL_DISPOSAL("CV-UNS-STD-ENG-01379.docx", "disposal_hearing_sdo_%s.pdf"),
