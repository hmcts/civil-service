...
VALUES ('Notice.AAA6.DefResponse.FullDefence.FullDispute.FastTrack.Claimant', 'Response to the claim', 'Response to the claim',
        '<p class="govuk-body">${respondent1PartyName} has rejected the claim. You need to respond by ${applicant1ResponseDeadlineEn}. <a href="{CLAIMANT_RESPONSE_TASK_LIST}" class="govuk-link">View and respond</a>.</p>',
        '<p class="govuk-body">${respondent1PartyName} has rejected the claim. You need to respond by ${applicant1ResponseDeadlineCy}. <a href="{CLAIMANT_RESPONSE_TASK_LIST}" class="govuk-link">View and respond</a>.</p>',
        'CLAIMANT');
