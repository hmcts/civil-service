...
VALUES ('Notice.AAA6.DefResponse.FullDefence.FullDispute.FastTrack.Claimant', 'Response to the claim', 'Ymateb i’r hawliad',
        ...
        '<p class="govuk-body">Mae ${respondent1PartyName} wedi gwrthod yr hawliad. Mae angen i chi ymateb erbyn ${applicant1ResponseDeadlineCy}. <a href="{CLAIMANT_RESPONSE_TASK_LIST}" class="govuk-link">Gweld ac ymateb</a>.</p>',
        'CLAIMANT');
