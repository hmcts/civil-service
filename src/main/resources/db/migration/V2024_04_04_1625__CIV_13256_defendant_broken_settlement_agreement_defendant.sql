...
VALUES ('Notice.AAA6.ClaimantIntent.RequestCCJ.ClaimantAcceptOrRejectPlan.SettlementRequested.DefPaymentMissed.Defendant',
        ...
        '<p class="govuk-body">Mae ${applicant1PartyName} wedi ${claimantSettlementAgreementCy} eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad. Rydych wedi llofnodi’r cytundeb ond mae’r hawlydd yn dweud eich bod wedi torri’r telerau. Pan fyddwn wedi prosesu’r cais, byddwn yn anfon copi o’r dyfarniad drwy’r post atoch chi. Os byddwch yn talu’r ddyled o fewn mis o ddyddiad y dyfarniad, bydd y CCJ yn cael ei ddileu o’r gofrestr gyhoeddus. Gallwch dalu £15 i <a href="{APPLY_FOR_CERTIFICATE}" target="_blank" rel="noopener noreferrer" class="govuk-link">wneud cais am dystysgrif (yn agor mewn ffenestr newydd)</a> sy’n cadarnhau hyn. <a href="{CITIZEN_CONTACT_THEM_URL}"  rel="noopener noreferrer" class="govuk-link">Cysylltwch â ${applicant1PartyName}</a> os oes arnoch angen eu manylion talu.   <a href="{VIEW_RESPONSE_TO_CLAIM}"  rel="noopener noreferrer" class="govuk-link">Gweld eich ymateb</a>.</p>',
        'DEFENDANT');
