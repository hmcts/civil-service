...
VALUES ('Scenario.AAA6.CP.SDOMadebyLA.Claimant', '{"Notice.AAA6.ClaimantIntent.GoToHearing.Claimant"}', '{"Notice.AAA6.CP.SDOMadebyLA.Claimant" : ["requestForReconsiderationDeadlineEn", "requestForReconsiderationDeadlineCy"]}');
