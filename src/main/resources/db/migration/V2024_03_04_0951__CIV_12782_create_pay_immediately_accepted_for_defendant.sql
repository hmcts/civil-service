...
VALUES ('Scenario.AAA7.ClaimantIntent.PartAdmit.Defendant', '{"Notice.AAA7.DefResponse.FullOrPartAdmit.PayImmediately.Defendant"}', '{"Notice.AAA7.ClaimantIntent.PartAdmit.Defendant":[]}');
