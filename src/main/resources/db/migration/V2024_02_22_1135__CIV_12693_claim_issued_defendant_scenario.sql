...
values ('<a href={VIEW_CLAIM_URL} rel="noopener noreferrer" class="govuk-link">View the claim</a>', 'The claim',
       ...
       ('<a>Confirm you have paid a judgment (CCJ) debt</a>', 'Judgments from the court' ,'<a>Gweld y Dyfarniad</a>',
        'Dyfarniadau gan y llys', 'Judgment.View', 'Scenario.AAA6.ClaimIssue.Response.Required', '{1, 1}', 'DEFENDANT', 15),
