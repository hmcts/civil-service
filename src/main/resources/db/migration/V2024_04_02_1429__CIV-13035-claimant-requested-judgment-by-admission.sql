...
VALUES ('Scenario.AAA6.ClaimantIntent.RequestedCCJ.Claimant','{"Notice.AAA6.DefResponse.FullOrPartAdmit.PayBySetDate.Claimant",
        ...
        "Notice.AAA6.DefResponse.OrgOrLtdCompany.FullOrPartAdmit.PayByInstalments.Claimant",
...
VALUES ('Notice.AAA6.ClaimantIntent.RequestedCCJ.Claimant', 'You requested a County Court Judgment against ${respondent1PartyName}', 'You requested a County Court Judgment against ${respondent1PartyName}',
        '<p class="govuk-body">You ${claimantRepaymentPlanDecision} the <a href="{VIEW_CCJ_REPAYMENT_PLAN_CLAIMANT}" class="govuk-link">repayment plan.</a></p><p class="govuk-body">When we''ve processed the request, we''ll post a copy of the judgment to you.</p><p class="govuk-body"><a href="{TELL_US_IT_IS_SETTLED}" rel="noopener noreferrer" class="govuk-link">Tell us it''s paid</a></p>',
        '<p class="govuk-body">You ${claimantRepaymentPlanDecision} the <a href="{VIEW_CCJ_REPAYMENT_PLAN_CLAIMANT}" class="govuk-link">repayment plan.</a></p><p class="govuk-body">When we''ve processed the request, we''ll post a copy of the judgment to you.</p><p class="govuk-body"><a href="{TELL_US_IT_IS_SETTLED}" rel="noopener noreferrer" class="govuk-link">Tell us it''s paid</a></p>',
        'CLAIMANT');
