...
VALUES ('Notice.AAA6.ClaimantIntent.SettlementAgreement.ClaimantAcceptsPlan.Defendant', 'Settlement agreement', 'Cytundeb setlo',
        '<p class="govuk-body">${applicant1PartyName} has accepted your offer and asked you to sign a settlement agreement. You must respond by ${respondent1SettlementAgreementDeadlineEn}. If you do not respond by then, or reject the agreement, they can request a County Court Judgment (CCJ). You can <a href="{VIEW_REPAYMENT_PLAN}" rel="noopener noreferrer" class="govuk_link">view the repayment plan</a> or <a href="{VIEW_RESPONSE_TO_CLAIM}" rel="noopener noreferrer" class="govuk_link">view your response</a>.</p>',
        '<p class="govuk-body">Mae ${applicant1PartyName} wedi derbyn eich cynnig ac wedi gofyn i chi lofnodi cytundeb setlo. Mae’n rhaid i chi ymateb erbyn ${respondent1SettlementAgreementDeadlineCy}. Os na fyddwch wedi ymateb erbyn hynny, neu os byddwch yn gwrthod y cytundeb, gallant wneud cais am Ddyfarniad Llys Sifil (CCJ). Gallwch <a href="{VIEW_REPAYMENT_PLAN}" rel="noopener noreferrer" class="govuk_link">weld y cynllun ad-dalu</a> neu <a href="{VIEW_RESPONSE_TO_CLAIM}" rel="noopener noreferrer" class="govuk_link">weld eich ymateb</a>.</p>',
        'DEFENDANT');
