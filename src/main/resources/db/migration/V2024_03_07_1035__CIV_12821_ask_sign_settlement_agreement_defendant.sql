...
VALUES ('Notice.AAA7.ClaimantIntent.SettlementAgreement.ClaimantAcceptsPlan.Defendant', 'Settlement agreement', 'Settlement agreement',
        '<p class="govuk-body">The claimant has accepted your plan and asked you to sign a settlement agreement.</p><p class="govuk-body">You must respond by ${respondent1SettlementAgreementDeadline}. If you do not respond by then, or reject the agreement, they can request a County Court Judgment.</p><p class="govuk-body"><a href="{VIEW_REPAYMENT_PLAN}" rel="noopener noreferrer" class="govuk-link">View the repayment plan</a></p><p class="govuk-body"><a href="{VIEW_RESPONSE_TO_CLAIM}" rel="noopener noreferrer" class="govuk-link">View your response</a></p>',
        '<p class="govuk-body">The claimant has accepted your plan and asked you to sign a settlement agreement.</p><p class="govuk-body">You must respond by ${respondent1SettlementAgreementDeadline}. If you do not respond by then, or reject the agreement, they can request a County Court Judgment.</p><p class="govuk-body"><a href="{VIEW_REPAYMENT_PLAN}" rel="noopener noreferrer" class="govuk-link">View the repayment plan</a></p><p class="govuk-body"><a href="{VIEW_RESPONSE_TO_CLAIM}" rel="noopener noreferrer" class="govuk-link">View your response</a></p>',
        'DEFENDANT');
