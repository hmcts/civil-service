...
values ('<a>View the claim</a>', 'The claim','<a>View the claim</a>',
        'The claim', 'Claim.View', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 2}', 'CLAIMANT', 1),
       ('<a>View information about the claimant</a>', 'The claim','<a>View information about the claimant</a>',
        'The claim', 'Claim.Claimant.Info', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 2}', 'CLAIMANT', 2),
       ...
       ('<a>View information about the defendant</a>', 'The response','<a>View information about the defendant</a>',
        'The response', 'Response.Defendant.Info', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 1}', 'CLAIMANT', 4),
       ('<a>View hearings</a>', 'Hearings','<a>View hearings</a>',
        'Hearings', 'Hearing.View', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 1}', 'CLAIMANT', 5),
       ('<a>Upload hearing documents</a>', 'Hearings' ,'<a>Upload hearing documents</a>',
        'Hearings', 'Hearing.Document.Upload', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 1}', 'CLAIMANT', 6),
       ('<a>Add the trial arrangements</a>', 'Hearings' ,'<a>Add the trial arrangements</a>',
        'Hearings', 'Hearing.Arrangements.Add', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 1}', 'CLAIMANT', 7),
       ...
       ('<a>View orders and notices</a>', 'Orders and notices from the court' ,'<a>View orders and notices</a>',
        'Orders and notices from the court', 'Order.View', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 2}', 'CLAIMANT', 10),
       ...
       ('<a>View applications</a>', 'Applications' ,'<a>View applications</a>',
        'Applications', 'Application.View', 'Scenario.AAA7.ClaimIssue.ClaimFee.Required', '{1, 1}', 'CLAIMANT', 12);
