...
VALUES ('Scenario.AAA6.Update.Defendant.TaskList.UploadDocuments.FinalOrders', '{"Notice.AAA6.CP.Trial.Arrangements.Required.Defendant"}', '{"Notice.AAA6.CP.OrderMade.Defendant" : ["orderDocument"]}');
...
VALUES ('<a>Upload hearing documents</a>', 'Hearing',
       ...
       ('<a>Add the trial arrangements</a>', 'Hearing' ,'<a>Ychwanegu trefniadau''r treial</a>',
        'Gwrandawiad', 'Hearing.Arrangements.Add', 'Scenario.AAA6.Update.Defendant.TaskList.UploadDocuments.FinalOrders', '{2, 2}', 'DEFENDANT', 12);
