...
VALUES ('Notice.AAA6.DefResponse.FullDefence.FullDispute.SuggestedMediation.Claimant', 'Response to the claim', 'Response to the claim',
        '<p class="govuk-body">The defendant has rejected the claim and agreed to mediation. You can reject or agree to mediation. You need to respond by ${applicant1ResponseDeadlineEn}.</p><p class="govuk-body"><a href="{CLAIMANT_RESPONSE_TASK_LIST}" rel="noopener noreferrer" class="govuk-link">View and respond</a></p>',
        '<p class="govuk-body">The defendant has rejected the claim and agreed to mediation. You can reject or agree to mediation. You need to respond by ${applicant1ResponseDeadlineCy}.</p><p class="govuk-body"><a href="{CLAIMANT_RESPONSE_TASK_LIST}" rel="noopener noreferrer" class="govuk-link">View and respond</a></p>',
        'CLAIMANT');
...
values ('<a href={VIEW_RESPONSE_TO_CLAIM} class="govuk-link">View the response to the claim</a>',
        ...
        'The response', 'Response.View', 'Scenario.AAA6.DefResponse.FullDefence.FullDispute.SuggestedMediation.Claimant', '{3, 3}', 'CLAIMANT', 3);
