...
VALUES ('Notice.AAA6.ClaimantIntent.RequestCCJ.ClaimantAcceptOrRejectPlan.SettlementRequested.NoDefResponse.Defendant', '${applicant1PartyName} has requested a County Court Judgment against you',
        ...
        '<p class="govuk-body">Mae ${applicant1PartyName} wedi ${claimantRepaymentPlanDecision} eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad. Ni wnaethoch lofnodi’r cytundeb.</p>'
        ...
        '<p class="govuk-body"><a href="{CITIZEN_CONTACT_THEM_URL}" class="govuk-link">Cysylltwch â ${applicant1PartyName}</a> os oes arnoch angen eu manylion talu.<br><a href={VIEW_DEFENDANT_RESPONSE} class="govuk-link">Gweld eich ymateb</a></p>',
        'DEFENDANT');
