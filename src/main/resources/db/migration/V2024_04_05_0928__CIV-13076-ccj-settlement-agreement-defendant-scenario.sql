...
VALUES ('Notice.AAA6.ClaimantIntent.RequestCCJ.ClaimantAcceptOrRejectPlan.SettlementRequested.NoDefResponse.Defendant', '${applicant1PartyName} has requested a County Court Judgment against you',
        ...
        '<p class="govuk-body"><a href="{CITIZEN_CONTACT_THEM_URL}" class="govuk-link">Contact ${applicant1PartyName}</a> if you need their payment details. <a href={VIEW_DEFENDANT_RESPONSE} class="govuk-link">View your response</a></p>',
        ...
        '<p class="govuk-body"><a href="{CITIZEN_CONTACT_THEM_URL}" class="govuk-link">Cysylltwch â ${applicant1PartyName}</a> os oes arnoch angen eu manylion talu. <a href={VIEW_DEFENDANT_RESPONSE} class="govuk-link">Gweld eich ymateb</a></p>',
        'DEFENDANT');
