...
VALUES ('Notice.AAA6.LiPQM.QueryResponded.Claimant',
        ...
        '<p class="govuk-body">The court has responded to the message you sent. <br> <a href="{QM_VIEW_MESSAGES_URL_CLICK}" target="_blank" rel="noopener noreferrer" class="govuk-link">View the message</a></p>',
        '<p class="govuk-body">Mae''r llys wedi ymateb i''r neges a anfonwyd gennych. <br> <a href="{QM_VIEW_MESSAGES_URL_CLICK}" target="_blank" rel="noopener noreferrer" class="govuk-link">Gweld y neges</a></p>',
        'CLAIMANT', 'Click');
