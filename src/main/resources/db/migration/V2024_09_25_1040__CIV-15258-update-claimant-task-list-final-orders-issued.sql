...
VALUES ('Scenario.AAA6.Update.Claimant.TaskList.TrialReady.FinalOrders',
...
VALUES ('<a>Upload hearing documents</a>', 'Hearing',
        ...
        'Hearing.Document.Upload', 'Scenario.AAA6.Update.Claimant.TaskList.TrialReady.FinalOrders', '{2, 2}', 'CLAIMANT', 10),
       ('<a>Add the trial arrangements</a>', 'Hearing' ,'<a>Ychwanegu trefniadau''r treial</a>',
        'Gwrandawiad', 'Hearing.Arrangements.Add', 'Scenario.AAA6.Update.Claimant.TaskList.TrialReady.FinalOrders', '{2, 2}', 'CLAIMANT', 12);
