...
VALUES ('Notice.AAA6.ClaimantIntent.GoToHearing.DefPartAdmit.FullDefence.StatesPaid.ClaimantConfirms.Defendant',
        ...
        '<p class="govuk-body">${applicant1PartyName} wants to proceed with the claim.</p><p class="govuk-body">They rejected your admission of ${admissionPaidAmount} although they accept you have already paid it.</p><p class="govuk-body">The case will be referred to a judge who will decide what should happen next.</p><p class="govuk-body">You can <a href="{VIEW_RESPONSE_TO_CLAIM}"  rel="noopener noreferrer" class="govuk-link">view your response</a> or <a target="_blank" href="{VIEW_CLAIMANT_HEARING_REQS}"  rel="noopener noreferrer" class="govuk-link">view the claimant''s hearing requirements</a>.</p>',
        '<p class="govuk-body">Mae ${applicant1PartyName} eisiau parhau â’r hawliad.</p><p class="govuk-body">Maent wedi gwrthod eich addefiad o ${admissionPaidAmount} ond yn derbyn eich bod wedi’i dalu’n barod.</p><p class="govuk-body">Bydd yr achos yn cael ei gyfeirio at farnwr a fydd yn penderfynu beth ddylai ddigwydd nesaf.</p><p class="govuk-body">Gallwch <a href="{VIEW_RESPONSE_TO_CLAIM}"  rel="noopener noreferrer" class="govuk-link">weld eich ymateb</a> neu <a target="_blank" href="{VIEW_CLAIMANT_HEARING_REQS}"  rel="noopener noreferrer" class="govuk-link">weld gofynion ar gyfer y gwrandawiad yr hawlydd</a>.</p>',
        'DEFENDANT');
