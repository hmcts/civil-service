                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mae eich hawliad nawr yn mynd i gyfryngu."
                            ...
                            + "Os na fyddwch yn mynychu’ch apwyntiad cyfryngu, efallai y bydd y barnwr yn eich cosbi.</p>"));
    }
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Bydd eich achos yn cael ei gyfeirio at y gwasanaeth cyfryngu." +
                            ...
                            "o wybodaeth am sut mae cyfryngu yn gweithio (yn agor mewn tab newydd)</a>. " +
