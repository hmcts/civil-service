    ...
    void should_create_online_notification_after_defendant_noc() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "CLAIMANT").andExpect(status().isOk()).andExpectAll(
            ...
            jsonPath("$[0].titleEn").value(
                "Mr. Sole Trader T/A Sole Trader co has assigned a legal representative to act on their behalf"),
            ...
            jsonPath("$[0].titleCy").value(
                "Mae Mr. Sole Trader T/A Sole Trader co wedi neilltuo cynrychiolydd cyfreithiol i weithredu ar ei ran"),
