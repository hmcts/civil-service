                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mae Mr. John Rambo eisiau parhau â’r hawliad. Mi wnaethant wrthod rhoi cynnig ar gyfryngu." +
                            ...
                            " <a href={VIEW_DEFENDANT_RESPONSE} class=\"govuk-link\">weld eich ymateb</a> neu <a target=\"_blank\" href={VIEW_CLAIMANT_HEARING_REQS} rel=\"noopener noreferrer\" class=\"govuk-link\">weld gofynion ar gyfer y gwrandawiad yr hawlydd (yn agor mewn tab newydd)</a>.</p>")
            );
    }
}
