        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "APPLICANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Byddwch yn cael help gyda’r ffi ${applicationFeeTypeCy}. Bydd ${remissionAmount} o’r ffi yn cael ei ddileu.</p>" +
                        "<p class=\"govuk-body\">I symud eich cais yn ei flaen, rhaid i chi dalu’r ffi sy’n weddill sef ${outstandingFeeInPounds}.</p>" +
