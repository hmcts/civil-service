        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy")
                    .value("<p class=\"govuk-body\">Mae Mr. John Rambo wedi gwrthod eich cynnig ac wedi gofyn i chi lofnodi cytundeb setlo. " +
                               "Mi wnaeth Mr. John Rambo gynnig cynllun ad-dalu newydd, ac yna mi wnaeth " +
                               "y llys ymateb gyda chynllun arall a gafodd ei dderbyn. " +
                               "Mae’n rhaid i chi ymateb erbyn " + DateUtils.formatDateInWelsh(responseDeadline.toLocalDate()) +
                               ". Os na fyddwch wedi ymateb erbyn hynny, neu os byddwch yn gwrthod y cytundeb, gallant wneud cais am Ddyfarniad Llys Sifil (CCJ). " +
