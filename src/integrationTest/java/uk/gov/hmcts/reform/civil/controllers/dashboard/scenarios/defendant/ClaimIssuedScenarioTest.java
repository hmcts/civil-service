    ...
    void should_create_scenario_for_claim_issue() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_TASKS_ITEMS_URL, caseId, "DEFENDANT")
            .andExpectAll(
                ...
                jsonPath("$[1].taskNameEn").value("<a href={VIEW_INFO_ABOUT_CLAIMANT}>View information about the claimant</a>"),
                ...
                jsonPath("$[3].taskNameEn").value("<a href={VIEW_INFO_ABOUT_DEFENDANT}>View information about the defendant</a>"),
                ...
                jsonPath("$[8].taskNameEn").value("<a href={VIEW_ORDERS_AND_NOTICES}>View orders and notices</a>"),
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn")
                    .value("You need to respond before 4 pm on " + hearingFeeByDate + ". There are {daysLeftToRespond} days remaining. <a href=\"{RESPONSE_TASK_LIST_URL}\">Respond to the claim.</a>.")
            );
    }
}
