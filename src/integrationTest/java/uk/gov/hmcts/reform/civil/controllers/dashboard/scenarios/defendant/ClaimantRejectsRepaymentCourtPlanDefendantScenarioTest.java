        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mi wnaeth Mr. John Rambo} wrthod eich <a href={CCJ_REPAYMENT_PLAN_DEFENDANT_URL} class=\"govuk-link\">cynllun ad-dalu</a> a chynllun arall a gynigwyd gan y llys yn seiliedig ar eich manylion ariannol. Mi wnaethant ofyn i farnwr wneud cynllun newydd.</p>" +
                        ...
                        "<a href=\"{APPLY_FOR_CERTIFICATE}\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"govuk-link\">wneud cais am dystysgrif (yn agor mewn tab newydd)</a> sy’n cadarnhau hyn.<br>" +
