        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "APPLICANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">The court has responded to the application. You must upload a document<a href=\"{GA_VIEW_APPLICATION_URL}\" class=\"govuk-link\">" +
                        " providing more information</a> to the court by 4pm on ${judgeRequestMoreInfoByDateEn}.</p>"),
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae’r llys wedi ymateb i’r cais. Rhaid i chi uwchlwytho dogfen sy’n <a href=\"{GA_VIEW_APPLICATION_URL}\" class=\"govuk-link\"> " +
