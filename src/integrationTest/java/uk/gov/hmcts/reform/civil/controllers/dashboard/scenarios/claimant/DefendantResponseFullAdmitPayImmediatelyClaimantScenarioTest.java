            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">James John has offered to pay £1001 by " +
                        DateUtils.formatDate(admitPaymentDeadline) + ". This amount includes interest if it has been claimed which will continue to accrue to the date of Judgment, settlement agreement or earlier payment.</p>" +
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae James John wedi cynnig talu £1001 erbyn " +
                        DateUtils.formatDateInWelsh(admitPaymentDeadline, false) + ". Mae’r swm hwn yn cynnwys llog os hawlir a fydd yn parhau i gronni hyd at ddyddiad y dyfarniad, cytundeb setlo neu daliad cynharach</p>" +
