            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">" + claimantName + "has requested CCJ against you, because the response deadline has passed.</p>"
                        ...
                        + "<p class=\"govuk-body\">If your deadline has passed, but the CCJ has not been issued, you can still respond. Get in touch with HMCTS on {civilMoneyClaimsTelephone} if you are in England and Wales, or 0300 790 6234 if you are in Scotland. You can call from Monday to Friday, between 8.30am to 5pm.</p>"
