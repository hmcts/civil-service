            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">We've rejected your application for help with the claim fee. See the email for "
                        + "further details. You must pay the full fee of £"
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Rydym wedi gwrthod eich cais am help i dalu ffi’r hawliad. Gweler yr e-bost am ragor o fanylion. " +
                        "Rhaid i chi dalu’r ffi lawn o £"
