            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">Your case will be referred for mediation. " +
                        "Your mediation appointment will be arranged within 28 days. <a href=\"{MEDIATION}\" rel=\"noopener noreferrer\" class=\"govuk-link\" target=\"_blank\">" +
                        "Find out more about how mediation works (opens in a new tab)</a>. " +
                        "They've also sent us their hearing requirements. <a href=\"{VIEW_CLAIMANT_HEARING_REQS}\" rel=\"noopener noreferrer\" class=\"govuk-link\" target=\"_blank\">" +
