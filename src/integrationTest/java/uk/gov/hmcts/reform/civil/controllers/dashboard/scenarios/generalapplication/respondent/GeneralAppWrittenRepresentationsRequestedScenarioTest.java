...
@Testcontainers
public class GeneralAppWrittenRepresentationsRequestedScenarioTest extends BaseIntegrationTest {

    public static final String SCENARIO_GA_WRITTEN_REPS_REQUESTED = "Scenario.AAA6.GeneralApps.WrittenRepresentationRequired.Respondent";
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">The court has requested that you must <a href={GA_VIEW_APPLICATION_URL}"
                        ...
                        + " by 4pm on ${writtenRepRespondentDeadlineDateEn}.</p>"),
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae'r llys wedi gofyn i chi <a href={GA_VIEW_APPLICATION_URL}"
                        ...
                        + " Rhaid i chi wneud hyn erbyn 4pm ar ${writtenRepRespondentDeadlineDateCy}.</p>")
            );
    }
}
