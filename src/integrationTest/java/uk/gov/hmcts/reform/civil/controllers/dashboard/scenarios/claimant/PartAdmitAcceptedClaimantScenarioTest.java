            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">Mr. Sole Trader has said that they will pay you £500 immediately " +
                        ...
                        "Funds must be received in your account by 19 March 2024. " +
                        "If you don´t receive the money by then, " +
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae Mr. Sole Trader wedi dweud y byddant yn talu £500 i chi ar " +
                        ...
                        "Rhaid i’r arian gyrraedd eich cyfrif erbyn 19 Mawrth 2024. " +
                        "Os nad ydych wedi cael yr arian erbyn hynny, gallwch " +
