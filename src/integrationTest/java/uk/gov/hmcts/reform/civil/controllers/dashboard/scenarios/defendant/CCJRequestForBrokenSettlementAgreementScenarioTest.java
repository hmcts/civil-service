        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">Mr. John Rambo accepted your repayment plan and asked you to sign a settlement. You signed the agreement but the claimant says you have broken the terms. When we've processed the request, we'll post a copy of the judgment to you. If you pay the debt within one month of the date of judgment, the County Court Judgment (CCJ) is removed from the public register. You can pay £15 to <a href=\"{APPLY_FOR_CERTIFICATE}\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"govuk-link\">apply for a certificate (opens in new tab)</a> that confirms this. <a href=\"{CITIZEN_CONTACT_THEM_URL}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">Contact Mr. John Rambo</a> if you need their payment details. <a href=\"{VIEW_RESPONSE_TO_CLAIM}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">View your response</a>.</p>"
                ),
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae Mr. John Rambo wedi derbyn eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad. " +
                        "Rydych wedi llofnodi’r cytundeb ond mae’r hawlydd yn dweud eich bod wedi torri’r telerau. " +
                        "Pan fyddwn wedi prosesu’r cais, byddwn yn anfon copi o’r dyfarniad drwy’r post atoch chi. " +
                        "Os byddwch yn talu’r ddyled o fewn mis o ddyddiad y dyfarniad, bydd y CCJ " +
                        ...
                        "wneud cais am dystysgrif (yn agor mewn ffenestr newydd)</a> sy’n cadarnhau hyn. " +
                        "<a href=\"{CITIZEN_CONTACT_THEM_URL}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">Cysylltwch â Mr. John Rambo</a>" +
                        " os oes arnoch angen eu manylion talu. <a href=\"{VIEW_RESPONSE_TO_CLAIM}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">Gweld eich ymateb</a>.</p>")
            );
    }
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae Mr. John Rambo wedi gwrthod eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad. " +
                        ...
                        "(yn agor mewn ffenestr newydd)</a> sy’n cadarnhau hyn. " +
                        "<a href=\"{CITIZEN_CONTACT_THEM_URL}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">Cysylltwch â Mr. John Rambo</a> " +
                        "os oes arnoch angen eu manylion talu. <a href=\"{VIEW_RESPONSE_TO_CLAIM}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">Gweld eich ymateb</a>." +
                        "</p>")
            );
    }
}
