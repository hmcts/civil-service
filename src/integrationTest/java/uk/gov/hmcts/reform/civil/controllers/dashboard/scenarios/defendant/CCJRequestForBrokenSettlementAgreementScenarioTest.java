            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae Mr. John Rambo wedi derbyn eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad. " +
                        "Rydych wedi llofnodi’r cytundeb ond mae’r hawlydd yn dweud eich bod wedi torri’r telerau.</p><p class=\"govuk-body\">" +
                        "Pan fyddwn wedi prosesu’r cais, byddwn yn anfon copi o’r dyfarniad drwy’r post atoch chi.</p><p class=\"govuk-body\">" +
