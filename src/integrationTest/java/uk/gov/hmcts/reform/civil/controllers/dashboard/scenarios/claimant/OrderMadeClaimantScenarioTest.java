...
public class OrderMadeClaimantScenarioTest extends DashboardBaseIntegrationTest {
    ...
    @Test
    void should_create_order_made_claimant_scenario_when_case_progression_not_enabled() throws Exception {
    ...
    @Test
    void should_create_order_made_claimant_all_orders_issued_fast_track_not_ready_trial_scenario() throws Exception {
    ...
    private static CallbackParams callbackParamsTest(CaseData caseData) {
        return CallbackParamsBuilder.builder()
            ...
            .request(CallbackRequest.builder().eventId(
                CaseEvent.CREATE_DASHBOARD_NOTIFICATION_FINAL_ORDER_CLAIMANT.name())
