            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">Mr. John Rambo accepted your repayment plan. When we've processed the request, " +
                        "we'll post a copy of the judgment to you. If you pay the debt within one month of the date of judgment, " +
                        ...
                        "that confirms this. <a href=\"{CITIZEN_CONTACT_THEM_URL}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">" +
                        "Contact Mr. John Rambo</a> if you need their payment details. <a href=\"{VIEW_RESPONSE_TO_CLAIM}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">View your response</a>.</p>"
                ),
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae Mr. John Rambo wedi derbyn eich cynllun ad-dalu. Pan fyddwn wedi prosesu’r cais, " +
                        "byddwn yn anfon copi o’r dyfarniad drwy’r post atoch chi. Os byddwch yn talu’r ddyled o fewn " +
                        ...
                        " (yn agor mewn tab newydd)</a> sy’n cadarnhau hyn. " +
                        "<a href=\"{CITIZEN_CONTACT_THEM_URL}\"  rel=\"noopener noreferrer\" class=\"govuk-link\">" +
                        "Cysylltwch â Mr. John Rambo</a> os oes arnoch angen eu manylion talu. " +
