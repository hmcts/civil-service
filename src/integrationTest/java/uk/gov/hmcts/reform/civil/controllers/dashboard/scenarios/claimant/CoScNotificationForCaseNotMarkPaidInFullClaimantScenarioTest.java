            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">The defendant who owed you money has told us that they paid in full on " + DateUtils.formatDate(
                        ...
                        "<br>If you have not been paid, you will need to write to the court where the judgment was issued within a month from " + DateUtils.formatDate(
                        coscFullPaymentDate) +
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae diffynnydd a oedd arnynt arian ichi wedi dweud wrthym eu bod wedi talu’n llawn ar " + DateUtils.formatDateInWelsh(
                        ...
                        "<br>Os nad ydych wedi cael eich talu, bydd angen i chi ysgrifennu at y llys lle cyhoeddwyd y dyfarniad o fewn mis i " + DateUtils.formatDateInWelsh(
                        coscFullPaymentDate) +
