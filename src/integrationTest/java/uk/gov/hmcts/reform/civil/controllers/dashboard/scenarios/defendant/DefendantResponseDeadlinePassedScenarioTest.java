        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn")
                    .value("<p class=\"govuk-body\">You have not responded to the claim. "
                               + "Claimant John can now request a county court judgment."
                               + " You can still respond to the claim before they ask for a judgment. "
                               + "A County Court Judgment can mean you find it difficult to get credit, like a mortgage or mobile phone contact."
                               + " Bailiffs could also be sent to your home. "
                               + "<a href=\"{RESPONSE_TASK_LIST_URL}\" class=\"govuk-link\">Respond to"
                               + " claim</a></p>"),
                jsonPath("$[0].descriptionCy")
                    .value("<p class=\"govuk-body\">Nid ydych wedi ymateb i’r hawliad. "
                               + "Gall Claimant John nawr wneud cais am ddyfarniad llys sirol."
                               + " Gallwch dal ymateb i’r hawliad cyn iddynt wneud cais am ddyfarniad. "
                               + "Gall Dyfarniad Llys Sirol olygu eich bod yn ei chael hi'n anodd cael credyd, fel morgais neu gontract ffôn symudol."
                               + " Gallai beilïaid hefyd gael eu hanfon i'ch cartref. "
