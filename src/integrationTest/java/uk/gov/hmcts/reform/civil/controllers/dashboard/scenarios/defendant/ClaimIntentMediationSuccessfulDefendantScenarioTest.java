        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn")
                    .value(
                        "<p class=\"govuk-body\">You made an agreement which means the claim is now ended and sets out the terms of how you must repay Mr. John Rambo. <a href=\"{MEDIATION_SUCCESSFUL_URL}\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"govuk-link\">Download the agreement</a>.</p><p class=\"govuk-body\"><a href=\"{CITIZEN_CONTACT_THEM_URL}\" rel=\"noopener noreferrer\" class=\"govuk-link\">Contact Mr. John Rambo</a> if you need their payment details. Make sure you get receipts for any payments.</p>"),
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mi wnaethoch gytundeb sy’n golygu bod yr hawliad nawr ar ben. Mae’r " +
                            "cytundeb yn nodi’r telerau ar gyfer sut mae rhaid i chi ad-dalu Mr. John Rambo. " +
                            "<a href=\"{MEDIATION_SUCCESSFUL_URL}\" target=\"_blank\" rel=\"noopener noreferrer\" " +
                            "class=\"govuk-link\">Lawrlwytho’r cytundeb</a>." +
                            "</p> <p class=\"govuk-body\"><a href=\"{CITIZEN_CONTACT_THEM_URL}\" rel=\"noopener noreferrer\" class=\"govuk-link\">Cysylltwch â " +
