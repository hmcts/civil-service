package uk.gov.hmcts.reform.civil.controllers.dashboard.notifications.defendant;
...
public class DefendantResponseFullDefenceFullDisputeFastTrackScenarioTest extends DashboardBaseIntegrationTest {
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">You have rejected the claim." +
