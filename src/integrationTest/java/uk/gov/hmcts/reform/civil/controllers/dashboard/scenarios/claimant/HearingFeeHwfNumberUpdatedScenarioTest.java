...
public class HearingFeeHwfNumberUpdatedScenarioTest extends DashboardBaseIntegrationTest {
    ...
    void should_create_hearing_fee_hwf_number__scenario() throws Exception {
        ...
        CaseData caseData = CaseDataBuilder.builder().atStateTrialReadyCheckLiP(false).build()
            ...
            .hearingHwfDetails(new HelpWithFeesDetails().setHwfCaseEvent(CaseEvent.UPDATE_HELP_WITH_FEE_NUMBER))
