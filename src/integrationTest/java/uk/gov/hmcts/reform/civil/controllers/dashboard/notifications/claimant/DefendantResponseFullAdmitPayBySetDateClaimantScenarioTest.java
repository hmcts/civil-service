package uk.gov.hmcts.reform.civil.controllers.dashboard.notifications.claimant;
...
public class DefendantResponseFullAdmitPayBySetDateClaimantScenarioTest extends DashboardBaseIntegrationTest {
    ...
    void should_create_full_admit_pay_setdate_claimant_scenario() throws Exception {
        ...
        CaseData caseData = CaseDataBuilder.builder().atStateRespondentFullAdmissionSpec().build()
            ...
            .businessProcess(new BusinessProcess().setActivityId(DEFENDANT_RESPONSE_CUI))
            .build();
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "CLAIMANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">James John has offered to pay you £1001 (this amount includes interest " +
                        "if it has been claimed which may continue to accrue to the date of Judgment, settlement agreement or earlier " +
                        "payment) by " + DateUtils.formatDate(admitPaymentDeadline) + ".</p>" +
                        "<p class=\"govuk-body\"><a href=\"{CLAIMANT_RESPONSE_TASK_LIST}\" class=\"govuk-link\">View and respond</a></p>"
                ),
                jsonPath("$[0].titleCy").value("Ymateb i’r hawliad"),
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Mae James John wedi cynnig talu £1001 (mae’r swm hwn yn cynnwys llog os yw wedi’i hawlio " +
                        "a gall barhau i gronni hyd dyddiad y Dyfarniad, y cytundeb setlo neu daliad cynharach) i chi erbyn " +
