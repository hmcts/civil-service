            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">You've applied for help with the ${applicationFeeTypeEn} fee, but the reference number is invalid.</p>" +
                        "<p class=\"govuk-body\">You've been sent an email with instructions on what to do next. If you've already read the email and taken action, you can disregard this message.</p>" +
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Rydych wedi gwneud cais am help i dalu'r ffi gwneud ${applicationFeeTypeCy}, ond mae'r cyfeirnod yn annilys.</p>" +
                        "<p class=\"govuk-body\">Anfonwyd e-bost atoch gyda chyfarwyddiadau ar beth i'w wneud nesaf. Os ydych wedi darllen yr e-bost yn barod ac wedi gweithredu, gallwch anwybyddu'r neges hon.</p>" +
