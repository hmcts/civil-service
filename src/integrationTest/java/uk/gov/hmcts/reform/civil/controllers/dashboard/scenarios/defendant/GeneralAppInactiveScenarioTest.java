...
public class GeneralAppInactiveScenarioTest extends BaseIntegrationTest {
    ...
    public static final String SCENARIO_GA_INACTIVE = "Scenario.AAA6.GeneralApplication.InitiateApplication.Inactive.Defendant";
    ...
    void should_create_scenario_for_general_application_action_needed() throws Exception {
        ...
        doPost(BEARER_TOKEN,
               ...
               DASHBOARD_CREATE_SCENARIO_URL, SCENARIO_GA_INACTIVE, caseId
        )
