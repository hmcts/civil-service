...
@Testcontainers
public class NonUrgentApplicatioUncloakedRespondentScenarioTest extends BaseIntegrationTest {

    public static final String SCENARIO_NON_URGENT_APPLICATION_UNCLOAKED_RESPONDENT = "Scenario.AAA6.GeneralApps.NonUrgentApplicationUncloaked.Respondent";
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">Review their request and respond to it by 4pm on"
                        + " ${judgeRequestMoreInfoByDateEn}. After this date, the application will go to a judge"
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Dylech adolygu eu cais ac ymateb iddo erbyn 4pm ar"
                        + " ${judgeRequestMoreInfoByDateCy}. Ar ôl y dyddiad hwn, bydd y cais yn mynd at farnwr a"
