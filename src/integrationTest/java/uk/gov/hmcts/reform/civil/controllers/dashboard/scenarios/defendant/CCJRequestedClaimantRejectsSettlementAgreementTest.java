        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn")
                    .value(
                        "<p class=\"govuk-body\">Mr. John Rambo rejected your repayment plan and asked you to sign a settlement. You did not sign the agreement.</p><p class=\"govuk-body\">" +
                            "When we've processed the request, we'll post a copy of the judgment to you.</p><p class=\"govuk-body\">" +
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mae Mr. John Rambo wedi gwrthod eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad." +
                            ...
                            "byddwn yn anfon copi o’r dyfarniad drwy'r post atoch chi.</p><p class=\"govuk-body\">" +
                            ...
                            "</p><p class=\"govuk-body\"><a href=\"{CITIZEN_CONTACT_THEM_URL}\" class=\"govuk-link\">Cysylltwch â Mr. John Rambo</a>" +
