        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mae Mr. John Rambo wedi rejected  eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad. Ni wnaethoch lofnodi’r cytundeb.</p><p class=\"govuk-body\">Pan fyddwn wedi prosesu’r cais, byddwn yn anfon copi o’r dyfarniad drwy'r post atoch chi.</p>" +
                            "<p class=\"govuk-body\">Os byddwch yn talu’r ddyled o fewn mis o ddyddiad y dyfarniad, bydd y Dyfarniad Llys Sirol (CCJ) yn cael ei ddileu o’r gofrestr gyhoeddus. Gallwch dalu £15 i <a href={APPLY_FOR_CERTIFICATE} class=\"govuk-link\" target=\"_blank\" rel=\"noopener noreferrer\">" +
                            " wneud cais am dystysgrif (yn agor mewn tab newydd)</a> sy’n cadarnhau hyn.</p><p class=\"govuk-body\"><a href=\"{CITIZEN_CONTACT_THEM_URL}\" class=\"govuk-link\">Cysylltwch â Mr. John Rambo</a> os oes arnoch angen eu manylion talu.<br>" +
                            "<a href={VIEW_DEFENDANT_RESPONSE} class=\"govuk-link\">Gweld eich ymateb</a></p>")
