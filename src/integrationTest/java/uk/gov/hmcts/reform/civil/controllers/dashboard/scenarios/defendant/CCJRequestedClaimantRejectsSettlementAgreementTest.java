        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn")
                    .value(
                        "<p class=\"govuk-body\">Mr. John Rambo rejected your repayment plan and asked you to sign a settlement. You did not sign the agreement. " +
                            "When we've processed the request, we'll post a copy of the judgment to you. " +
                            "If you pay the debt within one month of the date of judgment, the County Court Judgment (CCJ) " +
                            ...
                            "that confirms this. <a href=\"{CITIZEN_CONTACT_THEM_URL}\" class=\"govuk-link\">Contact Mr. John Rambo</a> " +
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mae Mr. John Rambo wedi rejected eich cynllun ad-dalu ac wedi gofyn i chi lofnodi setliad." +
                            " Ni wnaethoch lofnodi’r cytundeb. Pan fyddwn wedi prosesu’r cais, " +
                            "byddwn yn anfon copi o’r dyfarniad drwy'r post atoch chi. " +
                            "Os byddwch yn talu’r ddyled o fewn mis o ddyddiad y dyfarniad, bydd y Dyfarniad Llys Sirol (CCJ) " +
                            ...
                            "<a href=\"{CITIZEN_CONTACT_THEM_URL}\" class=\"govuk-link\">Cysylltwch â Mr. John Rambo</a>" +
                            " os oes arnoch angen eu manylion talu. <a href={VIEW_DEFENDANT_RESPONSE} class=\"govuk-link\">Gweld eich ymateb</a></p>")
