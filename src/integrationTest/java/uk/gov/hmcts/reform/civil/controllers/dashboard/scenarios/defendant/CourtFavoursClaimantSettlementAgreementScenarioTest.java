                ...
                jsonPath("$[0].descriptionEn")
                    .value(
                        "<p class=\"govuk-body\">Mr. John Rambo has rejected your offer and asked " +
                            "you to sign a settlement agreement. " +
                            "Mr. John Rambo has proposed a new repayment plan and the court has agreed with it, " +
                            "based on the financial details you provided. " +
                            "You must respond by 16 March 2024. If you do not respond by then, " +
                            "or reject the agreement, they can request a County Court Judgment (CCJ). " +
                            "You can <a href=\"{VIEW_REPAYMENT_PLAN}\"  rel=\"noopener noreferrer\" " +
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mae Mr. John Rambo wedi gwrthod eich cynnig ac wedi gofyn " +
                            "i chi lofnodi cytundeb setlo. " +
                            "Mae Mr. John Rambo wedi cynnig cynllun ad-dalu newydd, " +
                            "ac mae’r llys wedi cytuno iddo, yn seiliedig ar y manylion ariannol a ddarparwyd gennych. " +
                            "Mae’n rhaid i chi ymateb erbyn 16 Mawrth 2024. Os na fyddwch wedi " +
                            "ymateb erbyn hynny, neu os byddwch yn gwrthod y cytundeb, gallant wneud cais am Ddyfarniad Llys Sifil (CCJ). " +
                            "Gallwch <a href=\"{VIEW_REPAYMENT_PLAN}\"  rel=\"noopener noreferrer\" " +
