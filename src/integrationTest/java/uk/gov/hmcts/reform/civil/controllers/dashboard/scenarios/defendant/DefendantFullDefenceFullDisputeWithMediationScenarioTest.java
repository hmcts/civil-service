        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn")
                    .value("<p class=\"govuk-body\">You have rejected the claim and agreed to mediation.The claimant can reject or agree to mediation.</p>" +
                              "<p class=\"govuk-body\">The court will contact you when they respond.<br>"
