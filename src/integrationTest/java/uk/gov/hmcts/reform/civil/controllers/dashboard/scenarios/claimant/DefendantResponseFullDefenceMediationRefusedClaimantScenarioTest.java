    ...
    void should_create_full_defence_mediation_refused_response_scenario() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "CLAIMANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value("<p class=\"govuk-body\">James John has rejected the claim and refused mediation. You need to respond by 21 March 2024. <a href=\"{CLAIMANT_RESPONSE_TASK_LIST}\" class=\"govuk-link\">View and respond</a></p>"),
                jsonPath("$[0].descriptionCy").value("<p class=\"govuk-body\">Mae James John wedi gwrthod yr hawliad ac wedi gwrthod cyfryngu. Mae angen i chi ymateb erbyn 21 Mawrth 2024. <a href=\"{CLAIMANT_RESPONSE_TASK_LIST}\" class=\"govuk-link\">Gweld ac ymateb</a></p>")
            );
    }
}
