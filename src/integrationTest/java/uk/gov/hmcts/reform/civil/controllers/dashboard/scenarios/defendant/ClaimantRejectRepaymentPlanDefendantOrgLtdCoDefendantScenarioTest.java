            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">Company one has rejected your payment plan, the court will issue a County Court Judgment (CCJ)."
                          ...
                          +  " reference to {cmcCourtEmailId} or send by post to: {cmcCourtAddress}</p>"),
                ...
                .andExpectAll(
                        ...
                        jsonPath("$[0].descriptionCy").value(
                                "<p class=\"govuk-body\">Mae Applicant Org wedi gwrthod eich cynllun talu, a bydd y llys yn cyhoeddi Dyfarniad " +
                                    ...
                                    "post. Anfonwch y manylion a rhif eich hawliad reference ar e-bost i {cmcCourtEmailId} neu postiwch yr wybodaeth i: " +
                                    "{cmcCourtAddress}</p>"));
    }
}
