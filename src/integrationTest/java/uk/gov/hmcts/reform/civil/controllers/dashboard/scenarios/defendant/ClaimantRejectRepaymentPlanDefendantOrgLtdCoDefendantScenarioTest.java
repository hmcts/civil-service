            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy").value(
                        "<p class=\"govuk-body\">Mae Company one wedi gwrthod eich cynllun talu, a bydd y llys yn " +
                            ...
                            "<br>Ni fydd eich cyfrif ar-lein yn cael ei ddiweddaru - bydd unrhyw ddiweddariadau pellach yn cael eu hanfon drwy’r post." +
                ...
                .andExpectAll(
                        ...
                        jsonPath("$[0].descriptionCy").value(
                                "<p class=\"govuk-body\">Mae Applicant Org wedi gwrthod eich cynllun talu, a bydd y llys yn cyhoeddi Dyfarniad " +
                                    ...
                                    "<br>Ni fydd eich cyfrif ar-lein yn cael ei ddiweddaru - bydd unrhyw ddiweddariadau pellach yn cael eu hanfon drwy’r " +
                                    "post.<br>Anfonwch y manylion a rhif eich hawliad reference ar e-bost i {cmcCourtEmailId} neu postiwch yr wybodaeth i: </p>" +
                                    "<p class=\"govuk-body\">{cmcCourtAddress}</p>"));
    }
}
