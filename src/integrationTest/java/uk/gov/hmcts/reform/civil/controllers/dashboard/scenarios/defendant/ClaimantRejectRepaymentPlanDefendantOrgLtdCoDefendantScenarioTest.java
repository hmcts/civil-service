        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy").value(
                        "<p class=\"govuk-body\">Mae Company one wedi gwrthod eich cynllun talu, a bydd y llys yn cyhoeddi Dyfarniad Llys Sirol (CCJ). Os nad ydych yn cytuno â’r dyfarniad, gallwch anfon eich manylion ariannol i’r llys a gofyn am ailbenderfyniad." +
                            "<br>Ni fydd eich cyfrif ar-lein yn cael ei ddiweddaru - bydd unrhyw ddiweddariadau pellach yn cael eu hanfon drwy’r post.<br>Anfonwch y manylion a rhif eich hawliad reference ar e-bost i {cmcCourtEmailId} neu postiwch yr wybodaeth i: </p>" +
    ...
    void should_create_scenario_for_full_admit_reject_repaymentPlan_scenario() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
                ...
                .andExpectAll(
                        ...
                        jsonPath("$[0].titleCy").value("Bydd y llys yn adolygu’r manylion ac yn cyhoeddi dyfarniad"),
                        jsonPath("$[0].descriptionCy").value(
                                "<p class=\"govuk-body\">Mae Applicant Org wedi gwrthod eich cynllun talu, a bydd y llys yn cyhoeddi Dyfarniad Llys Sirol (CCJ). Os nad ydych yn cytuno â’r dyfarniad, gallwch anfon eich manylion ariannol i’r llys a gofyn am ailbenderfyniad." +
                                    "<br>Ni fydd eich cyfrif ar-lein yn cael ei ddiweddaru - bydd unrhyw ddiweddariadau pellach yn cael eu hanfon drwy’r post.<br>Anfonwch y manylion a rhif eich hawliad reference ar e-bost i {cmcCourtEmailId} neu postiwch yr wybodaeth i: </p>" +
                                    "<p class=\"govuk-body\">{cmcCourtAddress}</p>"));
    }
}
