    ...
    void should_create_part_admit_defendant_response_scenario() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "CLAIMANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value("<p class=\"govuk-body\">James John has offered to pay £300 by 18 March 2024. The payment must be received in your account by then, if not you can request a county court judgment. <a href=\"{CLAIMANT_RESPONSE_TASK_LIST}\" class=\"govuk-link\">View and respond</a></p>"),
                jsonPath("$[0].descriptionCy").value("<p class=\"govuk-body\">Mae James John wedi cynnig talu £300 erbyn 18 Mawrth 2024. Rhaid i’r taliad fod yn eich cyfrif erbyn y dyddiad hwnnw. Os nad yw, yna gallwch wneud cais am ddyfarniad llys sirol. <a href=\"{CLAIMANT_RESPONSE_TASK_LIST}\" class=\"govuk-link\">Gweld ac ymateb</a></p>")
            );
