    ...
    void should_create_scenario_for_claim_fee_required() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_TASKS_ITEMS_URL, caseId, "CLAIMANT")
            .andExpectAll(
                ...
                jsonPath("$[1].taskNameEn").value("<a href={VIEW_INFO_ABOUT_CLAIMANT_URL}>View information about the claimant</a>"),
                ...
                jsonPath("$[9].taskNameEn").value("<a href={VIEW_ORDERS_AND_NOTICES_URL}>View orders and notices</a>"),
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "CLAIMANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value("Your claim has not yet been issued, in order to proceed you must pay the claim fee of £70. <a href={CLAIM_FEE_URL}>Pay the claim fee</a>.")
            );
    }
