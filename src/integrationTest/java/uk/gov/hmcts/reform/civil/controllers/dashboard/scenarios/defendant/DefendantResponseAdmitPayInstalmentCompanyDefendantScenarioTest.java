            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionEn").value(
                    "<p class=\"govuk-body\">You have offered to pay Claimant John £1000 in instalments of £10 every week." +
                        ...
                        " You need to send the claimant your financial details. The court will contact you when they respond. " +
                ...
                jsonPath("$[0].descriptionCy").value(
                    "<p class=\"govuk-body\">Rydych wedi cynnig talu £1000 mewn rhandaliadau o £10 i Claimant John bob week." +
                        ...
                        " Mae angen i chi anfon eich manylion ariannol at yr hawlydd. Bydd y llys yn cysylltu â chi pan fyddant yn ymateb. " +
