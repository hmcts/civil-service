                ...
                jsonPath("$[0].descriptionEn")
                    .value(
                        "<p class=\"govuk-body\">Mr. John Rambo has accepted your offer and asked you to sign a settlement agreement. " +
                            ...
                            "<a href=\"{VIEW_REPAYMENT_PLAN}\" rel=\"noopener noreferrer\" class=\"govuk_link\">view the repayment plan</a> or " +
                            "<a href=\"{VIEW_RESPONSE_TO_CLAIM}\" rel=\"noopener noreferrer\" class=\"govuk_link\">view your response</a>.</p>"),
