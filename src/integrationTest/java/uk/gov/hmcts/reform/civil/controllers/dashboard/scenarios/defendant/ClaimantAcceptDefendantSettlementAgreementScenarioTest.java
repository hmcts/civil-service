    ...
    void should_create_scenario_for_claimant_accept_defendant_plan_settlement_agreement() throws Exception {
        ...
        doPost(
            ...
            ScenarioRequestParams.builder()
                .params(new HashMap<>(Map.of("respondent1SettlementAgreementDeadlineEn", "16 March 2024",
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, "DEFENDANT")
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">mr claimant has accepted your offer and asked you to sign a settlement agreement. You must respond by 16 Mawrth 2024.</p><p class=\"govuk-body\">If you do not respond by then, or " +
