    ...
    void should_create_mediation_scenario() throws Exception {
        ...
        doGet(BEARER_TOKEN, GET_NOTIFICATIONS_URL, caseId, CLAIMANT)
            ...
            .andExpectAll(
                ...
                jsonPath("$[0].descriptionCy")
                    .value(
                        "<p class=\"govuk-body\">Mi wnaethoch gytundeb sy’n golygu bod yr hawliad nawr ar ben. Mae’r cytundeb yn nodi’r telerau ar gyfer sut mae'n rhaid i Mr. Sole Trader eich ad-dalu.</p>" +
