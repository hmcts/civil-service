...
@Testcontainers
public class ClaimantMediationSuccessfulDashboardNotificationScenarioTest extends BaseIntegrationTest {
    ...
    void should_create_mediation_scenario() throws Exception {
        ...
        doPost(BEARER_TOKEN,
               ScenarioRequestParams.builder()
                   .params(Map.of())
                   .build(),
               DASHBOARD_CREATE_SCENARIO_URL, SCENARIO_AAA6_CLAIMANT_MEDIATION_SUCCESSFUL.getScenario(), caseId
        )
