...
@SpringBootTest(classes = {Application.class, TestIdamConfiguration.class, CoreCaseDataApiMockHelperConfiguration.class}, properties = {
    "test.id=ClaimDetailsNotificationDeadlineSchedulerIT",
    "scheduler.claim-details-notification-deadline.enabled=true",
    "scheduler.lockAtLeastFor=PT0S"
})
public class ClaimDetailsNotificationDeadlineSchedulerIT {
