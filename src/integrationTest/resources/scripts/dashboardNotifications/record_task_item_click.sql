...
VALUES(12257, 'task_name_en', 'hint_text_en', 'category_en', 'task_name_cy', 'hint_text_cy', 'category_cy', 'name', array[1,2,3,4,5], 'defendant', 0, now());
...
VALUES('8c2712da-47ce-4050-bbee-650134a7b9e7', 12257, '125', 0, 1, 'task_name_en', 'hint_text_en', 'task_name_cy', 'hint_text_cy', null, '2024-01-01T10:15:30+00:00', null, 'Test');
