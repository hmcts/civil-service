...
INSERT INTO dbs.scenario (id, name, notifications_to_delete, notifications_to_create, created_at)
VALUES (9997, 'Scenario.AAA7.ClaimIssue.ClaimFee.Required.Test', '{"Notice.AAA7.ClaimIssue.ClaimSubmit.Required.Test"}',
        '{"Notice.AAA7.ClaimIssue.ClaimFee.Required.Test" : ["claimFee"]}',
        '2021-05-09T20:15:45.345875+01:00');

INSERT INTO dbs.dashboard_notifications_Templates (id, template_name, title_En, title_Cy, description_En, description_Cy
                                                  ,notification_role, time_to_live, created_at)
VALUES (9997, 'Notice.AAA7.ClaimIssue.ClaimFee.Required.Test', 'You need to pay your claim fee', 'You need to pay your claim fee',
