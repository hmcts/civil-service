...
@SpringBootTest(
    ...
    properties = {
        ...
        "robotics.notification.recipient:Courtney.Suhr@hmcts.net",
        "robotics.notification.specRecipient:Courtney.Suhr@hmcts.net",
        "robotics.notification.multipartyrecipient:Courtney.Suhr@hmcts.net",
