...
class SetAsideJudgementRequestClaimantEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    private SetAsideJudgementRequestClaimantEmailDTOGenerator generator;
    ...
    void shouldReturnLipTemplate() {
        ...
        assertThat(generator.getReferenceTemplate()).isEqualTo("set-aside-judgment-applicant-notification-lip-%s");
    }
}
