...
public class CaseDataBuilder {
    ...
    public CaseData buildJudmentOnlineCaseDataWithPaymentImmediately() {
        return build().toBuilder()
            ...
            .respondent1(Party.builder().type(Party.Type.SOLE_TRADER)
                             .soleTraderFirstName("First")
                             .soleTraderLastName("Last")
                             .primaryAddress(Address.builder().addressLine1("78 This Street").build())
                             .soleTraderDateOfBirth(LocalDate.of(1950, 12, 12))
                             .build())
            .joJudgmentRecordReason(JudgmentRecordedReason.JUDGE_ORDER)
            .joAmountOrdered("1200")
            .joAmountCostOrdered("1100")
    ...
    public CaseData buildJudgmentOnlineCaseWithMarkJudgementPaidAfter31Days() {
        return build().toBuilder()
            .ccdState(CaseState.All_FINAL_ORDERS_ISSUED)
            .respondent1(Party.builder().soleTraderFirstName("First")
                             .soleTraderLastName("Last")
                             .primaryAddress(Address.builder().addressLine1("78 This Street").build())
                             .soleTraderDateOfBirth(LocalDate.of(1950, 12, 12))
                             .build())
