...
public class ClaimantDefendantAgreedMediationAppSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private ClaimantDefendantAgreedMediationAppSolOneEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("mediation-agreement-applicant-notification-%s");
    }
