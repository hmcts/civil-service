...
public class BundleCreationPartiesEmailGeneratorTest {

    @Mock
    private BundleCreationAppSolOneEmailDTOGenerator appSolOneEmailDTOGenerator;

    @Mock
    private BundleCreationRespSolOneEmailDTOGenerator respSolOneEmailDTOGenerator;

    @Mock
    private BundleCreationRespSolTwoEmailDTOGenerator respSolTwoEmailDTOGenerator;

    @Mock
    private BundleCreationClaimantEmailDTOGenerator claimantEmailDTOGenerator;

    @Mock
    private BundleCreationDefendantEmailDTOGenerator defendantEmailDTOGenerator;

    @Mock
    private SimpleStateFlowEngine stateFlowEngine;

    @InjectMocks
    private BundleCreationPartiesEmailGenerator emailGenerator;
    ...
    @Test
    void shouldNotifyClaimantAndDefendant_whenUnrepresented() {
        CaseData caseData = mock(CaseData.class);
