...
public class RespondentOneAuthoritiesDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentOneAuthoritiesDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyLegalRep1ChangesToLegalRep2() {
        ...
        CaseData caseData = CaseData.builder()
                .documentAuthoritiesRes(List.of(
        ...
        assertEquals(1, builder.build().getDocumentAuthoritiesRes2().size());
    }
