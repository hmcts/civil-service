...
class ServiceRequestUpdateClaimIssuedCallbackControllerUnitTest {
    ...
    void shouldProcessAuthorisedServiceRequestUpdate() {
        ...
        verify(requestUpdateCallbackService).processCallback(request, FeeType.CLAIMISSUED.name());
    }
    ...
    void shouldThrowInternalServerErrorWhenServiceIsNotAuthorised() {
        ...
        verify(requestUpdateCallbackService, never()).processCallback(request, FeeType.CLAIMISSUED.name());
    }
    ...
    void shouldWrapExceptionThrownWhileProcessingCallback() {
        ...
        doThrow(exception).when(requestUpdateCallbackService)
            .processCallback(request, FeeType.CLAIMISSUED.name());
