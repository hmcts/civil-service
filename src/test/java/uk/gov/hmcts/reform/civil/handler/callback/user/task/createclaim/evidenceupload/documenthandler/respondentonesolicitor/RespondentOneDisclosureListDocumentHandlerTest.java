...
public class RespondentOneDisclosureListDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentOneDisclosureListDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyDisclosureListDocumentsToLegalRep2() {
        ...
        CaseData caseData = CaseData.builder()
                .documentDisclosureListRes(List.of(
        ...
        assertEquals(1, builder.build().getDocumentDisclosureListRes2().size());
    }
