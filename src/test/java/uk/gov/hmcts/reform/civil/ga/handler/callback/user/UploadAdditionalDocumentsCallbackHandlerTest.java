...
class UploadAdditionalDocumentsCallbackHandlerTest
    ...
    @InjectMocks private UploadAdditionalDocumentsCallbackHandler handler;

    @Mock private IdamClient idamClient;

    @Mock private AssignCategoryId assignCategoryId;

    @Mock private DocUploadDashboardNotificationService docUploadDashboardNotificationService;
    ...
    class AboutToSubmit {
        ...
        public void setUp() throws IOException {
            when(idamClient.getUserInfo(anyString()))
                    .thenReturn(UserInfo.builder().sub(DUMMY_EMAIL).uid(STRING_CONSTANT).build());
        }

        @Test
        void shouldSetUpReadyBusinessProcessWhenJudgeUncloaked() {
            when(gaForLipService.isGaForLip(any(GeneralApplicationCaseData.class)))
                    .thenReturn(false);
            ...
            assertThat(responseCaseData.getBusinessProcess().getCamundaEvent())
                    .isEqualTo(UPLOAD_ADDL_DOCUMENTS.toString());
            ...
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            ...
                            .generalAppInformOtherParty(
                                    new GAInformOtherParty().setIsWithNotice(YES))
                            .parentClaimantIsApplicant(YES)
                            .generalAppApplnSolicitor(
                                    new GASolicitorDetailsGAspec()
                                            .setId(STRING_CONSTANT)
        ...
        void shouldSetUpReadyBusinessProcessWhenApplicationIsNonUrgentAndAddedToRespCollection() {
            ...
            uploadDocumentByRespondent.add(
                    element(
                            new UploadDocumentByType()
                                    .setDocumentType("witness")
                                    .setAdditionalDocument(
            ...
            verify(docUploadDashboardNotificationService)
        ...
        @Test
        void
                shouldSetUpReadyBusinessProcessWhenApplicationIsConsentOrderAndAddedToResp1Collection1v2() {
            when(gaForLipService.isGaForLip(any(GeneralApplicationCaseData.class)))
                    .thenReturn(false);
        ...
        @Test
        void
                shouldSetUpReadyBusinessProcessWhenApplicationIsConsentOrderAndAddedToResp2Collection1v2() {
            when(gaForLipService.isGaForLip(any(GeneralApplicationCaseData.class)))
                    .thenReturn(false);
        ...
        @Test
        void
                shouldSetUpReadyBusinessProcessWhenApplicationIsConsentOrderAndAddedToResp2Collection1v2MultipleCollection() {
            when(gaForLipService.isGaForLip(any(GeneralApplicationCaseData.class)))
                    .thenReturn(false);
