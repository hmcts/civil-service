...
public class ApplicationIssuedFeeRequiredHandlerTest
    ...
    @InjectMocks private ApplicationIssuedFeeRequiredHandler handler;

    @Test
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents())
                .contains(CREATE_DASHBOARD_NOTIFICATION_FOR_GA_APPLICANT);
    }
