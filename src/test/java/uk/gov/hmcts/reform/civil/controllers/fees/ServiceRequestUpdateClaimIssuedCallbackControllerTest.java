...
class ServiceRequestUpdateClaimIssuedCallbackControllerTest {
    ...
    private ServiceRequestUpdateClaimIssuedCallbackController controller;

    @BeforeEach
    void setUp() {
        controller = new ServiceRequestUpdateClaimIssuedCallbackController(
    ...
    @Test
    void shouldProcessClaimIssuedPaymentCallback_whenServiceIsAuthorised() {
        ...
        verify(requestUpdateCallbackService).processCallback(serviceRequestUpdateDto(), FeeType.CLAIMISSUED.name());
    }
