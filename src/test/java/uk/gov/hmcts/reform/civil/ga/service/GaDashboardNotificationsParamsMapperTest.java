...
public class GaDashboardNotificationsParamsMapperTest {
    ...
    @InjectMocks private GaDashboardNotificationsParamsMapper mapper;
    ...
    void shouldMapAllParametersWhenIsRequested() {
                ...
                GeneralApplicationCaseDataBuilder.builder()
                        ...
                        .judicialDecisionRequestMoreInfo(
                                new GAJudicialRequestMoreInfo()
                                        ...
                                        .setJudgeRequestMoreInfoByDate(requestMoreInfoDate))
                        .build();
        ...
        assertThat(result)
                .extracting("generalAppNotificationDeadlineDateEn")
                .isEqualTo("21 March 2024");
        assertThat(result)
                .extracting("generalAppNotificationDeadlineDateCy")
                .isEqualTo("21 Mawrth 2024");
        assertThat(result)
                .extracting("judgeRequestMoreInfoByDate")
                .isEqualTo(requestMoreInfoDate.atTime(END_OF_BUSINESS_DAY));
    ...
    void shouldMapWrittenRepSequentialDeadlinesClaimantIsApplicantWhenIsRequested() {
        ...
        assertThat(result)
                .extracting("writtenRepApplicantDeadline")
                .isEqualTo(claimantDate.atTime(END_OF_BUSINESS_DAY));
        assertThat(result)
                .extracting("writtenRepApplicantDeadlineDateEn")
                .isEqualTo("1 March 2024");
        assertThat(result)
                .extracting("writtenRepApplicantDeadlineDateCy")
                .isEqualTo("1 Mawrth 2024");
        assertThat(result)
                .extracting("writtenRepRespondentDeadline")
                .isEqualTo(defendantDate.atTime(END_OF_BUSINESS_DAY));
        assertThat(result)
                .extracting("writtenRepRespondentDeadlineDateEn")
                .isEqualTo("2 March 2024");
        assertThat(result)
                .extracting("writtenRepRespondentDeadlineDateCy")
                .isEqualTo("2 Mawrth 2024");
    }
                ...
                GeneralApplicationCaseDataBuilder.builder()
                        ...
                        .generalAppHelpWithFees(
                                new HelpWithFees()
                                        ...
                                        .setHelpWithFeesReferenceNumber("HWF-A1B-23C"))
    ...
    void shouldMapParametersWhenHwfApplicationFeeIsRequestedAndIsPartAdmitted_PartRemission() {
        caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        ...
                        .gaHwfDetails(
                                new HelpWithFeesDetails()
                                        .setHwfCaseEvent(CaseEvent.PARTIAL_REMISSION_HWF_GA)
                                        .setRemissionAmount(BigDecimal.valueOf(7500))
                                        .setOutstandingFee(new BigDecimal("200.00")))
                        .build();
    ...
    @Test
    void
            shouldMapParametersWhenHwfAdditionalApplicationFeeIsRequestedAndIsPartAdmitted_PartRemission() {
        caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .build()
                        .copy()
    ...
    @Test
    void
            shouldMapParametersWhenHwfApplicationFeeIsRequestedAndCaseStateIsAwaitingApplicationPayment() {
        caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .build()
                        .copy()
                        ...
                        .generalAppType(
                                new GAApplicationType()
                                        .setTypes(List.of(GeneralApplicationTypes.VARY_ORDER)))
                        .generalAppHelpWithFees(
                                new HelpWithFees()
                                        .setHelpWithFee(YesOrNo.YES)
                                        .setHelpWithFeesReferenceNumber("HWF-A1B-23C"))
    ...
    @Test
    void
            shouldMapParametersWhenHwfAdditionalApplicationFeeIsRequestedAndCaseStateIsApplicationAddPayment() {
        caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .build()
                        .copy()
    ...
    void shouldNotMapDataWhenNotPresent() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder().buildMakePaymentsCaseData().build();
    ...
    void shouldMapAllParametersWhenIsRequestedForHearingScheduled() {
        ...
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .buildCaseWorkerHearingScheduledInfo()
                        .build();
        Map<String, Object> result = mapper.mapCaseDataToParams(caseData);
        assertThat(result)
                .extracting("hearingNoticeApplicationDateEn")
                .isEqualTo("4 September 2024");
