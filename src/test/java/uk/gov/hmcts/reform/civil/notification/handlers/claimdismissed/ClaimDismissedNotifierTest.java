...
class ClaimDismissedNotifierTest extends NotifierTestBase {

    @InjectMocks
    private ClaimDismissedNotifier notifier;

    @Test
    void shouldReturnCorrectTaskId() {
        String taskId = notifier.getTaskId();
        assertThat(taskId).isEqualTo(ClaimDismissedNotifyParties.toString());
    }
