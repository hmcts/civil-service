...
class ApplicationsProceedOfflineDefendantDashboardServiceTest {
    ...
    @InjectMocks private ApplicationsProceedOfflineDefendantDashboardService service;
    ...
    void shouldRecordScenariosWhenEligible() {
        List<Element<GeneralApplication>> applications =
                wrapElements(new GeneralApplication().setCaseLink(new CaseLink("123")));
    ...
    void shouldOnlyRecordInitiateScenarioWhenNoLiveApplications() {
        List<Element<GeneralApplication>> applications =
                wrapElements(new GeneralApplication().setCaseLink(new CaseLink("123")));
        List<Element<GADetailsRespondentSol>> respondentDetails =
                wrapElements(new GADetailsRespondentSol().setCaseState("Application Dismissed"));
