...
public class ClaimantResponseNotAgreedRepaymentRespSolOneEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    private ClaimantResponseNotAgreedRepaymentRespSolOneEmailDTOGenerator emailDTOGenerator;
