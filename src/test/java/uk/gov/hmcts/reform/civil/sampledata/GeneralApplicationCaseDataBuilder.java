...
public class GeneralApplicationCaseDataBuilder {
    ...
    private static final Fee FEE108 =
            new Fee()
                    ...
                    .setCode("FEE0443")
                    .setVersion("1");
    private static final Fee FEE14 =
            new Fee()
                    .setCalculatedAmountInPence(BigDecimal.valueOf(1400))
                    .setCode("FEE0458")
                    .setVersion("2");
    ...
    public GeneralApplicationCaseDataBuilder generalAppDeadlineNotificationDate(
            LocalDateTime generalAppDeadlineNotificationDate) {
        this.generalAppDeadlineNotificationDate = generalAppDeadlineNotificationDate;
        return this;
    }

    public GeneralApplicationCaseDataBuilder generalApplications(
            List<Element<GeneralApplication>> generalApplications) {
        this.generalApplications = generalApplications;
        return this;
    }

    public GeneralApplicationCaseDataBuilder generalAppApplnSolicitor(
    ...
    public GeneralApplicationCaseDataBuilder applicantSolicitor1UserDetails(
            IdamUserDetails applicantSolicitor1UserDetails) {
        this.applicantSolicitor1UserDetails = applicantSolicitor1UserDetails;
        return this;
    }

    public GeneralApplicationCaseDataBuilder generalAppRespondentSolicitors(
    ...
    public GeneralApplicationCaseDataBuilder makeAppVisibleToRespondents(
    ...
    public GeneralApplicationCaseDataBuilder generalAppParentCaseLink(
            GeneralAppParentCaseLink generalAppParentCaseLink) {
        this.generalAppParentCaseLink = generalAppParentCaseLink;
        return this;
    }

    public GeneralApplicationCaseDataBuilder parentClaimantIsApplicant(
    ...
    public GeneralApplicationCaseDataBuilder gaInformOtherParty(
            GAInformOtherParty gaInformOtherParty) {
        this.gaInformOtherParty = gaInformOtherParty;
        return this;
    }

    public GeneralApplicationCaseDataBuilder gaUrgencyRequirement(
            GAUrgencyRequirement gaUrgencyRequirement) {
        this.gaUrgencyRequirement = gaUrgencyRequirement;
        return this;
    }

    public GeneralApplicationCaseDataBuilder gaRespondentOrderAgreement(
            GARespondentOrderAgreement gaRespondentOrderAgreement) {
    ...
    public GeneralApplicationCaseDataBuilder gaPbaDetails(
            GeneralApplicationPbaDetails gaPbaDetails) {
        this.gaPbaDetails = gaPbaDetails;
        return this;
    }

    public GeneralApplicationCaseDataBuilder applicant1OrganisationPolicy(
            OrganisationPolicy applicant1OrganisationPolicy) {
        this.applicant1OrganisationPolicy = applicant1OrganisationPolicy;
        return this;
    }

    public GeneralApplicationCaseDataBuilder respondent1OrganisationPolicy(
            OrganisationPolicy respondent1OrganisationPolicy) {
        this.respondent1OrganisationPolicy = respondent1OrganisationPolicy;
        return this;
    }

    public GeneralApplicationCaseDataBuilder respondent2SameLegalRepresentative(
            YesOrNo respondent2SameLegalRepresentative) {
        this.respondent2SameLegalRepresentative = respondent2SameLegalRepresentative;
        return this;
    }

    public GeneralApplicationCaseDataBuilder respondent2OrganisationPolicy(
            OrganisationPolicy respondent2OrganisationPolicy) {
        this.respondent2OrganisationPolicy = respondent2OrganisationPolicy;
        return this;
    }

    public GeneralApplicationCaseDataBuilder judicialDecisionMakeOrder(
            GAJudicialMakeAnOrder judicialMakeAnOrder) {
    ...
    public GeneralApplicationCaseDataBuilder approveConsentOrder(
            GAApproveConsentOrder approveConsentOrder) {
        this.approveConsentOrder = approveConsentOrder;
        return this;
    }

    public GeneralApplicationCaseDataBuilder caseManagementLocation(
            CaseLocationCivil caseManagementLocation) {
    ...
    public GeneralApplicationCaseDataBuilder judicialDecisionRequestMoreInfo(
    ...
    public GeneralApplicationCaseData buildMakePaymentsCaseData() {
        ...
        return build().copy()
                ...
                .generalAppApplnSolicitor(
                        new GASolicitorDetailsGAspec().setOrganisationIdentifier("OrgId"))
                .build();
    }
                ...
                .generalAppPBADetails(
                        new GeneralApplicationPbaDetails()
                                .setPaymentSuccessfulDate(
                                        LocalDateTime.of(
                                                LocalDate.of(2020, 1, 1), LocalTime.of(12, 0, 0)))
                                .setPaymentDetails(
                                        new PaymentDetails()
    ...
    public GeneralApplicationCaseData buildCaseDateBaseOnGeneralApplication(
    ...
    public GeneralApplicationCaseData buildCaseDateBaseOnGeneralApplicationByState(
            GeneralApplication application, CaseState state) {
        return new GeneralApplicationCaseData()
                .ccdState(state)
                .generalAppType(application.getGeneralAppType())
                .caseLink(application.getCaseLink())
    ...
    public GeneralApplicationCaseData buildCaseDateBaseOnGaForCollection(
            GeneralApplication application) {
        return new GeneralApplicationCaseData()
    ...
    private GeneralApplicationPbaDetails convert(GAPbaDetails gaPbaDetails) {
        final GeneralApplicationPbaDetails generalApplicationPBADetails =
                new GeneralApplicationPbaDetails();
        generalApplicationPBADetails.setPaymentSuccessfulDate(
                gaPbaDetails.getPaymentSuccessfulDate());
        ...
        generalApplicationPBADetails.setAdditionalPaymentServiceRef(
                gaPbaDetails.getAdditionalPaymentServiceRef());
        generalApplicationPBADetails.setAdditionalPaymentDetails(
                gaPbaDetails.getAdditionalPaymentDetails());
        return generalApplicationPBADetails;
    }

    public GeneralApplicationCaseData buildFeeValidationCaseData(
            Fee fee, boolean isConsented, boolean isWithNotice) {
        ...
        return new GeneralApplicationCaseData()
                ...
                .generalAppRespondentAgreement(
                        new GARespondentOrderAgreement().setHasAgreed(isConsented ? YES : NO))
                .generalAppInformOtherParty(gaInformOtherParty)
                .generalAppPBADetails(
                        new GeneralApplicationPbaDetails()
                                .setFee(fee)
    ...
    public GeneralApplicationCaseData consentOrderApplication() {
        return new GeneralApplicationCaseData()
                ...
                .generalAppParentCaseLink(
                        new GeneralAppParentCaseLink().setCaseReference(PARENT_CASE_ID))
                ...
                .approveConsentOrder(
                        new GAApproveConsentOrder().setConsentOrderDescription("testing purpose"))
    ...
    public GeneralApplicationCaseData hearingOrderApplication(
            YesOrNo isAgreed, YesOrNo isWithNotice) {
        return new GeneralApplicationCaseData()
                .ccdCaseReference(CASE_ID)
                .generalAppParentCaseLink(
                        new GeneralAppParentCaseLink().setCaseReference(PARENT_CASE_ID))
                ...
                .generalAppRespondentAgreement(
                        new GARespondentOrderAgreement().setHasAgreed(isAgreed))
    ...
    public GeneralApplicationCaseData hearingScheduledApplication(YesOrNo isCloak) {
        ...
        GeneralApplicationsDetails generalApplicationsDetails =
                new GeneralApplicationsDetails()
                        ...
                        .setCaseLink(new CaseLink(String.valueOf(CASE_ID)));
        ...
        return new GeneralApplicationCaseData()
                ...
                .gaDetailsMasterCollection(
                        wrapElements(
                                new GeneralApplicationsDetails()
                                        .setCaseState(LISTING_FOR_A_HEARING.getDisplayedValue())
                                        .setCaseLink(new CaseLink(String.valueOf(CASE_ID)))))
                .claimantGaAppDetails(wrapElements(generalApplicationsDetails))
                ...
                .gaHearingNoticeApplication(
                        new GAHearingNoticeApplication()
                                .setHearingNoticeApplicationDate(now())
                                .setHearingNoticeApplicationDetail(
                                        HearingApplicationDetails.CLAIMANT_AND_DEFENDANT)
        ...
        return new GeneralApplicationCaseData()
                ...
                .judicialDecisionMakeAnOrderForWrittenRepresentations(
                        new GAJudicialWrittenRepresentations()
                                ...
                                .setSequentialApplicantMustRespondWithin(now().plusDays(5)))
                .submittedOn(APPLICATION_SUBMITTED_DATE);
    }
        ...
        return new GeneralApplicationCaseData()
                ...
                .generalAppPBADetails(
                        new GeneralApplicationPbaDetails()
                                ...
                                .setServiceReqReference(CUSTOMER_REFERENCE))
                .createdDate(LocalDateTime.now())
                .generalAppType(new GAApplicationType().setTypes(singletonList(ADJOURN_HEARING)))
                .generalAppHearingDate(generalAppHearingDate)
                .generalAppRespondentAgreement(
                        new GARespondentOrderAgreement().setHasAgreed(isRespondentAgreed))
                .businessProcess(new BusinessProcess().setCamundaEvent(JUDGES_DECISION))
                .submittedOn(APPLICATION_SUBMITTED_DATE);
    }
    ...
    public GeneralApplicationCaseData getMainCaseDataWithDetails(
        ...
        if (withGADetails) {
            caseDataBuilder.claimantGaAppDetails(wrapElements(generalApplicationsDetails));
        }

        if (withGADetailsMaster) {
            caseDataBuilder.gaDetailsMasterCollection(wrapElements(generalApplicationsDetails));
        }
    ...
    public GeneralApplicationCaseData buildJudicialDecisionRequestMoreInfo() {
        return new GeneralApplicationCaseData()
                ...
                .judicialDecisionRequestMoreInfo(
                        new GAJudicialRequestMoreInfo()
                                .setRequestMoreInfoOption(REQUEST_MORE_INFORMATION)
                                .setJudgeRequestMoreInfoByDate(LocalDate.of(2024, 9, 4)))
                .build();
    }
    ...
    public GeneralApplicationCaseData buildCaseWorkerHearingScheduledInfo() {
        return new GeneralApplicationCaseData()
                ...
                .gaHearingNoticeDetail(
                        new GAHearingNoticeDetail().setHearingDate((LocalDate.of(2024, 9, 4))))
                .build();
    }
}
