...
class BaseRoboticsDataMapperTest {
    ...
    void shouldReturnOrganisationId() {
        uk.gov.hmcts.reform.civil.model.Organisation org =
            uk.gov.hmcts.reform.civil.model.Organisation.builder().organisationID("ORG123").build();
        uk.gov.hmcts.reform.civil.model.OrganisationPolicy policy = uk.gov.hmcts.reform.civil.model.OrganisationPolicy.builder().organisation(org).build();
