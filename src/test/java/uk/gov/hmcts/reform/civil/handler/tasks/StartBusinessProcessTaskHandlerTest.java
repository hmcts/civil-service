...
import static uk.gov.hmcts.reform.civil.callback.CaseEvent.CLAIM_SETTLED_LETTER_NOTIFICATION;
...
class StartBusinessProcessTaskHandlerTest {
    ...
    void shouldSetClaimSettledLetterRequired_whenClaimSettledLetterProcess(YesOrNo respondent1Represented,
        ...
        BusinessProcess businessProcess = BusinessProcess.ready(CLAIM_SETTLED_LETTER_NOTIFICATION);
        CaseData caseData = new CaseDataBuilder().atStateClaimDraft().businessProcess(businessProcess).build();
