...
public class ReferToJudgeOrLegalAdvisorHandlerTest
    ...
    @InjectMocks private ReferToJudgeOrLegalAdvisorHandler handler;
                ...
                callbackParamsOf(
                        ...
                        .request(
                                CallbackRequest.builder()
                                        .eventId("REFER_TO_LEGAL_ADVISOR")
                                        .build());
    ...
    void aboutToStartCallbackShouldNotThrowErrorCourtValidationState_BeforeSDO_ReferToJudge() {
        CallbackParams params =
                callbackParamsOf(
                                ...
                                CallbackType.ABOUT_TO_START)
                        .copy()
                        .request(CallbackRequest.builder().eventId("REFER_TO_JUDGE").build());
        List<String> errors = new ArrayList<>();
        var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        assertThat(response).isNotNull();
        assertThat(response.getErrors()).isEqualTo(errors);
    ...
    @Test
    void
            aboutToStartCallbackShouldNotThrowErrorCourtValidationState_BeforeSDO_WithReferToLegalAdvisor() {
        CallbackParams params =
                callbackParamsOf(
                                getCase(APPLICATION_SUBMITTED_AWAITING_JUDICIAL_DECISION, YES),
                                CallbackType.ABOUT_TO_START)
    ...
    @Test
    void
            aboutToStartCallbackShouldThrowErrorCourtValidationState_AfterSDO_WithReferToLegalAdvisor() {
        CallbackParams params =
                callbackParamsOf(
                                getCase(APPLICATION_SUBMITTED_AWAITING_JUDICIAL_DECISION, NO),
                                CallbackType.ABOUT_TO_START)
