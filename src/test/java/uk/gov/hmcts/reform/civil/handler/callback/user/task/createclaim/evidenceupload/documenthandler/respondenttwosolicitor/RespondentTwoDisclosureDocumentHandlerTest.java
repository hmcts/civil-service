...
@Slf4j
public class RespondentTwoDisclosureDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentTwoDisclosureDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldRenameDocumentsThroughHandleDocuments() {
        ...
        CaseData caseData = CaseData.builder()
                .documentForDisclosureRes2(List.of(
        ...
        log.info("Bundle name: {}", caseData.getDocumentForDisclosureRes2().get(0).getValue().getBundleName());
