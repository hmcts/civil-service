...
public class CreateRespondentDashboardNotificationForApplicationSubmittedHandlerTest
    ...
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents())
                .contains(CREATE_APPLICATION_SUBMITTED_DASHBOARD_NOTIFICATION_FOR_RESPONDENT);
    }
    ...
    class AboutToSubmitCallback {
        ...
        @Test
        void
                shouldRecordApplicationSubmittedRespondentScenarioForWithNoticeNonUrgentApplicationWhenInvoked() {
            ...
            caseData =
                    caseData.copy()
                            ...
                            .generalAppUrgencyRequirement(
                                    new GAUrgencyRequirement().setGeneralAppUrgency(YesOrNo.NO))
                            .build();
                    ...
                    CallbackParamsBuilder.builder()
                            ...
                            .request(
                                    CallbackRequest.builder()
                                            .eventId(
                                                    CREATE_APPLICATION_SUBMITTED_DASHBOARD_NOTIFICATION_FOR_RESPONDENT
                                                            .name())
                                            .build())
                            .build();
        ...
        @Test
        void
                shouldRecordApplicationSubmittedRespondentScenarioForWithNoticeUrgentApplicationWhenInvoked() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withNoticeCaseData()
        ...
        @Test
        void
                shouldRecordApplicationSubmittedRespondentScenarioForWithConsentNonUrgentApplicationWhenInvoked() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withNoticeCaseData()
        ...
        @Test
        void
                shouldRecordApplicationSubmittedRespondentScenarioForWithConsentUrgentApplicationWhenInvoked() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withNoticeCaseData()
