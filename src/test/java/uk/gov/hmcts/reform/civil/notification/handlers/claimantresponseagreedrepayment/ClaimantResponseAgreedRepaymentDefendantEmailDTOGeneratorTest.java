...
public class ClaimantResponseAgreedRepaymentDefendantEmailDTOGeneratorTest {

    @InjectMocks
    private ClaimantResponseAgreedRepaymentDefendantEmailDTOGenerator emailDTOGenerator;
