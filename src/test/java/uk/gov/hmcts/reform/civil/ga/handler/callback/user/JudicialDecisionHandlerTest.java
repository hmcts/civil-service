...
public class JudicialDecisionHandlerTest extends GeneralApplicationBaseCallbackHandlerTest {
    ...
    @InjectMocks private JudicialDecisionHandler handler;

    @Mock private JudicialDecisionWrittenRepService service;

    @Mock private JudicialDecisionHelper helper;

    @Mock private GeneralAppLocationRefDataService locationRefDataService;

    @Mock private Time time;

    @Mock private DeadlinesCalculator deadlinesCalculator;
    ...
    @Mock private GeneralOrderGenerator generalOrderGenerator;

    @Mock private RequestForInformationGenerator requestForInformationGenerator;

    @Mock private DirectionOrderGenerator directionOrderGenerator;

    @Mock private DismissalOrderGenerator dismissalOrderGenerator;

    @Mock private HearingOrderGenerator hearingOrderGenerator;

    @Mock
    private WrittenRepresentationConcurrentOrderGenerator
            writtenRepresentationConcurrentOrderGenerator;

    @Mock
    private WrittenRepresentationSequentialOrderGenerator
            writtenRepresentationSequentialOrderGenerator;

    @Mock private FreeFormOrderGenerator gaFreeFormOrderGenerator;

    @Mock private IdamClient idamClient;

    @Mock private CoreCaseDataService coreCaseDataService;

    @Mock private JudicialTimeEstimateHelper timeEstimateHelper;

    @Mock private AssignCaseToRespondentSolHelper assignCaseToResopondentSolHelper;
    ...
    private static final DateTimeFormatter DATE_FORMATTER_SUBMIT_CALLBACK =
            DateTimeFormatter.ofPattern("dd/MM/yyyy");
    private static final String EXPECTED_DISMISSAL_ORDER = "This application is dismissed.\n\n";

    private static final String JUDICIAL_REQUEST_MORE_INFO_RECITAL_TEXT =
            "<Title> <Name> \n"
                + "Upon reviewing the application made and upon considering the information"
                + " provided by the parties, the court requests more information from the"
                + " applicant.";

    public static final String MAKE_DECISION_APPROVE_BY_DATE_IN_PAST =
            "The date entered cannot be in the past.";

    private static final String ON_INITIATIVE_SELECTION_TEST =
            "As this order was made on the court's own initiative, any party affected by the order"
                + " may apply to set aside, vary, or stay the order. Any such application must be"
                + " made by 4pm on";
    private static final String WITHOUT_NOTICE_SELECTION_TEXT =
            "If you were not notified of the application before "
    ...
    class AboutToStartCallbackHandling {
        ...
        @BeforeEach
        void setUp() {
            when(deadlinesCalculator.getJudicialOrderDeadlineDate(any(), anyInt()))
        ...
        void testAboutToStartForHearingGeneralOrderRecital() {
            ...
            String expecetedJudicialTimeEstimateText =
                    "Both applicant and respondent estimate it would take %s.";
            ...
            CallbackParams params =
                    callbackParamsOf(getHearingOrderApplnAndResp(types, NO, YES), ABOUT_TO_START);
        ...
        void testAboutToStartForHearingPreferLocationsApplicantRespondent() {
            ...
            List<GeneralApplicationTypes> types =
                    List.of(
                            (GeneralApplicationTypes.STAY_THE_CLAIM),
                            (GeneralApplicationTypes.SUMMARY_JUDGEMENT));
            var caseDataApplicantRespondent1 =
                    getHearingOrderAppForCourtLocationPreference(types, YES, YES, NO);
            var caseDataApplicantRespondent2 =
                    getHearingOrderAppForCourtLocationPreference(types, YES, NO, YES);
            ...
            assertThat(responseCaseData.getJudgeHearingCourtLocationText1())
                    .isEqualTo(
                            String.format(
                                    expectedJudicialPreferenceLocationApplicantRespondent1Text,
                                    caseDataApplicantRespondent1
                                            .getGeneralAppHearingDetails()
                                            .getHearingPreferredLocation()
                                            .getValue()
                                            .getLabel(),
                                    caseDataApplicantRespondent1
                                            .getRespondentsResponses()
                                            .getFirst()
                                            .getValue()
                                            .getGaHearingDetails()
                                            .getHearingPreferredLocation()
            ...
            assertThat(responseCaseData.getJudgeHearingCourtLocationText1())
                    .isEqualTo(
                            String.format(
                                    expectedJudicialPreferenceLocationApplicantRespondent2Text,
                                    caseDataApplicantRespondent2
                                            .getGeneralAppHearingDetails()
                                            .getHearingPreferredLocation()
                                            .getValue()
                                            .getLabel(),
        ...
        void testAboutToStartForHearingOnlyRespondent1Respondent2LocationPreference() {
            ...
            assertThat(responseCaseData.getJudgeHearingCourtLocationText1())
                    .isEqualTo(
                            String.format(
                                    expectedOnlyRespondent1LocationText,
        ...
        void testAboutToStartForHearingOnlyRespondent2LocationPreference() {
            ...
            assertThat(responseCaseData.getJudgeHearingCourtLocationText1())
                    .isEqualTo(
                            String.format(
                                    expectedOnlyRespondent2LocationText,
                                    caseData.getRespondentsResponses()
                                            .get(1)
                                            .getValue()
                                            .getGaHearingDetails()
        ...
        void testAboutToStartForHearingOnlyApplicantLocationPreference() {
            ...
            assertThat(responseCaseData.getJudgeHearingCourtLocationText1())
                    .isEqualTo(
                            String.format(
                                    expectedOnlyRespondent1LocationText,
                                    caseData.getGeneralAppHearingDetails()
                                            .getHearingPreferredLocation()
                                            .getValue()
                                            .getLabel()));
        }
        ...
        void testSolicitorsHearingDetailsWithNoSupportText() {
            ...
            builder.generalAppHearingDetails(
                    new GAHearingDetails()
            ...
            String expectedJudicialSupportText =
                    "Applicant requires no support. Respondent 1 requires no support. Respondent 2"
                        + " requires no support.";
        ...
        void testAboutToStartForHearingDetails() {
            ...
            String expectedJudicialPreferenceLocationText =
                    "Applicant prefers Location %s. Respondent 1 prefers Location %s. Respondent 2"
                        + " prefers Location %s.";
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp1and2(types, NO, YES, YES), ABOUT_TO_START);
            ...
            caseData =
                    caseData.copy()
                            .generalAppHearingDetails(
                                    caseData.getGeneralAppHearingDetails()
                                            .copy()
                                            .setHearingDuration(null))
                            .respondentsResponses(respondentResponses)
                            .build();
            CallbackParams params = callbackParamsOf(caseData, ABOUT_TO_START);
            String expectedJudicialTimeEstimateText =
                    "Applicant and respondent have not provided estimates";
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldReturnEmptyStringForNullSupportReq() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getCaseDateWithNoSupportReq(respondentResponse, urgentApp),
                            ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void testAboutToStartForHearingScreenForUrgentApp() {
            ...
            String expectedJudicialSupportReqText =
                    "Applicant requires Hearing loop, Other support";
        ...
        void testHearingScreenSupportReqWithNoApplnHearingSupport() {
            ...
            GAUrgencyRequirement urgentApp = new GAUrgencyRequirement().setGeneralAppUrgency(YES);

            CallbackParams params =
                    callbackParamsOf(getCaseDateWithNoSupportReq(null, urgentApp), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void testHearingScreenSupportReqWithNoApplnHearingSupportAndRespWithSupportReq() {
            ...
            String expectedJudicialSupportReqText =
                    "Applicant requires no support. "
                            + "Respondent requires Other support, Hearing loop.";

            GAUrgencyRequirement urgentApp = new GAUrgencyRequirement().setGeneralAppUrgency(YES);

            List<Element<GARespondentResponse>> respondentResponse =
                    getRespodentResponses(hasRespondentResponseVul);

            CallbackParams params =
                    callbackParamsOf(
                            getCaseDateWithNoApplicantSupportReq(respondentResponse, urgentApp),
                            ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldMatchHearingReqForDifferentPreferences() {
            ...
            String expectedJudicialTimeEstimateText =
                    "Applicant estimates 45 minutes. Respondent estimates 1 hour.";
            String expectedJudicialPreferenceText =
                    "Applicant prefers Video conference hearing. Respondent "
                            + "prefers In person.";
            String expectedJudicialSupportReqText =
                    "Applicant requires Disabled access, Sign language interpreter. "
                            + "Respondent requires Other support, Hearing loop.";
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getCaseDateWithHearingScreeen1V1(types, NO, YES), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void testAboutToStartForNotifiedApplication() {
            String expectedRecitalText =
                    "The Judge considered the application of the claimant dated 15 January"
                        + " 2022\n\n";
            when(helper.isApplicationCreatedWithoutNoticeByApplicant(any())).thenReturn(NO);
            CallbackParams params =
                    callbackParamsOf(getNotifiedApplication(YES, YES), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
            ...
            assertThat(makeAnOrder.getJudgeRecitalText())
                    .isEqualTo(
                            String.format(
                                    expectedRecitalText, DATE_FORMATTER.format(LocalDate.now())));
        ...
        void testAboutToStartForNotifiedApplicationInitiatedByDefendant() {
            String expectedRecitalText =
                    "The Judge considered the application of the defendant dated 15 January"
                        + " 2022\n\n";
            when(helper.isApplicationCreatedWithoutNoticeByApplicant(any())).thenReturn(NO);
            CallbackParams params =
                    callbackParamsOf(getNotifiedApplication(YES, NO), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void testAboutToStartForCloakedApplicationInitiatedByClaimant() {
            String expectedRecitalText =
                    "The Judge considered the without notice application of the claimant dated 15"
                        + " January 2022\n\n"
        ...
        void testAboutToStartForUnCloakedApplicationInitiatedByDefendant() {
            String expectedRecitalText =
                    "The Judge considered the without notice application of the defendant dated 15"
                        + " January 2022\n\n"
        ...
        void testAboutToStartForRequestMoreInfoCloakedAppln() {
            ...
            GAJudicialRequestMoreInfo gaJudicialRequestMoreInfo =
                    getJudicialRequestMoreInfo(response);
        ...
        void testJudgeRecitalTextForRequestMoreInfoWithNoticeByDefendant() {
            ...
            // isWithNotice = YES
            CallbackParams params =
                    callbackParamsOf(getApplicationByParentCaseDefendant(), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldReturnYesForJudgeApproveEditOptionDateIfGATypeIsStayClaim() {
            ...
            CallbackParams params =
                    callbackParamsOf(getHearingOrderApplnAndResp(types, NO, NO), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);

            assertThat(response).isNotNull();
            GAJudicialMakeAnOrder makeAnOrder = getJudicialMakeAnOrder(response);

            assertThat(makeAnOrder.getDisplayjudgeApproveEditOptionDate()).isEqualTo(YES);
        }
        ...
        @Test
        void
                shouldReturnNOForJudgeApproveEditOptionDateIfGATypesIsNotEitherExtendTimeORStayClaim() {

            List<GeneralApplicationTypes> types =
                    List.of((GeneralApplicationTypes.SUMMARY_JUDGEMENT));
            ...
            assertThat(makeAnOrder.getDisplayjudgeApproveEditOptionDate()).isEqualTo(NO);
        }

        @Test
        void
                shouldReturnYESForjudgeApproveEditOptionDateIfGATypesIsNotEitherExtendTimeORStayClaim() {
        ...
        void shouldReturnYesForJudgeApproveEditOptionPartyIfGATypeIsExtendTime() {
            ...
            assertThat(makeAnOrder.getDisplayjudgeApproveEditOptionDoc()).isEqualTo(YES);
        }
        ...
        void shouldReturnCorrectDirectionOrderText_whenJudgeMakeDecisionGiveDirection() {
            List<GeneralApplicationTypes> types =
                    List.of((GeneralApplicationTypes.SUMMARY_JUDGEMENT));
            CallbackParams params =
                    callbackParamsOf(getDirectionOrderApplnAndResp(types, NO, NO), ABOUT_TO_START);
        ...
        @Test
        void
                shouldReturnNOForJudgeApproveEditOptionPartyIfGATypesIsNotEitherExtendTimeORStayClaim() {
            ...
            assertThat(makeAnOrder.getDisplayjudgeApproveEditOptionDoc()).isEqualTo(NO);
        }
        ...
        void shouldMatchExpectedVulnerabilityText() {
            ...
            CallbackParams params =
                    callbackParamsOf(getHearingOrderApplnAndResp(types, YES, YES), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldHaveVulTextWithApplicantRespondent1and2Respond() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp1and2(types, YES, YES, YES), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldHaveVulTextWithApplicantRespondent1Respond() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp1and2(types, YES, YES, NO), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldHaveVulTextWithApplicantRespondent2Respond() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp1and2(types, YES, NO, YES), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldHaveVulTextWithRespondent2Respond() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp1and2(types, NO, NO, YES), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldHaveVulTextWithRespondent1Respond() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp1and2(types, NO, YES, NO), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        void shouldHaveVulTextWithApplicantRespond() {
            ...
            CallbackParams params =
                    callbackParamsOf(getHearingOrderApplnAndResp(types, YES, NO), ABOUT_TO_START);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
        ...
        private GAJudgesHearingListGAspec getJudicialHearingOrder(
            ...
            return new GeneralApplicationCaseData()
                    ...
                    .generalAppHearingDetails(
                            new GAHearingDetails()
                                    .setHearingPreferencesPreferredType(GAHearingType.IN_PERSON)
                                    .setHearingDuration(GAHearingDuration.HOUR_1)
                                    .setSupportRequirement(getApplicantResponses()))
        ...
        private GeneralApplicationCaseData getCaseDateWithNoSupportReq(
                List<Element<GARespondentResponse>> respondentResponse,
        ...
        private GeneralApplicationCaseData getCaseDateWithNoApplicantSupportReq(
                List<Element<GARespondentResponse>> respondentResponse,
                GAUrgencyRequirement urgentApp) {
        ...
        public GeneralApplicationCaseData getCaseDateWithHearingScreeen1V1(
                List<GeneralApplicationTypes> types,
                YesOrNo vulQuestion,
            ...
            return new GeneralApplicationCaseData()
                    ...
                    .generalAppHearingDetails(
                            new GAHearingDetails()
                                    .setVulnerabilityQuestionsYesOrNo(vulQuestion)
                                    .setVulnerabilityQuestion("dummy")
                                    .setHearingPreferencesPreferredType(GAHearingType.VIDEO)
                                    .setHearingDuration(GAHearingDuration.MINUTES_45)
                                    .setSupportRequirement(getApplicantResponses1V1())
        ...
        public List<GAHearingSupportRequirements> getApplicantResponses1V1() {
            ...
            applSupportReq.add(GAHearingSupportRequirements.DISABLED_ACCESS);
            applSupportReq.add(GAHearingSupportRequirements.SIGN_INTERPRETER);

            return applSupportReq;
        }

        private GeneralApplicationCaseData getCloakedApplication(
        ...
        private GeneralApplicationCaseData getApplicationByParentCaseDefendant() {
            ...
            return new GeneralApplicationCaseData()
                    ...
                    .judicialDecisionRequestMoreInfo(
                            new GAJudicialRequestMoreInfo().setIsWithNotice(YES))
                    .generalAppInformOtherParty(new GAInformOtherParty().setIsWithNotice(YES))
                    .generalAppHearingDetails(
                            new GAHearingDetails()
                                    .setHearingPreferencesPreferredType(GAHearingType.IN_PERSON)
    ...
    class MidEventForWrittenRepresentation {
        ...
        private static final String VALIDATE_WRITTEN_REPRESENTATION_PAGE =
                "ga-validate-written-representation-date";
        ...
        void shouldGenerateListingForHearingDocument() {
            ...
            verify(hearingOrderGenerator)
                    .generate(any(GeneralApplicationCaseData.class), eq("BEARER_TOKEN"));

            GeneralApplicationCaseData updatedData =
                    objectMapper.convertValue(response.getData(), GeneralApplicationCaseData.class);
        ...
        void shouldThrowErrorForListingForHearingCourtOwnInitiative() {
            ...
            caseDataBuilder
                    .judicialByCourtsInitiativeListForHearing(GAByCourtsInitiativeGAspec.OPTION_2)
                    .orderWithoutNoticeListForHearing(
                            new GAOrderWithoutNoticeGAspec()
                                    .setOrderWithoutNotice("abcde")
                                    .setOrderWithoutNoticeDate(LocalDate.now().minusDays(4)))
                    .build();
            ...
            assertThat(response.getErrors().getFirst())
                    .isEqualTo(MAKE_DECISION_APPROVE_BY_DATE_IN_PAST);
        }
            ...
            caseDataBuilder
                    ...
                    .orderCourtOwnInitiativeListForHearing(
                            new GAOrderCourtOwnInitiativeGAspec()
                                    .setOrderCourtOwnInitiative("abcde")
                                    .setOrderCourtOwnInitiativeDate(LocalDate.now().minusDays(3)))
                    .build();
        ...
        void shouldGenerateConcurrentApplicationDocument() {
            ...
            GeneralApplicationCaseData caseDataBuilder = caseData.copy();
            caseDataBuilder
                    .judicialByCourtsInitiativeForWrittenRep(GAByCourtsInitiativeGAspec.OPTION_2)
            ...
            CallbackParams params =
                    callbackParamsOf(updateData, MID, "populate-written-rep-preview-doc");
            ...
            assertThat(updatedData.getJudicialWrittenRepDocPreview())
                    .isEqualTo(
                            PDFBuilder.WRITTEN_REPRESENTATION_CONCURRENT_DOCUMENT
                                    .getDocumentLink());
        }
        ...
        void shouldGenerateSequentialApplicationDocument() {
            ...
            assertThat(updatedData.getJudicialWrittenRepDocPreview())
                    .isEqualTo(
                            PDFBuilder.WRITTEN_REPRESENTATION_SEQUENTIAL_DOCUMENT
                                    .getDocumentLink());
        }
        ...
        void shouldThrowErrorCourtOwnInitiativeForWrittenRepIsPastDate() {
            ...
            caseDataBuilder
                    ...
                    .orderCourtOwnInitiativeForWrittenRep(
                            new GAOrderCourtOwnInitiativeGAspec()
                                    .setOrderCourtOwnInitiative("abcde")
                                    .setOrderCourtOwnInitiativeDate(LocalDate.now().minusDays(2)))
                    .build();
        ...
        void shouldThrowErrorOrderWithoutNoticeForWrittenRepIsPastDate() {
            ...
            caseDataBuilder
                    ...
                    .orderWithoutNoticeForWrittenRep(
                            new GAOrderWithoutNoticeGAspec()
                                    .setOrderWithoutNotice("abcde")
                                    .setOrderWithoutNoticeDate(LocalDate.now().minusDays(2)))
                    .build();
        ...
        void shouldReturnErrors_whenSequentialWrittenRepresentationDateIsInPast() {
            CallbackParams params =
                    callbackParamsOf(
                            getSequentialWrittenRepresentationDecision(
            ...
            assertThat(response.getErrors())
                    .contains(WRITTEN_REPRESENTATION_DATE_CANNOT_BE_IN_PAST);
        }
        ...
        void shouldReturnErrors_whenConcurrentWrittenRepresentationDateIsInPast() {
            CallbackParams params =
                    callbackParamsOf(
                            getConcurrentWrittenRepresentationDecision(
                                    LocalDate.now().minusDays(1)),
                            MID,
                            VALIDATE_WRITTEN_REPRESENTATION_PAGE);
            when(service.validateWrittenRepresentationsDates(any())).thenCallRealMethod();
        ...
        void shouldNotReturnErrors_whenSequentialWrittenRepresentationDateIsInFuture() {
            ...
            assertThat(
                            responseCaseData
                                    .getOrderCourtOwnInitiativeForWrittenRep()
                                    .getOrderCourtOwnInitiativeDate())
                    .isEqualTo(localDatePlus7days);
            assertThat(
                            responseCaseData
                                    .getOrderWithoutNoticeForWrittenRep()
                                    .getOrderWithoutNoticeDate())
                    .isEqualTo(localDatePlus7days);
            assertThat(responseCaseData.getJudicialApplicanSequentialDateText())
                    .isEqualTo(
                            String.format(
                                    expectedApplicantSequentialText,
                                    formatLocalDate(
                                            responseCaseData
                                                    .getJudicialDecisionMakeAnOrderForWrittenRepresentations()
        ...
        void shouldNotReturnErrors_whenConcurrentWrittenRepresentationDateIsInFuture() {
            ...
            String expectedConcurrentText =
                    "The claimant and defendant should upload any written submissions and evidence"
                        + " by 4pm on %s";
        ...
        void shouldPopulateJudicialGOHearingAndTimeEst() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getHearingOrderApplnAndResp(judgeSupportReqChoices),
                            MID,
                            VALIDATE_HEARING_ORDER_SCREEN);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
            ...
            assertThat(responseCaseData.getJudicialHearingGeneralOrderHearingText())
                    .isEqualTo(
                            String.format(
                                    expectedJudicialHearingTypeText,
                                    responseCaseData
                                            .getJudicialListForHearing()
                                            .getHearingPreferencesPreferredType()
                                            .getDisplayedValue()));
            ...
            assertThat(responseCaseData.getJudicialGeneralOrderHearingEstimationTimeText())
                    .isEqualTo(
                            String.format(
                                    expeceedJudicialTimeEstimateText,
                                    responseCaseData
                                            .getJudicialListForHearing()
                                            .getJudicialTimeEstimate()
                                            .getDisplayedValue()));

            assertThat(
                            responseCaseData
                                    .getOrderCourtOwnInitiativeListForHearing()
                                    .getOrderCourtOwnInitiativeDate())
                    .isEqualTo(localDatePlus7days);
            assertThat(
                            responseCaseData
                                    .getOrderWithoutNoticeListForHearing()
                                    .getOrderWithoutNoticeDate())
                    .isEqualTo(localDatePlus7days);
        }
        ...
        void shouldMatchJudgeGOSupportReqWithExpectedTextWithSeperator() {
            ...
            List<SupportRequirements> judgeSupportReqChoices = new ArrayList<>();
            judgeSupportReqChoices.add(SupportRequirements.HEARING_LOOPS);
            judgeSupportReqChoices.add(SupportRequirements.OTHER_SUPPORT);
            ...
            String expecetedJudicialSupportReqText =
                    "Hearing requirements Hearing loop, Other support";
        ...
        void shouldReturnErrorWhenInPersonAndLocationIsNull() {
            ...
            CallbackParams params =
                    callbackParamsOf(
                            getJudicialListHearingData(), MID, VALIDATE_HEARING_ORDER_SCREEN);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
            ...
            return new GeneralApplicationCaseData()
                    .judicialListForHearing(
                            new GAJudgesHearingListGAspec()
                                    .setHearingPreferencesPreferredType(
                                            GAJudicialHearingType.IN_PERSON)
        ...
        private GeneralApplicationCaseData getHearingOrderApplnAndResp(
                List<SupportRequirements> judgeSupportReqChoices) {
        ...
        public GeneralApplicationCaseData getSequentialWrittenRepresentationDecision(
                LocalDate writtenRepresentationDate) {

            GAJudicialWrittenRepresentations gaJudicialWrittenRepresentations =
            ...
            return new GeneralApplicationCaseData()
                    .judicialDecisionMakeAnOrderForWrittenRepresentations(
                            gaJudicialWrittenRepresentations)
                    .build();
        }

        public GeneralApplicationCaseData getConcurrentWrittenRepresentationDecision(
                LocalDate writtenRepresentationDate) {
            GAJudicialWrittenRepresentations gaJudicialWrittenRepresentations =
                    new GAJudicialWrittenRepresentations()
                            .setWrittenOption(
    ...
    class MidEventForMakeAnOrderOption {
        ...
        void shouldPopulateFreeFormOrderValues_onMidEventCallback() {
            ...
            CallbackParams params =
                    callbackParamsOf(caseDataBuilder.build(), MID, VALIDATE_MAKE_AN_ORDER);
            ...
            assertThat(response.getData())
                    .extracting("orderOnCourtInitiative")
                    .extracting("onInitiativeSelectionTextArea")
                    .isEqualTo(ON_INITIATIVE_SELECTION_TEST);
            assertThat(response.getData())
                    .extracting("orderOnCourtInitiative")
                    .extracting("onInitiativeSelectionDate")
                    .isEqualTo(localDatePlus7days.toString());
            assertThat(response.getData())
                    .extracting("orderWithoutNotice")
                    .extracting("withoutNoticeSelectionTextArea")
                    .isEqualTo(WITHOUT_NOTICE_SELECTION_TEXT);
            assertThat(response.getData())
                    .extracting("orderWithoutNotice")
                    .extracting("withoutNoticeSelectionDate")
                    .isEqualTo(localDatePlus7days.toString());
            assertThat(response.getData().get("caseNameHmctsInternal").toString())
                    .isEqualTo("Mr. John Rambo v Mr. Sole Trader");
            assertThat(response.getData())
                    .extracting("judicialDecisionRequestMoreInfo")
                    .extracting("judgeRequestMoreInfoByDate")
                    .isEqualTo(localDatePlus7days.toString());
        }

        @Test
        void shouldGenerateFinalOrderPreviewDocumentWhenPopulateFinalOrderPreviewDocIsCalled() {
            when(gaFreeFormOrderGenerator.generate(any(), any()))
                    .thenReturn(new CaseDocument().setDocumentLink(new Document()));
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder().build();
            CallbackParams params =
                    callbackParamsOf(caseData, MID, "populate-final-order-preview-doc");
        ...
        void shouldReturnErrorForWrittenRepresentationWithOutNoticeApplnForJudgeRevisit() {
            ...
            assertThat(response.getErrors().getFirst())
                    .isEqualTo(
                            "The application needs to be uncloaked before requesting written"
                                + " representations");
        }
        ...
        @Test
        void
                shouldNotReturnErrorForWrittenRepresentationWithOutNoticeApplnForJudgeRevisitLipCase() {
            List<GeneralApplicationTypes> types = List.of((GeneralApplicationTypes.STRIKE_OUT));
            when(helper.isApplicationCreatedWithoutNoticeByApplicant(any())).thenReturn(NO);
        ...
        void shouldReturnErrorForWrittenRepWithOutNoticeAppln() {
            ...
            GeneralApplicationCaseData caseData = getHearingOrderApplnAndResp(types, NO, NO);
            GeneralApplicationCaseData caseDataBuilder = caseData.copy();
            caseDataBuilder.judicialDecision(
                    new GAJudicialDecision().setDecision(MAKE_ORDER_FOR_WRITTEN_REPRESENTATIONS));
            CallbackParams params =
                    callbackParamsOf(caseDataBuilder.build(), MID, VALIDATE_MAKE_AN_ORDER);
    ...
    class MidEventForRespondToDirectionsDateValidity {
        ...
        public static final String RESPOND_TO_DIRECTIONS_DATE_IN_PAST =
                "The date, by which the response to direction"
        ...
        void shouldReturnErrors_whenApplicationIsUrgentButConsiderationDateIsNotProvided() {
            GeneralApplicationCaseData caseData =
                    getApplication_MakeDecision_GiveDirections(
                            GIVE_DIRECTIONS_WITHOUT_HEARING, null, OPTION_3, null, null);
        ...
        void shouldReturnErrors_whenUrgencyConsiderationDateIsInPastForUrgentApplication() {
            GeneralApplicationCaseData caseData =
                    getApplication_MakeDecision_GiveDirections(
                            GIVE_DIRECTIONS_WITHOUT_HEARING,
                            LocalDate.now().minusDays(1),
                            OPTION_3,
                            null,
                            null);
        ...
        void shouldNotCauseAnyErrors_whenApplicationIsNotUrgentAndConsiderationDateIsNotProvided() {
            GeneralApplicationCaseData caseData =
                    getApplication_MakeDecision_GiveDirections(
                            APPROVE_OR_EDIT, LocalDate.now().minusDays(1), OPTION_3, null, null);
        ...
        void shouldGenerateDirectionOrderDocument() {
            ...
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder().directionOrderApplication().build();

            CallbackParams params = callbackParamsOf(caseData, MID, VALIDATE_MAKE_DECISION_SCREEN);

            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);

            verify(directionOrderGenerator)
                    .generate(any(GeneralApplicationCaseData.class), eq("BEARER_TOKEN"));
        ...
        void shouldGenerateDismissalOrderDocument() {
            ...
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder().dismissalOrderApplication().build();
            CallbackParams params = callbackParamsOf(caseData, MID, VALIDATE_MAKE_DECISION_SCREEN);

            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);

            verify(dismissalOrderGenerator)
                    .generate(any(GeneralApplicationCaseData.class), eq("BEARER_TOKEN"));
        ...
        private GeneralApplicationCaseData getApplication_MakeDecision_GiveDirections(
                GAJudgeMakeAnOrderOption orderOption,
                LocalDate directionsResponseByDate,
                GAByCourtsInitiativeGAspec gaByCourtsInitiativeGAspec,
    ...
    class MidEventForRequestMoreInfoScreenDateValidity {
        ...
        private static final String VALIDATE_REQUEST_MORE_INFO_SCREEN =
                "validate-request-more-info-screen";
        public static final String REQUESTED_MORE_INFO_BY_DATE_REQUIRED =
                "The date, by which the applicant must " + "respond, is required.";
        public static final String REQUESTED_MORE_INFO_BY_DATE_IN_PAST =
                "The date, by which the applicant must " + "respond, cannot be in past.";
        ...
        void shouldGenerateRequestMoreInfoDocument_JudgeRevisit_Without_Uncloaked() {
            ...
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            ...
                            .build();
            CallbackParams params =
                    callbackParamsOf(caseData, MID, VALIDATE_REQUEST_MORE_INFO_SCREEN);
                    ...
                    GeneralApplicationCaseDataBuilder.builder()
                            ...
                            .judicialDecisionRequestMoreInfo(
                                    new GAJudicialRequestMoreInfo()
                                            .setJudgeRecitalText(
                                                    JUDICIAL_REQUEST_MORE_INFO_RECITAL_TEXT)
        ...
        void shouldNotGenerateRequestMoreInfoDocumentForSend_App_OtherParty() {
            String judgeRecitalText =
                    "<Title><Name>\n"
                        + "Upon reviewing the application made and upon considering the"
                        + " informationprovided by the parties, the court requests more information"
                        + " from the applicant.";
            ...
            assertThat(updatedData.getJudicialRequestMoreInfoDocPreview()).isEqualTo(null);
        }
        ...
        void shouldNotReturnErrors_whenRequestedMoreInfoAndTheDateIsInFuture() {
            ...
            GeneralApplicationCaseData caseData =
                    getApplication_RequestMoreInformation(
                            REQUEST_MORE_INFORMATION, LocalDate.now().plusDays(1), YES);
        ...
        void shouldReturnErrors_whenRequestedMoreInfoAndTheDateIsNull() {
            ...
            GeneralApplicationCaseData caseData =
                    getApplication_RequestMoreInformation2(REQUEST_MORE_INFORMATION, null, NO);
        ...
        void shouldReturnErrors_whenRequestedMoreInfoAndTheDateIsInPast() {
            ...
            GeneralApplicationCaseData caseData =
                    getApplication_RequestMoreInformation2(
                            REQUEST_MORE_INFORMATION, LocalDate.now().minusDays(1), NO);
        ...
        void shouldNotCauseAnyErrors_whenApplicationIsNotUrgentAndConsiderationDateIsNotProvided() {
            ...
            GeneralApplicationCaseData caseData =
                    getApplication_RequestMoreInformation2(null, LocalDate.now(), YES);
        ...
        private GeneralApplicationCaseData getApplication_RequestMoreInformation2(
                GAJudgeRequestMoreInfoOption option,
            ...
            return new GeneralApplicationCaseData()
                    ...
                    .generalAppRespondentAgreement(
                            new GARespondentOrderAgreement().setHasAgreed(hasAgree))
                    .generalAppInformOtherParty(
                            new GAInformOtherParty().setIsWithNotice(YesOrNo.YES))
                    .createdDate(LocalDateTime.of(2022, 1, 15, 0, 0, 0))
                    .judicialDecisionRequestMoreInfo(
                            new GAJudicialRequestMoreInfo()
                                    ...
                                    .setJudgeRequestMoreInfoText("Test")
                                    .setIsWithNotice(YES)
                                    .setDeadlineForMoreInfoSubmission(
                                            LocalDateTime.now().plusDays(5)))
                    .build();
        }

        private GeneralApplicationCaseData getApplication_RequestMoreInformation(
                GAJudgeRequestMoreInfoOption option,
                LocalDate judgeRequestMoreInfoByDate,
                YesOrNo hasAgree) {
            List<GeneralApplicationTypes> types =
            ...
            return new GeneralApplicationCaseData()
                    ...
                    .ccdState(CaseState.APPLICATION_SUBMITTED_AWAITING_JUDICIAL_DECISION)
                    .judicialDecisionMakeOrder(
                            new GAJudicialMakeAnOrder().setMakeAnOrder(APPROVE_OR_EDIT))
                    .judicialDecisionRequestMoreInfo(
                            new GAJudicialRequestMoreInfo()
                                    .setRequestMoreInfoOption(option)
                                    .setJudgeRequestMoreInfoByDate(judgeRequestMoreInfoByDate)
    ...
    class AboutToSubmitHandling {
        ...
        void shouldSetUpReadyBusinessProcess() {
            ...
            assertThat(responseCaseData.getMakeAppVisibleToRespondents().getMakeAppAvailableCheck())
                    .isNotNull();
            assertThat(responseCaseData.getBusinessProcess().getStatus())
                    .isEqualTo(BusinessProcessStatus.READY);
            assertThat(responseCaseData.getBusinessProcess().getCamundaEvent())
                    .isEqualTo("MAKE_DECISION");
        }

        @Test
        void shouldSetUpReadyWhenPreferredTypeNotInPerson() {
            GeneralApplicationCaseData caseData =
                    getApplicationWithPreferredTypeNotInPerson()
                            .copy()
                            .isMultiParty(NO)
                            .generalAppApplnSolicitor(
                                    new GASolicitorDetailsGAspec()
            ...
            assertThat(responseCaseData.getJudicialListForHearing().getHearingPreferredLocation())
                    .isNull();
            assertThat(responseCaseData.getBusinessProcess().getStatus())
                    .isEqualTo(BusinessProcessStatus.READY);
            assertThat(responseCaseData.getBusinessProcess().getCamundaEvent())
        ...
        void shouldClearJudicialHearingLabelText() {
            ...
            assertNull(
                    responseCaseData
                            .getJudicialListForHearing()
                            .getJudgeHearingCourtLocationText1());
            assertNull(
                    responseCaseData
                            .getJudicialListForHearing()
                            .getJudgeHearingTimeEstimateText1());
            assertNull(
                    responseCaseData
                            .getJudicialListForHearing()
                            .getHearingPreferencesPreferredTypeLabel1());
            assertNull(
                    responseCaseData.getJudicialListForHearing().getJudgeHearingSupportReqText1());
        }
            ...
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .judicialDecisionWithUncloakRequestForInformationApplication(
                                    SEND_APP_TO_OTHER_PARTY, NO, YES)
        ...
        void shouldCallAssignCase_3Times() {
            ...
            GeneralApplicationCaseData responseCaseData =
                    objectMapper.convertValue(response.getData(), GeneralApplicationCaseData.class);
            assertThat(responseCaseData.getApplicationIsCloaked()).isEqualTo(NO);
            verify(assignCaseToResopondentSolHelper)
                    .assignCaseToRespondentSolicitor(caseData, caseId);
        }
        ...
        void shouldApplicationRemainSame_WhenJudgeNotUncloaked_RequestMoreInformationApplication() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .judicialDecisionWithUncloakRequestForInformationApplication(
                                    REQUEST_MORE_INFORMATION, NO, YES)
                            .isMultiParty(NO)
                            .generalAppRespondentSolicitors(getRespondentSolicitors())
                            .build();
        ...
        @Test
        void
                shouldAssignToRespondent_WhenJudgeNotUncloaked_RequestMoreInformationApplicationLipRespondent() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .judicialDecisionWithUncloakRequestForInformationApplication(
                                    REQUEST_MORE_INFORMATION, NO, YES)
        ...
        void shouldBeUncloaked_WhenRequestMoreInformation_WithNoticeApplication() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .judicialDecisionWithUncloakRequestForInformationApplication(
                                    REQUEST_MORE_INFORMATION, YES, null)
                            .isMultiParty(NO)
                            .generalAppRespondentSolicitors(getRespondentSolicitors())
                            .build();
        ...
        private GeneralApplicationCaseData getApplicationWithPreferredTypeNotInPerson() {
            ...
            return new GeneralApplicationCaseData()
                    ...
                    .judicialListForHearing(
                            new GAJudgesHearingListGAspec()
                                    .setHearingPreferencesPreferredType(
                                            GAJudicialHearingType.TELEPHONE))
                    .businessProcess(
                            new BusinessProcess()
                                    .setCamundaEvent(CAMUNDA_EVENT)
                                    .setProcessInstanceId(BUSINESS_PROCESS_INSTANCE_ID)
    ...
    class SubmittedCallbackHandling {
        ...
        void callbackHandlingForMakeAnOrder() {
            GeneralApplicationCaseData caseData =
                    getApplication(new GAJudicialDecision().setDecision(MAKE_AN_ORDER), null);
            CallbackParams params = callbackParamsOf(caseData, SUBMITTED);
        ...
        void callbackHandlingForListForHearing() {
            GeneralApplicationCaseData caseData =
                    getApplication(new GAJudicialDecision().setDecision(LIST_FOR_A_HEARING), null);
            CallbackParams params = callbackParamsOf(caseData, SUBMITTED);
        ...
        void callbackHandlingForRequestInfoFromApplicant() {
            ...
            assertThat(response.getConfirmationBody())
                    .isEqualTo(
                            "<br/><p>The applicant will be notified. "
                                    + "They will need to provide a response by "
                                    + DATE_FORMATTER_SUBMIT_CALLBACK.format(LocalDate.now())
                                    + "</p>");
        }
        ...
        void callbackHandlingForRequestHearingDetailsFromOtherParty() {
            ...
            assertThat(response.getConfirmationHeader())
                    .isEqualTo("# You have requested a response");
            assertThat(response.getConfirmationBody())
                    .isEqualTo("<br/><p>The parties will be notified.</p>");
        }

        @Test
        void callbackHandlingForRequestMoreInfoWithNullGAJudicialRequestMoreInfo() {
            GeneralApplicationCaseData caseData =
                    getApplication(new GAJudicialDecision().setDecision(REQUEST_MORE_INFO), null);
            CallbackParams params = callbackParamsOf(caseData, SUBMITTED);

            Assertions.assertThrows(IllegalArgumentException.class, () -> handler.handle(params));
        }

        private GeneralApplicationCaseData getApplication(
                GAJudicialDecision decision, GAJudicialRequestMoreInfo moreInfo) {
            List<GeneralApplicationTypes> types =
                    List.of((GeneralApplicationTypes.SUMMARY_JUDGEMENT));
            ...
            return builder.parentClaimantIsApplicant(YES)
                    .generalAppRespondentAgreement(
                            new GARespondentOrderAgreement().setHasAgreed(NO))
                    .generalAppInformOtherParty(new GAInformOtherParty().setIsWithNotice(NO))
                    .createdDate(LocalDateTime.of(2022, 1, 15, 0, 0, 0))
    ...
    public GeneralApplicationCaseData getDirectionOrderApplnAndResp(
            List<GeneralApplicationTypes> types,
            YesOrNo vulQuestion,
            YesOrNo hasRespondentResponseVul) {
    ...
    public GeneralApplicationCaseData getMakeAnOrder(YesOrNo hasRespondentResponseVul) {
        ...
        return new GeneralApplicationCaseData()
                ...
                .applicantPartyName("ApplicantPartyName")
                .judicialDecisionMakeOrder(
                        new GAJudicialMakeAnOrder().setMakeAnOrder(GIVE_DIRECTIONS_WITHOUT_HEARING))
                .build();
    }

    public GeneralApplicationCaseData getGaCaseAppln(
            List<GeneralApplicationTypes> types, YesOrNo isWithNotice, YesOrNo hasAgreed) {

        return new GeneralApplicationCaseData()
                .generalAppParentCaseLink(new GeneralAppParentCaseLink().setCaseReference("1"))
                .generalAppRespondentAgreement(
                        new GARespondentOrderAgreement().setHasAgreed(hasAgreed))
                .generalAppHearingDetails(
                        new GAHearingDetails()
                                .setHearingPreferencesPreferredType(GAHearingType.IN_PERSON)
                                .setHearingDuration(GAHearingDuration.HOUR_1)
    ...
    public GeneralApplicationCaseData getHearingOrderApplnAndResp(
            List<GeneralApplicationTypes> types,
            YesOrNo vulQuestion,
            YesOrNo hasRespondentResponseVul) {
    ...
    public GeneralApplicationCaseData getHearingOrderApplnAndResp1and2(
            List<GeneralApplicationTypes> types,
            YesOrNo vulQuestion,
            YesOrNo hasRespondentResponseVul,
            YesOrNo hasRespondentResponseVul2) {
        List<Element<GASolicitorDetailsGAspec>> respondentSolicitors = new ArrayList<>();
        respondentSolicitors.add(element(new GASolicitorDetailsGAspec().setId("1L")));
        respondentSolicitors.add(element(new GASolicitorDetailsGAspec().setId("2L")));
        ...
        return new GeneralApplicationCaseData()
                ...
                .respondentsResponses(
                        getRespondentResponses1nad2(
                                hasRespondentResponseVul, hasRespondentResponseVul2, YES, YES))
                .generalAppInformOtherParty(new GAInformOtherParty().setIsWithNotice(YES))
                .createdDate(LocalDateTime.of(2022, 1, 15, 0, 0, 0))
                .applicantPartyName("ApplicantPartyName")
                ...
                .generalAppHearingDetails(
                        new GAHearingDetails()
                                ...
                                .setHearingPreferencesPreferredType(GAHearingType.IN_PERSON)
                                .setHearingDuration(GAHearingDuration.HOUR_1)
                                .setSupportRequirement(getApplicant1Responses())
                                .setHearingPreferredLocation(getLocationDynamicList()))
                .generalAppType(new GAApplicationType().setTypes(types))
                .businessProcess(
                        new BusinessProcess()
    ...
    public GeneralApplicationCaseData getHearingOrderAppForCourtLocationPreference(
            List<GeneralApplicationTypes> types,
        ...
        return new GeneralApplicationCaseData()
                ...
                .respondentsResponses(
                        getRespondentResponses1nad2(
                                YES, YES, hasResp1PreferLocation, hasResp2PreferLocation))
                .generalAppInformOtherParty(new GAInformOtherParty().setIsWithNotice(YES))
                .createdDate(LocalDateTime.of(2022, 1, 15, 0, 0, 0))
                .applicantPartyName("ApplicantPartyName")
                .generalAppRespondentSolicitors(respondentSolicitors)
    ...
    public List<Element<GARespondentResponse>> getRespodentResponses(YesOrNo vulQuestion) {
        ...
        respSupportReq.add(GAHearingSupportRequirements.OTHER_SUPPORT);
        respSupportReq.add(GAHearingSupportRequirements.HEARING_LOOPS);
                                ...
                                .setGaHearingDetails(
                                        new GAHearingDetails()
                                                ...
                                                .setHearingPreferencesPreferredType(
                                                        GAHearingType.IN_PERSON)
                                                .setHearingDuration(GAHearingDuration.HOUR_1)
                                                .setSupportRequirement(respSupportReq)
                                                .setHearingPreferredLocation(
                                                        getLocationDynamicList()))));
    ...
    public List<MakeAppAvailableCheckGAspec> getMakeAppVisible() {
        ...
        applMakeVisible.add(MakeAppAvailableCheckGAspec.CONSENT_AGREEMENT_CHECKBOX);
        return applMakeVisible;
    }

    public List<GAHearingSupportRequirements> getApplicantResponses() {
        List<GAHearingSupportRequirements> applSupportReq = new ArrayList<>();
        applSupportReq.add(GAHearingSupportRequirements.HEARING_LOOPS);
        applSupportReq.add(GAHearingSupportRequirements.OTHER_SUPPORT);
    ...
    public GeneralApplicationCaseData getNotifiedApplication(
            YesOrNo isWithNotice, YesOrNo parentClaimantIsApplicant) {
    ...
    public GAJudicialMakeAnOrder getJudicialMakeAnOrder(
            AboutToStartOrSubmitCallbackResponse response) {
        GeneralApplicationCaseData responseCaseData =
                objectMapper.convertValue(response.getData(), GeneralApplicationCaseData.class);
    ...
    public GAJudicialRequestMoreInfo getJudicialRequestMoreInfo(
            AboutToStartOrSubmitCallbackResponse response) {
        GeneralApplicationCaseData responseCaseData =
                objectMapper.convertValue(response.getData(), GeneralApplicationCaseData.class);
