    ...
    class RespondentOne {
        ...
        class GetTemplateData {
            ...
            void whenNoRequestedCourt_build() {
                ...
                assertThat(templateData.getRequestedCourt()).isEqualTo(
            ...
            void whenSmallClaimSpecFullAdmissionNotRepresentedDefendant() {
                ...
                assertThat(templateData.getWitnessesIncludingDefendants()).isEqualTo(2);
    ...
    class RespondentTwo {
        ...
        class GetTemplateData {
            ...
            void when1v2DiffSolRespondsTo2ndDefendantWithDivergentResponse_shouldGetRespondentDQData() {
                ...
                assertThat(caseDocument.orElseThrow(() -> new IllegalStateException("CaseDocument not found")))
                        .isEqualTo(CASE_DOCUMENT_DEFENDANT);
