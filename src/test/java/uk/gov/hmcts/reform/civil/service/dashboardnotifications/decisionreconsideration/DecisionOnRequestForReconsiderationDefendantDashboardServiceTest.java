...
class DecisionOnRequestForReconsiderationDefendantDashboardServiceTest {
    ...
    @Test
    void shouldRecordScenarioForDecisionReconsiderationDefendantWhenOptionsIsYes() {
    ...
    @Test
    void shouldNotRecordScenarioForDecisionReconsiderationDefendantWhenOptionsIsCreateSdo() {
        CaseData caseData = CaseDataBuilder.builder().build();
        caseData.setRespondent1Represented(YesOrNo.NO);
        caseData.setCcdCaseReference(1234L);
    ...
    @Test
    void shouldNotRecordScenarioForDecisionReconsiderationDefendantWhenOptionsIsCreateGeneralOrder() {
        CaseData caseData = CaseDataBuilder.builder().build();
        caseData.setRespondent1Represented(YesOrNo.NO);
        caseData.setCcdCaseReference(1234L);
