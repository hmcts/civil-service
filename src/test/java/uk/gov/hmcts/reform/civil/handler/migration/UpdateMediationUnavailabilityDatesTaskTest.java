...
class UpdateMediationUnavailabilityDatesTaskTest {
    ...
    void shouldUpdateNextMissingDefendantDateAndPreserveElementDetails() {
        ...
        CaseData caseData = caseDataWithResponses(
            List.of(
                new Element<>(UUID.randomUUID(), alreadyPopulated),
                new Element<>(existingId, missingDates)
            ),
            null
        );
        ...
        List<Element<UnavailableDate>> dates = result.getCaseDataLiP()
            .getRespondent1MediationLiPResponseCarm()
            .getUnavailableDatesForMediation();

        assertThat(dates.get(1).getId())
            .isEqualTo(existingId);

        assertThat(dates.get(1).getValue().getUnavailableDateType())
            .isEqualTo(UnavailableDateType.DATE_RANGE);

        assertThat(dates.get(1).getValue().getDate())
            .isEqualTo(LocalDate.of(2026, 9, 7));

        assertThat(dates.get(1).getValue().getFromDate())
            .isEqualTo(LocalDate.of(2026, 9, 7));

        assertThat(dates.get(1).getValue().getToDate())
            .isEqualTo(LocalDate.of(2026, 9, 14));

        assertThat(dates.get(0).getValue())
            .isEqualTo(alreadyPopulated);
    }
    ...
    void shouldUpdateClaimantResponseWhenPartyTypeIsClaimant() {
        ...
        CaseData caseData = caseDataWithResponses(
            null,
            List.of(
                new Element<>(UUID.randomUUID(), claimantDate)
            )
        );
        ...
        assertThat(claimantDate.getDate())
            .isEqualTo(LocalDate.of(2026, 10, 5));

        assertThat(claimantDate.getFromDate())
            .isEqualTo(LocalDate.of(2026, 10, 5));

        assertThat(claimantDate.getToDate())
            .isNull();
    }
    ...
    void shouldUseConsecutiveRowsToUpdateConsecutiveMissingDates() {
        ...
        CaseData caseData = caseDataWithResponses(
            List.of(
                new Element<>(UUID.randomUUID(), first),
                new Element<>(UUID.randomUUID(), second)
            ),
            null
        );
        ...
        assertThat(first.getDate())
            .isEqualTo(LocalDate.of(2026, 9, 7));

        assertThat(first.getFromDate())
            .isEqualTo(LocalDate.of(2026, 9, 7));

        assertThat(first.getToDate())
            .isEqualTo(LocalDate.of(2026, 9, 14));

        assertThat(second.getDate())
            .isEqualTo(LocalDate.of(2026, 10, 5));

        assertThat(second.getFromDate())
            .isEqualTo(LocalDate.of(2026, 10, 5));

        assertThat(second.getToDate())
            .isEqualTo(LocalDate.of(2026, 10, 5));
    }
    ...
    @Test
    void shouldNotFailWhenNoMatchingDateRequiresUpdate() {
        ...
        CaseData caseData = caseDataWithResponses(
            List.of(
                new Element<>(UUID.randomUUID(), populated)
            ),
            null
        );
        ...
        CaseData result = task.migrateCaseData(
            caseData,
            reference
        );
        ...
        assertThat(populated.getDate())
            .isEqualTo(existingDate);

        assertThat(populated.getFromDate())
            .isEqualTo(existingDate);

        assertThat(populated.getToDate())
            .isEqualTo(existingDate);
    }
    ...
    private CaseData caseDataWithResponses(
        ...
        if (defendantDates != null) {
            caseDataLiP.setRespondent1MediationLiPResponseCarm(
                new MediationLiPCarm()
                    .setUnavailableDatesForMediation(defendantDates)
            );
        }
        ...
        if (claimantDates != null) {
            caseDataLiP.setApplicant1LiPResponseCarm(
                new MediationLiPCarm()
                    .setUnavailableDatesForMediation(claimantDates)
            );
        }
