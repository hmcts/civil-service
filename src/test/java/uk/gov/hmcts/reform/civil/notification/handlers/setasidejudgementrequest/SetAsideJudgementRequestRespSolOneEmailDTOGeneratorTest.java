...
class SetAsideJudgementRequestRespSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private SetAsideJudgementRequestRespSolOneEmailDTOGenerator generator;
    ...
    void shouldAddAdditionalProperties() {
        ...
        try (MockedStatic<NotificationUtils> utils = Mockito.mockStatic(NotificationUtils.class)) {
            utils.when(() -> NotificationUtils.getLegalOrganizationNameForRespondent(caseData, true, organisationService))
                .thenReturn("Org1");
            ...
            assertThat(updated)
                .containsEntry(CLAIM_LEGAL_ORG_NAME_SPEC, "Org1")
                .containsEntry(LEGAL_ORG_NAME, "Org1")
