...
class RespondToClaimSpecCallbackHandlerTest extends BaseCallbackHandlerTest {
    ...
    class AboutToSubmitTests {
        ...
        void updateRespondent2AddressWhenSpecAoSRespondent2HomeAddressRequiredIsNO() {
            ...
            Party partyWithPrimaryAddress = new PartyBuilder().individual().build();
    ...
    class HandleLocations {
        ...
        void oneVOne() {
            ...
            Party defendant1 = new PartyBuilder()
                    .company().build();
    ...
    class SubmittedCallback {
        ...
        @Test
        void specificSummary_whenPartialAdmitNotPay_LrAdmissionBulkEnabledRespondent2() {
            // Given
            BigDecimal admitted = BigDecimal.valueOf(1000);
            CaseData caseData = CaseDataBuilder.builder()
                .atStateApplicantRespondToDefenceAndProceed()
        ...
        @Test
        void specificSummary_whenFullAdmitBySetDateRespondent2() {
            // Given
            CaseData caseData = CaseDataBuilder.builder()
                .atStateApplicantRespondToDefenceAndProceed()
                .build();
