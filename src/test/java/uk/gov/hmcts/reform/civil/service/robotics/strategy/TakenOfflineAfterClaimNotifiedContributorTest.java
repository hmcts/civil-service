...
class TakenOfflineAfterClaimNotifiedContributorTest {
    ...
    @InjectMocks
    private TakenOfflineAfterClaimNotifiedContributor contributor;
    ...
    void supportsReturnsTrueWhenStatePresent() {
        CaseData caseData = CaseData.builder()
            .submittedDate(LocalDateTime.of(2024, 2, 3, 8, 0))
            .build();
