...
class ClaimContinuingOnlineApplicantSpecRespSolTwoEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private ClaimContinuingOnlineApplicantSpecRespSolTwoEmailDTOGenerator generator;
    ...
    void shouldReturnReferenceTemplate() {
        String ref = generator.getReferenceTemplate();
