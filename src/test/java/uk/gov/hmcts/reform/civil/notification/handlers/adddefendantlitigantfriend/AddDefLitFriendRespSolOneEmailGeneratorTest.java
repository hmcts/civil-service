...
class AddDefLitFriendRespSolOneEmailGeneratorTest {
    ...
    @InjectMocks
    private AddDefLitFriendRespSolOneEmailDTOGenerator emailGenerator;
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("litigation-friend-added-respondent-notification-%s");
    }
}
