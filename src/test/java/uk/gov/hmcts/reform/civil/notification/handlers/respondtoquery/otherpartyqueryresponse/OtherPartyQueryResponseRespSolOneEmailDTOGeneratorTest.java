...
class OtherPartyQueryResponseRespSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private OtherPartyQueryResponseRespSolOneEmailDTOGenerator generator;
    ...
    @Test
    void shouldPopulateRespondentOneOrganisation() {
        CaseData caseData = CaseDataBuilder.builder().atStateClaimIssued().build();
        caseData.setRespondent1(createParty("Respondent"));
        caseData.setApplicant1(createParty("Applicant"));
        Organisation organisation = new Organisation().setOrganisationID("RESP1");
        caseData.setRespondent1OrganisationPolicy(new OrganisationPolicy().setOrganisation(organisation));
        uk.gov.hmcts.reform.civil.prd.model.Organisation prdOrganisation =
            new uk.gov.hmcts.reform.civil.prd.model.Organisation();
        prdOrganisation.setName("Respondent 1 Org");
        ...
        verify(respondToQueryHelper).addCustomProperties(properties, caseData, "Respondent 1 Org", false);
    }
