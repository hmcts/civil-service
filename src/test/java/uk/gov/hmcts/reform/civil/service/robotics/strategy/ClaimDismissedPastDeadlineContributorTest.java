...
class ClaimDismissedPastDeadlineContributorTest {
    ...
    @InjectMocks
    private ClaimDismissedPastDeadlineContributor contributor;
    ...
    void contributeThrowsWhenUnexpectedState() {
        ...
        assertThatThrownBy(() -> contributor.contribute(EventHistory.builder(), caseData, null))
