...
class DocmosisTemplateDataUtilsTest {
    ...
    void shouldReturnCaseName_whenMultiRespondent() {
        CaseData caseData = CaseData.builder()
            .applicant1(new Party()
                            ...
                            .setIndividualFirstName("Sam")
                            .setIndividualLastName("Clark")
                            .setPartyName("Ms. Irrelevant name"))
            .respondent2(new Party()
                             .setType(Party.Type.INDIVIDUAL)
                             .setIndividualTitle("Mr.")
                             .setIndividualFirstName("White")
            ...
            .respondent1(new Party()
                             ...
                             .setIndividualTitle("Mr.")
                             .setIndividualFirstName("Alex")
                             .setIndividualLastName("King")
                             .setPartyName("Mr. Alex King"))
            .build();
    ...
    void shouldReturnCaseName_whenApplicantIsSoleTrader() {
        CaseData caseData = CaseData.builder()
            .applicant1(new Party()
                            ...
                            .setSoleTraderLastName("Hammersmith")
                            .setSoleTraderTradingAs("EuroStar"))
            .respondent1(new Party()
                             .setType(Party.Type.INDIVIDUAL)
                             .setIndividualTitle("Mr.")
                             .setIndividualFirstName("Alex")
    ...
    void shouldReturnCaseName_whenRespondentIsSoleTrader() {
        CaseData caseData = CaseData.builder()
            ...
            .respondent1(new Party()
                             .setType(Party.Type.SOLE_TRADER)
                             .setSoleTraderFirstName("Boris")
                             .setSoleTraderLastName("Johnson")
                             .setSoleTraderTradingAs("UberFlip"))
            .build();
    ...
    void shouldReturnCaseName_whenBothAreSoleTrader() {
        CaseData caseData = CaseData.builder()
            ...
            .respondent1(new Party()
                             ...
                             .setSoleTraderFirstName("Sean")
                             .setSoleTraderLastName("White")
                             .setPartyName("Mr. Boris Johnson")
                             .setSoleTraderTradingAs("UberFlip"))
            .build();
