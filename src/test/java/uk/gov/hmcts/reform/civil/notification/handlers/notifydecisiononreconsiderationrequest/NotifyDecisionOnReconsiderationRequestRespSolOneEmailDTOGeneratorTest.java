...
class NotifyDecisionOnReconsiderationRequestRespSolOneEmailDTOGeneratorTest {
    ...
    private NotifyDecisionOnReconsiderationRequestRespSolOneEmailDTOGenerator generator;

    @BeforeEach
    void setUp() {
        generator = new NotifyDecisionOnReconsiderationRequestRespSolOneEmailDTOGenerator(organisationService, notificationsProperties);
    }
