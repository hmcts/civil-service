...
public class ResponseToJudgeDirectionsOrderTest extends GeneralApplicationBaseCallbackHandlerTest {
    ...
    @InjectMocks private ResponseToJudgeDirectionsOrder handler;
    ...
    void shouldPopulateDocListAndReturnNullWrittenRepUpload() {
        ...
        GeneralApplicationCaseData caseData = getCase(generalAppDirOrderUpload, null);
    ...
    private GeneralApplicationCaseData getCase(
            List<Element<Document>> generalAppDirOrderUpload,
