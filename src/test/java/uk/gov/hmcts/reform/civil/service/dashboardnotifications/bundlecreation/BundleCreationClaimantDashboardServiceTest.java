...
class BundleCreationClaimantDashboardServiceTest {
    ...
    @InjectMocks
    private BundleCreationClaimantDashboardService service;
    ...
    void shouldRecordScenarioForLipClaimant() {
        ...
        verify(dashboardScenariosService).recordScenarios(
            eq(AUTH_TOKEN),
            eq(SCENARIO_AAA6_BUNDLE_CREATED_TRIAL_READY_CLAIMANT.getScenario()),
            eq("1234"),
