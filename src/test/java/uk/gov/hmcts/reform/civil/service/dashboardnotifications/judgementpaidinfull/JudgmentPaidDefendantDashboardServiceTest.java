...
class JudgmentPaidDefendantDashboardServiceTest {
    ...
    @InjectMocks
    private JudgmentPaidDefendantDashboardService service;
    ...
    @Test
    void shouldRecordScenarioForJudgmentPaidDefendant() {
    ...
    @Test
    void shouldNotRecordScenarioForJudgmentPaidDefendant() {
        CaseData caseData = CaseDataBuilder.builder().build();
