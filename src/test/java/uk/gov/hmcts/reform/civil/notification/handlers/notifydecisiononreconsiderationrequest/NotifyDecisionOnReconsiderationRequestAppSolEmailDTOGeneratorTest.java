...
class NotifyDecisionOnReconsiderationRequestAppSolEmailDTOGeneratorTest {
    ...
    private NotifyDecisionOnReconsiderationRequestAppSolEmailDTOGenerator generator;

    @BeforeEach
    void setUp() {
        generator = new NotifyDecisionOnReconsiderationRequestAppSolEmailDTOGenerator(organisationService, notificationsProperties);
    }
    ...
    void shouldAddCustomProperties() {
        ...
        assertThat(result)
            ...
            .containsEntry(PARTY_NAME, caseData.getApplicant1().getPartyName());
    }
}
