...
class TrialReadyCheckRespondent1DefendantDashboardServiceTest {
    ...
    @InjectMocks
    private TrialReadyCheckRespondent1DefendantDashboardService service;
    ...
    @Test
    void shouldNotifyDefendantWhenTrialReadyCheckRespondent1Required() {
        ...
        service.notifyCaseTrialReadyCheckRespondent1(caseData, AUTH_TOKEN);
