...
public class RetriggerUpdateLocationSchedulerTest extends BpmnBaseTest {

    public static final String TOPIC_NAME = "RETRIGGER_UPDATE_LOCATION_EVENTS";

    public RetriggerUpdateLocationSchedulerTest() {
        super("retrigger_update_location_scheduler.bpmn", "RETRIGGER_UPDATE_LOCATION_SCHEDULER");
    }
