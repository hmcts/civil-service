...
class HearingScheduledClaimantNotificationHandlerTest extends BaseCallbackHandlerTest {
    ...
    @Test
    void shouldCreateDashboardNotificationsForHearingFeeIfCaseInHRAndRelisting() {
        when(dashboardNotificationsParamsMapper.mapCaseDataToParams(any())).thenReturn(params);
        ...
        caseData.setCcdCaseReference(1234L);
        caseData.setCcdState(HEARING_READINESS);
        caseData.setListingOrRelisting(RELISTING);
        caseData.setApplicant1Represented(YesOrNo.NO);
    ...
    @Test
    void shouldCreateDashboardNotificationsForHearingFeeIfCaseInHRAndListingUnset() {
        when(dashboardNotificationsParamsMapper.mapCaseDataToParams(any())).thenReturn(params);
        CaseData caseData = CaseDataBuilder.builder().build();
        caseData.setLegacyCaseReference("reference");
        caseData.setCcdCaseReference(1234L);
