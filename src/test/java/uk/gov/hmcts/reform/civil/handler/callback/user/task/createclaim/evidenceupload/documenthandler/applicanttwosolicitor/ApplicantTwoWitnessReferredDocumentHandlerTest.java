...
public class ApplicantTwoWitnessReferredDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantTwoWitnessReferredDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldHandleDocumentsWithRenaming() {
        ...
        CaseData caseData = CaseData.builder()
                .documentReferredInStatementApp2(List.of(
