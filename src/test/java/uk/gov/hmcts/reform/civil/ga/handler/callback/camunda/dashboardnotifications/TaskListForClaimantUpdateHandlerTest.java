        ...
        void shouldKeepHearingListingInProgressWhenAnotherApplicationHasFinished(String storedStatus,
            ...
            caseData = caseData.copy()
                ...
                .claimantGaAppDetails(List.of(
                    element(new GeneralApplicationsDetails()
            ...
            CallbackParams params = CallbackParamsBuilder.builder().of(ABOUT_TO_SUBMIT, caseData).request(
                CallbackRequest.builder().eventId(UPDATE_CLAIMANT_TASK_LIST_GA.name()).build()
            ).build();
            ...
            assertThat(caseData.getClaimantGaAppDetails().getFirst().getValue().getCaseState()).isEqualTo(storedStatus);
        }
