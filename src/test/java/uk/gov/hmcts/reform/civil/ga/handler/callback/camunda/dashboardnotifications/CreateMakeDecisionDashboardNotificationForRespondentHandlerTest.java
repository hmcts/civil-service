...
public class CreateMakeDecisionDashboardNotificationForRespondentHandlerTest
    ...
    @InjectMocks private CreateMakeDecisionDashboardNotificationForRespondentHandler handler;
    ...
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents())
                .contains(CREATE_RESPONDENT_DASHBOARD_NOTIFICATION_FOR_MAKE_DECISION);
    }
    ...
    class AboutToSubmitCallback {
        ...
        @Test
        void
                shouldNotRecordRequestWrittenRepresentationsRespondentScenarioWhenAppIsNotUncloakedInvoked() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withNoticeCaseData()
    ...
    class AboutToSubmitCallbackForHearingScheduled {
        ...
        void shouldRecordOrderMadeRespondentScenarioWhenInvoked_isWIthNoticeApplication(
            ...
            caseData =
                    caseData.copy()
                            ...
                            .judicialDecisionMakeOrder(
                                    new GAJudicialMakeAnOrder().setMakeAnOrder(orderOption))
                            .build();
        ...
        @Test
        void
                shouldRecordOrderMadeApplicantScenarioWhenInvoked_isWIthNoticeApplication_whenStateIsNotCorrect() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withNoticeCaseData()
        ...
        @Test
        void
                shouldRecordRequestWrittenRepresentationsApplicantScenarioWhenInvokedForUncloakedApplication() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withoutNoticeCaseData()
