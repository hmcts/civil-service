...
class HearingDocumentDeadlineParamsBuilderTest {
    ...
    @BeforeEach
    void setUp() {
        sdoCaseClassificationService = mock(SdoCaseClassificationService.class);
        builder = new HearingDocumentDeadlineParamsBuilder(sdoCaseClassificationService);
    }

    @Test
    void shouldReturnEmptyForSmallClaimsTrack() {
        CaseData caseData = mock(CaseData.class);
        when(sdoCaseClassificationService.isSmallClaimsTrack(caseData)).thenReturn(true);
