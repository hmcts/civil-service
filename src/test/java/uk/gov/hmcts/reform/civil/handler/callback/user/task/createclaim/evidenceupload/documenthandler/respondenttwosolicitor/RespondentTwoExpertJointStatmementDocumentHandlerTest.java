...
public class RespondentTwoExpertJointStatmementDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentTwoExpertJointStatmementDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldRenameDocumentsThroughHandleDocuments() {
        ...
        CaseData caseData = CaseData.builder()
                .documentJointStatementRes2(List.of(
