...
public class CreateSDORespSolTwoEmailDTOGeneratorTest {

    @InjectMocks
    private CreateSDORespSolTwoEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("create-sdo-respondent-2-notification-%s");
    }
}
