...
public class RespondentTwoAuthoritiesDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentTwoAuthoritiesDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldNotRenameDocumentsIndirectlyThroughHandleDocuments() {
        ...
        CaseData caseData = CaseData.builder()
                .documentAuthoritiesRes2(List.of(
