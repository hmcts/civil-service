...
class GenerateTrialReadyDocApplicantDashboardServiceTest {
    ...
    @InjectMocks
    private GenerateTrialReadyDocApplicantDashboardService service;
    ...
    @Test
    void shouldRecordScenarioForGenerateTrialReadyDocApplicantDefendant() {
        CaseData caseData = CaseDataBuilder.builder().build();
        caseData.setRespondent1Represented(YesOrNo.NO);
        caseData.setCcdCaseReference(1234L);

        service.notifyGenerateTrialReadyDocApplicant(caseData, AUTH_TOKEN);
    ...
    @Test
    void shouldNotRecordScenarioForGenerateTrialReadyDocApplicantDefendant() {
        CaseData caseData = CaseDataBuilder.builder().build();
