...
public class CreateApplicationRespondedDashboardNotificationHandlerTest
    ...
    @InjectMocks CreateApplicationRespondedDashboardNotificationHandler handler;
    ...
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents())
                .contains(CREATE_APPLICATION_RESPONDED_DASHBOARD_NOTIFICATION);
    }
