...
public class NotifyDefendantClaimantSettleTheClaimDefendantEmailDTOGeneratorTest {
    ...
    @Test
    void shouldNotifyWhenNoSolicitorEmailAndPartyEmailPresent() {
        CaseData caseData = CaseData.builder()
            .respondent1(new Party().setType(Party.Type.INDIVIDUAL).setPartyEmail("defendant@test.com"))
            .build();
    ...
    @Test
    void shouldNotNotifyWhenSolicitorEmailIsPresent() {
        CaseData caseData = CaseData.builder()
    ...
    @Test
    void shouldNotNotifyWhenNoSolicitorEmailAndNoPartyEmail() {
        CaseData caseData = CaseData.builder()
