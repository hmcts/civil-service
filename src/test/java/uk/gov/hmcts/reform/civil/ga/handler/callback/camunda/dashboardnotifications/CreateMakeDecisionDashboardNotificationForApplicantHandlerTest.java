...
public class CreateMakeDecisionDashboardNotificationForApplicantHandlerTest
    ...
    @InjectMocks private CreateMakeDecisionDashboardNotificationForApplicantHandler handler;
    @Mock private JudicialDecisionHelper judicialDecisionHelper;

    @Test
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents())
                .contains(CREATE_APPLICANT_DASHBOARD_NOTIFICATION_FOR_MAKE_DECISION);
    }
    ...
    class AboutToSubmitCallback {
        ...
        @Test
        void
                shouldNotRecordOrderMadeApplicantScenarioWhenInvoked_isWIthNoticeApplication_OrderNotMade() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .atStateClaimDraft()
                            .withNoticeCaseData()
            ...
            caseData =
                    caseData.copy()
                            ...
                            .generalAppInformOtherParty(
                                    new GAInformOtherParty().setIsWithNotice(YesOrNo.YES))
                            .ccdState(CaseState.AWAITING_RESPONDENT_RESPONSE)
                            .judicialDecisionMakeOrder(null)
                            .build();
        ...
        private static Stream<Arguments> provideOrderType() {
            return Stream.of(
                    Arguments.of(
                            GAJudgeDecisionOption.MAKE_AN_ORDER,
                            GAJudgeMakeAnOrderOption.APPROVE_OR_EDIT),
                    Arguments.of(
                            GAJudgeDecisionOption.MAKE_AN_ORDER,
