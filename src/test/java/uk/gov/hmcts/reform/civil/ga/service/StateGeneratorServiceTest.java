...
public class StateGeneratorServiceTest {
    ...
    @InjectMocks StateGeneratorService stateGeneratorService;
    @Mock JudicialDecisionHelper judicialDecisionHelper;
    ...
    public void shouldReturnAwaiting_Addition_InformationWhenMoreInfoSelected() {
        ...
        CaseState caseState =
                stateGeneratorService.getCaseStateForEndJudgeBusinessProcess(caseData);
        assertThat(caseState).isEqualTo(AWAITING_ADDITIONAL_INFORMATION);
    }

    @Test
    public void
            shouldReturn_Awaiting_Written_Representation_WhenMakeOrderForWrittenRepresentationsSelected() {
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData()
                        .judicialDecision(
                                new GAJudicialDecision(MAKE_ORDER_FOR_WRITTEN_REPRESENTATIONS))
                        .judicialDecisionMakeOrder(new GAJudicialMakeAnOrder().setOrderText("test"))
                        .build();
    ...
    public void shouldReturnCurrentStateWhenMakeOrderAndDismissed() {
        ...
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData()
                        ...
                        .businessProcess(new BusinessProcess().setCamundaEvent(JUDGES_DECISION))
                        .judicialDecisionMakeOrder(
                                new GAJudicialMakeAnOrder().setMakeAnOrder(DISMISS_THE_APPLICATION))
                        .build();
                ...
                new GeneralApplicationCaseData()
                        .approveConsentOrder(
                                new GAApproveConsentOrder()
                                        .setConsentOrderDescription("Test Order"))
                        .build();
    ...
    public void shouldReturnProceedsInHeritageSystemWhenTheDecisionHasBeenMade() {
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData()
                        ...
                        .businessProcess(new BusinessProcess().setCamundaEvent(JUDGES_DECISION))
                        .generalAppType(
                                new GAApplicationType().setTypes(applicationTypeJudgement()))
                        .build();
        CaseState caseState =
                stateGeneratorService.getCaseStateForEndJudgeBusinessProcess(caseData);
    ...
    @Test
    void
            shouldNotReturnOrderAdditionalAddPayment_WhenJudgeUncloakTheApplicationAwaitingDocsOrderMake() {
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData()
                        .ccdState(APPLICATION_SUBMITTED_AWAITING_JUDICIAL_DECISION)
                        .judicialDecision(new GAJudicialDecision(MAKE_AN_ORDER))
    ...
    @Test
    void
            shouldNotReturnAdditionalAddPayment_WhenJudgeUncloakTheApplication_RequestMoreInformation() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .judicialDecisionWithUncloakRequestForInformationApplication(
                                SEND_APP_TO_OTHER_PARTY, NO, YesOrNo.NO)
                        .generalAppType(
                                new GAApplicationType()
                                        .setTypes(singletonList(SET_ASIDE_JUDGEMENT)))
                        .build();

        when(judicialDecisionHelper.isApplicationUncloakedWithAdditionalFee(any()))
                .thenReturn(true);
    ...
    @Test
    void
            shouldRequestMoreInformation_WhenJudgeUncloakTheApplication_AdditionalPaymentIsMadeSuccessfully() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .judicialDecisionWithUncloakRequestForInformationApplication(
                                SEND_APP_TO_OTHER_PARTY, NO, YesOrNo.NO)
    ...
    @Test
    void
            shouldAwaitingJudicialDecision__WhenAdditionalPaymentReceived_RequestMoreInformation_UrgentWithoutNotice() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
    ...
    @Test
    void
            shouldAwaitingJudicialDecision__WhenAdditionalPaymentReceived_RequestMoreInformation_ConsentOrder() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .generalAppRespondentSolicitors(getRespondentSolicitors())
                        .judicialDecisionWithUncloakRequestForInformationApplication(
    ...
    @Test
    void
            shouldRespondentResponse_WhenAdditionalPaymentReceived_ConsentOrder_withoutRespondentResponse() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .judicialDecisionWithUncloakRequestForInformationApplication(
                                SEND_APP_TO_OTHER_PARTY, NO, YesOrNo.NO)
