...
public class FailedPaymentApplicantForSpecNotificationHandlerTest extends BaseCallbackHandlerTest {
    ...
    class AboutToSubmitCallback {
        ...
        private Map<String, String> getNotificationDataMap() {
            Map<String, String> props = new HashMap<>(addCommonProperties());
            props.put(CLAIM_LEGAL_ORG_NAME_SPEC, "Signer Name");
            props.put(CLAIM_REFERENCE_NUMBER, CASE_ID.toString());
            props.put(PARTY_REFERENCES, "Claimant reference: 12345 - Defendant reference: 6789");
            props.put(CASEMAN_REF, "000DC001");
            return props;
        }
