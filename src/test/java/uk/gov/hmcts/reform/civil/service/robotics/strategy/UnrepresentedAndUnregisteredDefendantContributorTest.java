...
class UnrepresentedAndUnregisteredDefendantContributorTest {
    ...
    @InjectMocks
    private UnrepresentedAndUnregisteredDefendantContributor contributor;
    ...
    void setUp() {
        ...
        when(textFormatter.unrepresentedAndUnregistered(1, "2024-03-02",
        ...
        when(textFormatter.unrepresentedAndUnregistered(2, "2024-03-02",
