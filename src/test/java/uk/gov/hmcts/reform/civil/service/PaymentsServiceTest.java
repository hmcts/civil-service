...
@ContextConfiguration(classes = {PaymentsService.class, JacksonAutoConfiguration.class})
class PaymentsServiceTest {
    ...
    private static final PBAServiceRequestResponse PAYMENT_DTO =
            PBAServiceRequestResponse.builder().paymentReference("RC-1234-1234-1234-1234").build();
    private static final PaymentServiceResponse PAYMENT_SERVICE_RESPONSE =
            PaymentServiceResponse.builder()
                    .serviceRequestReference("RC-1234-1234-1234-1234")
                    .build();
    private static final Organisation ORGANISATION =
            new Organisation()
                    .setName("test org")
    ...
    @MockBean private PaymentsClient paymentsClient;

    @MockBean private PaymentsConfiguration paymentsConfiguration;

    @MockBean private OrganisationService organisationService;

    @MockBean private HearingFeesService hearingFeesService;
    ...
    @BeforeEach
    void setUp() {
        given(paymentsClient.createServiceRequest(any(), any()))
                .willReturn(PAYMENT_SERVICE_RESPONSE);
        ...
        given(organisationService.findOrganisationById(any()))
    ...
    void shouldCreatePaymentServiceRequest_whenValidCaseDetails() {
        ...
        PaymentServiceResponse serviceRequestResponse =
                paymentsService.createServiceRequest(caseData, AUTH_TOKEN);
    ...
    void shouldCreateCreditAccountPayment_whenValidCaseDetails() {
        ...
        PBAServiceRequestResponse paymentResponse =
                paymentsService.createPbaPayment(caseData, AUTH_TOKEN);
    ...
    void validateRequestGaShouldThrowAnError_whenFeeDetailsDoNotHaveFeeAmount() {
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData()
                        .generalAppPBADetails(
                                new GeneralApplicationPbaDetails()
                                        .setFee(new Fee().setCode("FEE0442").setVersion("1")))
                        .generalAppApplnSolicitor(
                                new GASolicitorDetailsGAspec().setOrganisationIdentifier("OrgId"))
                        .build();
    ...
    void validateRequestGaShouldThrowAnError_whenApplicantSolicitorDetailsAreNotSet() {
        ...
        assertThat(exception.getMessage())
                .isEqualTo("Applicant's organization details not received.");
    }
    ...
    @Test
    void
            validateRequestGaShouldNotThrowAnError_whenApplicantSolicitorOrgDetailsAreNotSetForLiPApplicant() {
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData()
    ...
    void shouldCreatePaymentServiceRequestGa_whenValidCaseDetails() {
        ...
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder().buildMakePaymentsCaseData().build();
        PaymentServiceResponse serviceRequestResponse =
                paymentsService.createServiceRequestGa(caseData, AUTH_TOKEN);
