    ...
    class MidEventShowCertifyConditionCallback {
        ...
        void shouldReturnExpectedResponse_WhenCase2v1() {
            CaseData caseData = CaseDataBuilder.builder().atStateNotificationAcknowledged()
                ...
                .defendantDetails("Mr. Sole Trader")
                .build();
        ...
        @Test
        void shouldReturnExpectedResponse_CaseNameWhenCase1v2AndBothSelected() {
            CaseData caseData = CaseDataBuilder.builder().atStateNotificationAcknowledged().build().toBuilder()
                .respondent2(PartyBuilder.builder().individual().build())
                .addRespondent2(YES)
                .respondent2SameLegalRepresentative(YES)
        ...
        @Test
        void shouldReturnExpectedResponse_CaseNameWhenCase1v2AndBothNotSelected() {
            CaseData caseData = CaseDataBuilder.builder().atStateNotificationAcknowledged().build().toBuilder()
                .respondent2(PartyBuilder.builder().individual().build())
                .addRespondent2(YES)
                .respondent2SameLegalRepresentative(YES)
