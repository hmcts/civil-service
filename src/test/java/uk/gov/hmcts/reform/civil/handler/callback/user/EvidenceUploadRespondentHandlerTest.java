...
class EvidenceUploadRespondentHandlerTest extends BaseCallbackHandlerTest {
    ...
    private final UploadEvidenceDocumentType uploadEvidenceDate = new UploadEvidenceDocumentType();
    ...
    void shouldNotReturnError_whenDocumentTypeUploadDatePastRespondentOne(String dateField, String collectionField) {
        // Given
    ...
    void shouldNotReturnError_whenDocumentTypeUploadDatePastRespondentTwo(String dateField, String collectionField) {
        // Given
        List<Element<UploadEvidenceDocumentType>> date = new ArrayList<>();
        date.add(0, element(invoke(uploadEvidenceDate.toBuilder(), dateField, time.now()
            .toLocalDate().minusWeeks(1)).build()));
    ...
    void shouldReturnError_whenOneDateIsInFutureForOneRespondent(String dateField, String collectionField, String errorMessage) {
        //uploadEvidenceDate represents a collection so can have multiple dates entered at any time,
    ...
    void shouldReturnError_whenOneDateIsInFutureForTwoRespondents(String dateField, String collectionField, String errorMessage) {
        //uploadEvidenceDate represents a collection so can have multiple dates entered at any time,
        // these dates should all be in the past, otherwise an error will be populated
