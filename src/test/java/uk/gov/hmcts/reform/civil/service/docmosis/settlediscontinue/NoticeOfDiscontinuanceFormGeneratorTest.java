...
class NoticeOfDiscontinuanceFormGeneratorTest {
    ...
    private CaseData getCaseData() {
        return CaseDataBuilder.builder().atStateClaimIssued().build().toBuilder()
                ...
                .respondent1(PartyBuilder.builder().individual().build().setIndividualFirstName("John").setIndividualLastName("Doe"))
                .respondent2(PartyBuilder.builder().individual().build().setIndividualFirstName("Lily").setIndividualLastName("Potter"))
                .applicant1(PartyBuilder.builder().individual().build().setIndividualFirstName("James").setIndividualLastName("White"))
                .applicant2(PartyBuilder.builder().individual().build().setIndividualFirstName("Jan").setIndividualLastName("Black"))
