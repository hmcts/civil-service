...
public class ClaimantResponseConfirmsToProceedRespSolTwoEmailDTOGeneratorTest {

    @Mock
    private ClaimantResponseConfirmsToProceedEmailHelper helper;

    @InjectMocks
    private ClaimantResponseConfirmsToProceedRespSolTwoEmailDTOGenerator emailDTOGenerator;
