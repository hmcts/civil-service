...
public class ClaimantResponseNotAgreedRepaymentAppSolOneEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    private ClaimantResponseNotAgreedRepaymentAppSolOneEmailDTOGenerator emailDTOGenerator;
