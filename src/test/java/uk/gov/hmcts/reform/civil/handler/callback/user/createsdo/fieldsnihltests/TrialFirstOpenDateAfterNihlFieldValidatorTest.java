...
import uk.gov.hmcts.reform.civil.handler.callback.user.createsdo.fieldsnihl.TrialFirstOpenDateAfterNihlFieldValidator;
...
class TrialFirstOpenDateAfterNihlFieldValidatorTest {

    @Mock
    private FieldsNihlUtils fieldsNihlUtils;

    @InjectMocks
    private TrialFirstOpenDateAfterNihlFieldValidator validator;
    ...
    void shouldAddErrorWhenDateIsInThePast() {
        ...
        when(fieldsNihlUtils.validateFutureDate(caseData.getSdoR2Trial().getSdoR2TrialFirstOpenDateAfter().getListFrom()))
