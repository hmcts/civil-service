...
public class RespondentTwoWitnessSummaryDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentTwoWitnessSummaryDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldHandleDocumentsWithRenaming() {
        ...
        CaseData caseData = CaseData.builder()
                .documentWitnessSummaryRes2(List.of(
        ...
        assertEquals("Witness Summary of Witness Name 10-02-2022.pdf", caseData.getDocumentWitnessSummaryRes2().get(0).getValue().getWitnessOptionDocument().getDocumentFileName());
    }
}