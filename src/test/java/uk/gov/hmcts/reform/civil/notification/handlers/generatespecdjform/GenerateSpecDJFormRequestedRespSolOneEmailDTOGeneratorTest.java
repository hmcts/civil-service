...
class GenerateSpecDJFormRequestedRespSolOneEmailDTOGeneratorTest {
    ...
    private GenerateSpecDJFormRequestedRespSolOneEmailDTOGenerator generator;
    ...
    void setUp() {
        ...
        generator = new GenerateSpecDJFormRequestedRespSolOneEmailDTOGenerator(organisationService, notificationsProperties,
            notificationHelper);
    ...
    void shouldAddCustomPropertiesUsingDynamicList() {
        ...
        assertThat(result).containsEntry(DEFENDANT_EMAIL, "Respondent Org");
    ...
    @Test
    void shouldFallbackToRespondentNameWhenDynamicListMissing() {
        Map<String, String> properties = new HashMap<>();
        CaseData caseData = mock(CaseData.class);
        Party applicant1 = mock(Party.class);
    ...
    @Test
    void shouldNotNotifyWhenOnlyOneDefendantOnCase() {
