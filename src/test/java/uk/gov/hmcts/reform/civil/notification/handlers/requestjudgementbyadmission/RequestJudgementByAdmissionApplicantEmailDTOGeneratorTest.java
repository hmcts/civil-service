...
class RequestJudgementByAdmissionApplicantEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private RequestJudgementByAdmissionApplicantEmailDTOGenerator emailDTOGenerator;

    @Test
    void shouldReturnCorrectReferenceTemplate() {
        String referenceTemplate = emailDTOGenerator.getReferenceTemplate();

        assertThat(referenceTemplate).isEqualTo("request-judgement-by-admission-applicant-notification-%s");
    }
    ...
    void shouldReturnCorrectEmailTemplateId() {
        ...
        when(notificationsProperties.getNotifyApplicantLipRequestJudgementByAdmissionNotificationTemplate())
