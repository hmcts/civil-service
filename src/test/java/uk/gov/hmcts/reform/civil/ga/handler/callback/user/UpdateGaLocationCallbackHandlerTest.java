...
class UpdateGaLocationCallbackHandlerTest extends GeneralApplicationBaseCallbackHandlerTest {
    ...
    @InjectMocks private UpdateGaLocationCallbackHandler handler;
    ...
    class AboutToSubmitCallback {
        ...
        void shouldRespondAndUpdateCaseManagementLocation() {
            ...
            assertThat(response.getData())
                    ...
                    .isEqualTo("TRIGGER_LOCATION_UPDATE");

            assertThat(response.getData()).containsEntry("isCcmccLocation", "No");
            assertThat(response.getData()).containsEntry("locationName", "locationForRegion2");
            assertThat(response.getData())
                    .containsEntry(
        ...
        void shouldRespondAndUpdateCaseManagementLocationForTaskReconfig() {
            ...
            assertThat(response.getData())
                    .extracting("businessProcess")
                    .extracting("camundaEvent")
                    .isEqualTo("TRIGGER_TASK_RECONFIG");
        ...
        private GeneralApplication getGeneralApplication(
            ...
            return new GeneralApplication()
                    ...
                    .setCaseManagementLocation(
                            new CaseLocationCivil().setBaseLocation("687686").setRegion("4"))
        ...
        private GeneralApplicationCaseData getParentCaseDataAfterUpdateFromCivilService(
                YesOrNo isConsented, YesOrNo isTobeNotified) {
