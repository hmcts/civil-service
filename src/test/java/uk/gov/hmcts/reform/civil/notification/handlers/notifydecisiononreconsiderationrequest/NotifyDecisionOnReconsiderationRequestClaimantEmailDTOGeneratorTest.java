...
class NotifyDecisionOnReconsiderationRequestClaimantEmailDTOGeneratorTest {
    ...
    private NotifyDecisionOnReconsiderationRequestClaimantEmailDTOGenerator generator;

    @BeforeEach
    void setUp() {
        generator = new NotifyDecisionOnReconsiderationRequestClaimantEmailDTOGenerator(notificationsProperties);
    }
