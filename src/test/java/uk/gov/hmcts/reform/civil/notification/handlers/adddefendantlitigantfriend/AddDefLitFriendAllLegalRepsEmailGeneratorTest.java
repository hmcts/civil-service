...
class AddDefLitFriendAllLegalRepsEmailGeneratorTest {

    @Mock
    private AddDefLitFriendAppSolOneEmailDTOGenerator appSolOneEmailGenerator;

    @Mock
    private AddDefLitFriendRespSolOneEmailDTOGenerator respSolOneEmailGenerator;

    @Mock
    private AddDefLitFriendRespSolTwoEmailDTOGenerator respSolTwoEmailGenerator;
