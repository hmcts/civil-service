...
class BreathingSpaceLiftedLipNotificationHandlerTest {
    ...
    void shouldNotifyLipClaimant_withEnglishTemplate() {
        when(notificationsProperties.getNotifyLiPApplicantBreathingSpaceLifted())
            .thenReturn(ENGLISH_CLAIMANT_TEMPLATE);

        CaseData caseData = lipCaseData(CLAIMANT_EMAIL, DEFENDANT_EMAIL, null, null);

        handler.handle(callbackParams(caseData, CaseEvent.NOTIFY_LIP_APPLICANT_BREATHING_SPACE_LIFTED));
    ...
    void shouldNotifyLipClaimant_withWelshTemplate_whenClaimantBilingual() {
        when(notificationsProperties.getNotifyLiPApplicantBreathingSpaceLiftedWelsh())
    ...
    void shouldNotifyLipDefendant_withEnglishTemplate() {
        when(notificationsProperties.getNotifyLiPRespondentBreathingSpaceLifted())
        ...
        handler.handle(callbackParams(caseData, CaseEvent.NOTIFY_LIP_RESPONDENT1_BREATHING_SPACE_LIFTED));
    ...
    void shouldNotifyLipDefendant_withWelshTemplate_whenDefendantBilingual() {
        when(notificationsProperties.getNotifyLiPRespondentBreathingSpaceLiftedWelsh())
