...
import static uk.gov.hmcts.reform.civil.ga.stateflow.StateFlowContext.EXTENDED_STATE_HISTORY_KEY;

@ExtendWith(SpringExtension.class)
class GaStateFlowTest {
    ...
    class IsFlagSet {
        ...
        void setup() {
            ...
            stateFlow = new GaStateFlow(mockedStateMachine);
        }
