...
import uk.gov.hmcts.reform.civil.handler.callback.user.createsdo.fieldsnihl.DefendantMayAskDateNihlFieldValidator;
...
class DefendantMayAskDateNihlFieldValidatorTest {

    @Mock
    private FieldsNihlUtils fieldsNihlUtils;

    @InjectMocks
    private DefendantMayAskDateNihlFieldValidator validator;
    ...
    void shouldAddErrorWhenDateIsInThePast() {
        ...
        when(fieldsNihlUtils.validateFutureDate(caseData.getSdoR2QuestionsClaimantExpert().getSdoDefendantMayAskDate()))
    ...
    void shouldNotAddErrorWhenDateIsInTheFuture() {
        CaseData caseData = CaseData.builder()
                .sdoR2QuestionsClaimantExpert(SdoR2QuestionsClaimantExpert.builder()
                        .sdoDefendantMayAskDate(LocalDate.now().plusDays(1))
                        .build())
                .build();
