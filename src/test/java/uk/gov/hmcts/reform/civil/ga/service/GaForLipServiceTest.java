...
class GaForLipServiceTest {
    ...
    @InjectMocks private GaForLipService gaForLipService;
    ...
    void shouldReturnDefendantEmailWhenUserDetailsIsNotPresent() {
        GeneralApplicationCaseData civilCaseData =
                new GeneralApplicationCaseData()
                        .respondentSolicitor1EmailAddress("defendantEmail@test.com")
                        .build();
    ...
    void shouldReturnAnyFalse_nobody_is_welsh() {
        GeneralApplicationCaseData caseData =
                new GeneralApplicationCaseData().parentClaimantIsApplicant(YesOrNo.YES).build();
