...
class SealedClaimResponseFormGeneratorForSpecTest {
    ...
    @Mock private RepresentativeService representativeService;
    ...
    @Mock private ReferenceNumberAndCourtDetailsPopulator referenceNumberPopulator;
    @Mock private StatementOfTruthPopulator statementOfTruthPopulator;

    @Captor private ArgumentCaptor<SealedClaimResponseFormForSpec> templateDataCaptor;
    @Captor private ArgumentCaptor<DocmosisTemplates> templateEnumCaptor;
    @Captor private ArgumentCaptor<PDF> pdfCaptor;

    @InjectMocks
    private SealedClaimResponseFormGeneratorForSpec generator;

    private CaseData base1v1;
    private CaseData base1v2_latestIsResp2;
    ...
    void init() {
        ...
        base1v2_latestIsResp2 = CaseData.builder()
    ...
    void getTemplateData_1v2_latestIsRespondent2_usesResp2_fields_timeline2_and_resp2_def_doc() {
        SealedClaimResponseFormForSpec dto = generator.getTemplateData(base1v2_latestIsResp2, AUTH);
        ...
        assertThat(dto.getPaymentDate()).isEqualTo(base1v2_latestIsResp2.getRespondToAdmittedClaim().getWhenWasThisAmountPaid());
    ...
    void getTemplateData_1v2_latestIsRespondent1_switches_to_resp1_fields_doc_and_timeline1() {
        CaseData resp1Latest = base1v2_latestIsResp2.toBuilder()
    ...
    void generate_1v1_uses_LR_ADMISSION_BULK_template_and_uploads_pdf() {
        ...
        verify(documentGeneratorService).generateDocmosisDocument(templateDataCaptor.capture(), templateEnumCaptor.capture());
        ...
        assertThat(pdf.getFilename()).contains("LEG-123");
