...
public class SealedClaimResponseFormGeneratorForSpecTest {
    ...
    private static final List<LocationRefData> LOCATIONS = List.of(LocationRefData.builder()
            .siteName("SiteName")
            .courtAddress("1")
            .postcode("1")
    ...
    void contentCheckRespondent1() {
        SealedClaimResponseFormForSpec templateData =
                generator.getTemplateData(CASE_DATA_WITH_RESPONDENT1, BEARER_TOKEN);
        ...
        Assertions.assertEquals(
                CASE_DATA_WITH_RESPONDENT1
                        .getRespondent1DQ()
                        .getRespondent1DQStatementOfTruth()
                        .getName(),
    ...
    public void contentCheckRespondent2() {
        ...
        SealedClaimResponseFormForSpec templateData = generator.getTemplateData(caseData, BEARER_TOKEN);
        ...
        Assertions.assertEquals(
                caseData.getDetailsOfWhyDoesYouDisputeTheClaim2(), templateData.getWhyDisputeTheClaim());
        Assertions.assertEquals(
                caseData.getRespondent2DQ().getRespondent2DQStatementOfTruth().getName(),
                templateData.getStatementOfTruth().getName());
        Assertions.assertEquals(
                caseData.getRespondent2DQ().getRespondent2DQStatementOfTruth().getRole(),
                templateData.getStatementOfTruth().getRole());
        Assertions.assertEquals(LOCATIONS.get(0).getCourtName(), templateData.getHearingCourtLocation());
    }

    @Test
    public void contentCheckMultipartyRespondent2Answering() {
        SealedClaimResponseFormForSpec templateData =
                generator.getTemplateData(CASE_DATA_WITH_MULTI_PARTY, BEARER_TOKEN);
        ...
        Assertions.assertEquals(
                ...
                templateData.getWhyDisputeTheClaim());
        Assertions.assertEquals(
                CASE_DATA_WITH_MULTI_PARTY
                        .getRespondent2DQ()
                        .getRespondent2DQStatementOfTruth()
                        .getName(),
                templateData.getStatementOfTruth().getName());
        Assertions.assertEquals(
                CASE_DATA_WITH_MULTI_PARTY
        ...
        Assertions.assertEquals(
                CASE_DATA_WITH_MULTI_PARTY
                        .getRespondent2SpecDefenceResponseDocument()
                        .getFile()
                        .getDocumentFileName(),
        ...
        Assertions.assertEquals(
                CASE_DATA_WITH_MULTI_PARTY
                        .getSpecResponseTimelineOfEvents2()
                        .get(0)
                        .getValue()
    ...
    public void contentCheckMultipartyRespondent1Answering() {
        ...
        Assertions.assertEquals(caseData.getLegacyCaseReference(), templateData.getReferenceNumber());
        Assertions.assertEquals(caseData.getDetailsOfWhyDoesYouDisputeTheClaim(), templateData.getWhyDisputeTheClaim());
        Assertions.assertEquals(
    ...
    private static CaseData getCaseDataWithMultiParty() {
        ...
        timelines.add(TimelineOfEvents.builder()
                .value(TimelineOfEventDetails.builder()
                        ...
                        .timelineDescription("test timeline")
                        .build())
                .build());
        ...
        timelines2.add(TimelineOfEvents.builder()
                .value(TimelineOfEventDetails.builder()
                        .timelineDate(LocalDate.now())
                        .timelineDescription("test timeline2")
                        .build())
                .build());
        return CaseData.builder()
                .legacyCaseReference("case reference")
    ...
    void shouldGenerateDocumentSuccessfully_AfterCarmEnabled_1v1() {
        ...
        // Then
        SealedClaimResponseFormForSpec templateData = generator.getTemplateData(caseData, BEARER_TOKEN);
        Assertions.assertEquals("Jane", templateData.getMediationFirstName());
        Assertions.assertEquals("Smith", templateData.getMediationLastName());
        Assertions.assertEquals("jane.smith@email.com", templateData.getMediationEmail());
        Assertions.assertEquals("123456789", templateData.getMediationContactNumber());
        Assertions.assertEquals(
                LocalDate.now(),
                templateData
                        .getMediationUnavailableDatesList()
                        .get(0)
                        .getValue()
                        .getFromDate());
        Assertions.assertEquals(
    ...
    void shouldGenerateDocumentSuccessfully_AfterCarmDisabled() {
        ...
        // Then
        SealedClaimResponseFormForSpec templateData = generator.getTemplateData(caseData, BEARER_TOKEN);
        Assertions.assertEquals(YesOrNo.YES, templateData.getMediation());
    }
    ...
    void shouldSelectTemplateWithoutRepaymentPlan_whenLrAdmissionBulkEnabled() {
        ...
        verify(documentGeneratorService)
                .generateDocmosisDocument(templateDataCaptor.capture(), docmosisTemplatesArgumentCaptor.capture());
        assertThat(docmosisTemplatesArgumentCaptor.getValue())
                .isEqualTo(DocmosisTemplates.DEFENDANT_RESPONSE_SPEC_SEALED_1V1_INSTALLMENTS_LR_ADMISSION_BULK);
    }
