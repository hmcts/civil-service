...
class GAUnlessOrderSchedulerTest {
    ...
    void shouldRunGAUnlessOrderTask() {
        ...
        when(filter.hasExpiredUnlessOrderDeadline(expiredCaseDetails)).thenReturn(true);
        when(filter.hasExpiredUnlessOrderDeadline(futureCaseDetails)).thenReturn(false);
