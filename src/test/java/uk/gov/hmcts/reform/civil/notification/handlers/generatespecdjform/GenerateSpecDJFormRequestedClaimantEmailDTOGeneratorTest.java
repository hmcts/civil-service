...
class GenerateSpecDJFormRequestedClaimantEmailDTOGeneratorTest {
    ...
    private GenerateSpecDJFormRequestedClaimantEmailDTOGenerator generator;
    private MockedStatic<PartyUtils> partyUtilsMockedStatic;

    @BeforeEach
    void setUp() {
        generator = new GenerateSpecDJFormRequestedClaimantEmailDTOGenerator(notificationsProperties);
