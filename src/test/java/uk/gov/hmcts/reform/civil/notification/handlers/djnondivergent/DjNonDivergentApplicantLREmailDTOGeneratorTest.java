...
public class DjNonDivergentApplicantLREmailDTOGeneratorTest {
    ...
    @InjectMocks
    private DjNonDivergentApplicantLREmailDTOGenerator emailDTOGenerator;

    @Test
    void shouldReturnCorrectEmailTemplateId() {
        CaseData caseData = CaseData.builder().build();
        String expectedTemplateId = "dj-non-divergent-claimant-template";
        when(notificationsProperties.getNotifyDJNonDivergentSpecClaimantTemplate()).thenReturn(expectedTemplateId);
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("dj-non-divergent-applicant-notification-%s");
    }
    ...
    void shouldAddCustomProperties() {
        ...
        try (MockedStatic<NotificationUtils> notificationUtilsMockedStatic = Mockito.mockStatic(NotificationUtils.class)) {
            ...
            notificationUtilsMockedStatic.when(() -> NotificationUtils.getApplicantLegalOrganizationName(any(), any())).thenReturn("Legal Org");
