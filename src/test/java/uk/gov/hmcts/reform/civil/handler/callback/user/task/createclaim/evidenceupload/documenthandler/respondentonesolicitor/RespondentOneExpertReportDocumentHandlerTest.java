...
public class RespondentOneExpertReportDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentOneExpertReportDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyExpertReportDocumentsToLegalRep2() {
        ...
        CaseData caseData = CaseData.builder()
                .documentExpertReportRes(List.of(
        ...
        assertEquals(1, builder.build().getDocumentExpertReportRes2().size());
    }
