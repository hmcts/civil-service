...
public class DocUploadNotificationServiceTest {
    ...
    @InjectMocks private DocUploadNotificationService docUploadNotificationService;
    ...
    private static final String CUSTOM_PARTY_REFERENCE =
            "Claimant Reference: ABC Ltd - Defendant Reference: Defendant Ltd";
    ...
    class AboutToSubmitCallback {
        ...
        void lipApplicantNotificationShouldSendWhenInvoked_whenMainClaimIssuedInWelsh() {
            ...
            GeneralApplicationCaseData caseData =
                    getCaseData(true, YES, NO)
                            .copy()
                            .applicantBilingualLanguagePreference(YES)
                            .build();
            GeneralApplicationCaseData claimantClaimIssueFlag =
                    new GeneralApplicationCaseData()
                            .applicantBilingualLanguagePreference(YES)
                            .claimantBilingualLanguagePreference("WELSH")
                            .build();
            when(caseDetailsConverter.toGeneralApplicationCaseData(any()))
                    .thenReturn(claimantClaimIssueFlag);
            docUploadNotificationService.notifyApplicantEvidenceUpload(caseData);
            verify(notificationService, times(1))
                    .sendMail(
                            DUMMY_EMAIL,
        ...
        void lipRespondentNotificationShouldSend() {
            ...
            GASolicitorDetailsGAspec respondent1 =
                    new GASolicitorDetailsGAspec()
                            ...
                            .setSurname(Optional.of("surname"))
                            .setForename("forename")
                            .setOrganisationIdentifier("2");
            respondentSols.add(element(respondent1));

            GeneralApplicationCaseData caseData =
                    getCaseData(true, NO, YES)
                            .copy()
        ...
        private Map<String, String> getNotificationDataMapForLip(
                YesOrNo isLipAppln, YesOrNo isLipRespondent) {
        ...
        private Map<String, String> getNotificationDataMap(
                boolean customReferencePresent, boolean isLipCase) {
            ...
            if (isLipCase) {
                properties.put(
                        NotificationData.SPEC_UNSPEC_CONTACT,
                        "Email for Specified Claims: contactocmc@justice.gov.uk "
                                + "\n Email for Damages Claims: damagesclaims@justice.gov.uk");
            } else {
        ...
        private GeneralApplicationCaseData getCaseData(
                boolean isMet, YesOrNo isGaApplicantLip, YesOrNo isGaRespondentOneLip) {
            ...
            if (isMet) {
                ...
                return new GeneralApplicationCaseDataBuilder()
                        ...
                        .generalAppParentCaseLink(
                                new GeneralAppParentCaseLink().setCaseReference("1"))
