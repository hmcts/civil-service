...
class FeatureToggleServiceTest {
    ...
    void shouldReturnCorrectValue_whenMyFeatureIsEnabledOrDisabled(Boolean toggleState) {
        ...
        assertThat(featureToggleService.isFeatureEnabled("myFeature")).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenIsBulkClaimInvoked(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isBulkClaimEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenIsLipVLipInvoked(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isLipVLipEnabled()).isEqualTo(false);
    }

    @Test
    void shouldReturnCorrectValue_whenIsDashboardServiceInvoked() {
        assertThat(featureToggleService.isDashboardServiceEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenIsGeneralApplicationsEnabledInvoked(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isGeneralApplicationsEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenIsPinInPostEnabledInvoked(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isPinInPostEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenHmcIsEnabled(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isHmcEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenEnableRPAEmailsInvoked(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isRPAEmailEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenFastTrackUpliftsEnabled(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isFastTrackUpliftsEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenUpdateContactDetailsEnabled(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isUpdateContactDetailsEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenIsTransferCaseOnlineEnabled(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isTransferOnlineCaseEnabled()).isEqualTo(false);
    }
    ...
    @Test
    void shouldReturnCorrectValue_whenIsMintiEnabled() {
        assertThat(featureToggleService.isMintiEnabled()).isEqualTo(false);
    }
    ...
    void shouldReturnCorrectValue_whenIsCarmEnabled(Boolean toggleStat) {
        ...
        assertThat(featureToggleService.isCarmEnabledForCase(caseData)).isEqualTo(false);
    }
