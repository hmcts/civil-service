...
class RespondToDefenceSpecCallbackHandlerTest extends BaseCallbackHandlerTest {
    ...
    class AboutToStart {
        ...
        void shouldPopulateInitialData() {
            ...
            assertThat(response.getData()).extracting("respondent1Copy").isNotNull();
            assertThat(response.getData())
                    .extracting("claimantResponseScenarioFlag")
                    .isNotNull();
        }
        ...
        void shouldPopulateOnlyRespondent1Docs_whenInvokedAndSystemGeneratedContainsDQ() {
            ...
            // Given
            assertThat(response.getData())
                    .extracting("respondent1GeneratedResponseDocument")
                    .isNotNull();
            assertThat(response.getData())
                    .extracting("respondent2GeneratedResponseDocument")
                    .isNull();
        }
    ...
    class ValidateUnavailableDates {
        ...
        void shouldCheckDates_whenFastClaim() {
            CaseData caseData = CaseDataBuilder.builder().atStateRespondentFullDefence().build().toBuilder()
                    ...
                    .applicant1DQ(Applicant1DQ.builder()
                            .applicant1DQHearingLRspec(Hearing.builder().build())
                            .build())
                    .build();
            ...
            Mockito.verify(unavailableDateValidator)
                    .validateFastClaimHearing(caseData.getApplicant1DQ().getApplicant1DQHearingLRspec());
        }
        ...
        void shouldCheckDates_whenSmallClaim() {
            CaseData caseData = CaseDataBuilder.builder().atStateRespondentFullDefence().build().toBuilder()
                    ...
                    .applicant1DQ(Applicant1DQ.builder()
                            .applicant1DQSmallClaimHearing(
                                    SmallClaimHearing.builder().build())
                            .build())
                    .build();
            ...
            Mockito.verify(unavailableDateValidator)
                    .validateSmallClaimsHearing(caseData.getApplicant1DQ().getApplicant1DQSmallClaimHearing());
        }
    }
    ...
    class MidEventCallbackValidateExperts {
        ...
        void shouldReturnError_whenExpertRequiredAndNullDetails() {
            CaseData caseData = CaseDataBuilder.builder()
                    .applicant1DQ(Applicant1DQ.builder()
                            .applicant1DQExperts(
                                    Experts.builder().expertRequired(YES).build())
                            .build())
                    .build();
            CallbackParams params = callbackParamsOf(caseData, MID, PAGE_ID);
                    ...
                    .applicant1DQ(Applicant1DQ.builder()
                            .applicant1DQExperts(Experts.builder()
                                    ...
                                    .details(wrapElements(
                                            Expert.builder().name("test expert").build()))
                                    .build())
                            .build())
                    .build();
            CallbackParams params = callbackParamsOf(caseData, MID, PAGE_ID);
        ...
        void shouldReturnNoError_whenExpertNotRequired() {
            CaseData caseData = CaseDataBuilder.builder()
                    .applicant1DQ(Applicant1DQ.builder()
                            .applicant1DQExperts(
                                    Experts.builder().expertRequired(NO).build())
                            .build())
                    .build();
            CallbackParams params = callbackParamsOf(caseData, MID, PAGE_ID);
    ...
    class MidEventCallbackSetApplicantProceedFlag {
        ...
        void shouldSetApplicant1Proceed_whenPartAdmitApplicantRejectPaymentPlan() {
            ...
            assertThat(response.getData().get("applicant1ProceedWithClaim")).isEqualTo("Yes");
        }
        ...
        void shouldNotSetApplicant1Proceed_whenCaseIs2v1AndApplicantNotIntendsToProceed() {
            ...
            assertThat(response.getErrors()).isNull();
            assertThat(response.getData().get("applicant1ProceedWithClaim")).isEqualTo(null);
        }
        ...
        void shouldSetVulnerability_whenRejectAllAndProceed() {
            CaseData caseData = CaseDataBuilder.builder()
                    ...
                    .build();
            CallbackParams params = callbackParamsOf(CallbackVersion.V_2, caseData, MID, "set-applicant-route-flags");
    ...
    class MidStatementOfTruth {
        ...
        void shouldSetStatementOfTruthFieldsToNull_whenPopulated() {
            ...
            CaseData caseData = CaseDataBuilder.builder()
                    .uiStatementOfTruth(
                            StatementOfTruth.builder().name(name).role(role).build())
                    .build();
    ...
    class MidSugestInstalmentsValidation {
        ...
        void shouldreturnError_whenPopulated() {
            ...
            assertEquals(
                    "Enter a valid amount for equal instalments",
    ...
    class AboutToSubmitCallback {
        ...
        void setup() {
            ...
            Address address = Address.builder().postCode("E11 5BB").build();
        ...
        void shouldUpdateBusinessProcess_whenAtFullDefenceState(FlowState.Main flowState) {
            var params = callbackParamsOf(
                    CaseDataBuilder.builder().atState(flowState).build(), ABOUT_TO_SUBMIT);
        ...
        void shouldSetClaimantResponseDocs() {
            ...
            CaseData fullDefenceData =
                    CaseDataBuilder.builder().atState(FULL_DEFENCE_PROCEED).build();
            ...
            assertThat(actualCaseData.getApplicant1DQ().getApplicant1DQDraftDirections())
                    .isEqualTo(null);
                    ...
                    caseData.toBuilder()
                            ...
                            .applicant2DQ(Applicant2DQ.builder()
                                    .applicant2DQFileDirectionsQuestionnaire(
                                            caseData.getApplicant1DQ().getApplicant1DQFileDirectionsQuestionnaire())
                        ...
                        .applicant1DQ(Applicant1DQ.builder()
                                .applicant1DQRequestedCourt(RequestedCourt.builder()
                                        .responseCourtLocations(
                                                DynamicList.builder().build())
                                        .build())
                                .build())
                        .responseClaimTrack(FAST_CLAIM.name())
                        .caseManagementLocation(CaseLocationCivil.builder()
                                .baseLocation(handler.cnbcEpimsId)
                                .region("cnbc region")
                                .build())
                        .build();
        ...
        class ClaimTypeFlightDelay {
            ...
            void shouldUpdateCaseManagmentLocationIfAirlineNotOther() {
                ...
                when(courtLocationUtils.findPreferredLocationData(any(), any(DynamicList.class)))
                        .thenReturn(locationA);
                CaseLocationCivil flightLocation = CaseLocationCivil.builder()
                        .baseLocation("111000")
                        .region("2")
                        .build();

                List<AirlineEpimsId> airlineEpimsIDList = new ArrayList<>();
                airlineEpimsIDList.add(AirlineEpimsId.builder()
            ...
            void shouldUpdateCaseManagementLocatioToClaimantCourtIfAirlineOther() {
                ...
                DynamicList airlineList = DynamicList.builder()
                        ...
                        .value(DynamicListElement.builder()
                                ...
                                .build())
                        .build();
                CaseLocationCivil requestCourt = CaseLocationCivil.builder()
                        .baseLocation("111000")
                        .region("2")
                        .build();
        ...
        class UpdateExperts {
            ...
            void updateApplicant1Experts() {
                ...
                // Then
                assertThat(response.getData())
                        .extracting("applicant1ClaimExpertSpecRequired")
                        .isEqualTo("Yes");
                assertThat(response.getData())
                        .extracting("applicant1DQExperts")
            ...
            void updateApplicant2Experts() {
                ...
                // Then
                assertThat(response.getData())
                        .extracting("applicantMPClaimExpertSpecRequired")
                        .isEqualTo("Yes");
                assertThat(response.getData())
                        .extracting("applicant2DQExperts")
                        .extracting("expertRequired")
                        .isEqualTo("Yes");
            }
        ...
        void shouldChangeCaseState_WhenApplicant1AcceptFullAdmitPaymentPlanSpecNoAndFlagV2() {
            ...
            CaseData caseData = CaseData.builder()
                    .applicant1AcceptFullAdmitPaymentPlanSpec(YesOrNo.NO)
                    .applicant1(
                            Party.builder().partyName("name").type(INDIVIDUAL).build())
                    .respondent1ClaimResponseTypeForSpec(RespondentResponseTypeSpec.FULL_ADMISSION)
                    .respondent1(Party.builder()
                            .primaryAddress(Address.builder().build())
                            .type(Party.Type.INDIVIDUAL)
        ...
        void shouldAssignCategoryId_frc_whenInvoked() {
            ...
            assertThat(updatedData
                            .getApplicant1DQ()
                            .getApplicant1DQFixedRecoverableCostsIntermediate()
                            .getFrcSupportingDocument()
                            .getCategoryID())
    ...
    class ConfirmationText {
        ...
        void summary_WhenProceeds() {
            ...
            CallbackParams params =
                    CallbackParamsBuilder.builder().of(SUBMITTED, caseData).build();

            SubmittedCallbackResponse response = (SubmittedCallbackResponse) handler.handle(params);

            assertThat(response.getConfirmationBody()).contains("contact you about what to do next");
            assertThat(response.getConfirmationHeader())
                    .contains("decided to proceed", caseData.getLegacyCaseReference());
        }
        ...
        void summary_WhenDoesNotProceed() {
            ...
            assertThat(response.getConfirmationBody()).contains("not to proceed");
            assertThat(response.getConfirmationHeader()).contains("not to proceed", caseData.getLegacyCaseReference());
        }
        ...
        void summary_when_all_finals_order_issued() {
            ...
            assertThat(response.getConfirmationHeader()).contains("Judgment Submitted");
        }
        ...
        class ConfTextLRBulkAdmission {
            ...
            void setUp() {
                ...
                buildConfirmationTask = new BuildConfirmationTask(List.of(), List.of(textGen));
            ...
            void summary_when_all_finals_order_issued_on_LR_bulk_admission() {
                ...
                CaseData caseData = CaseData.builder()
                        ...
                        .defenceAdmitPartPaymentTimeRouteRequired(IMMEDIATELY)
                        .respondToClaimAdmitPartLRspec(RespondToClaimAdmitPartLRspec.builder()
                                .whenWillThisAmountBePaid(LocalDate.now().plusDays(1))
                                .build())
                        .caseManagementLocation(CaseLocationCivil.builder()
                                .baseLocation("0123")
                                .region("0321")
                ...
                SubmittedCallbackResponse response =
                        (SubmittedCallbackResponse) respondToDefenceSpecCallbackHandler.handle(params);

                assertThat(response.getConfirmationBody()).contains("by selecting 'Request Judgment by Admission'");
            }
    ...
    class SetUpPaymentDateToStringField {
        ...
        void shouldSetUpPaymentDateToString() {
            ...
            given(deadlineCalculatorService.calculateExtendedDeadline(any(LocalDateTime.class), anyInt()))
                    .willReturn(whenWillPay);

            RespondToClaimAdmitPartLRspec respondToClaimAdmitPartLRspec = RespondToClaimAdmitPartLRspec.builder()
            ...
            assertThat(result)
                    .isEqualTo(whenWillPay.format(DateTimeFormatter.ofPattern("dd MMMM yyyy", Locale.ENGLISH)));
            assertThat(getCaseData(response).getResponseClaimTrack()).isNotNull();
        }
        ...
        void shouldSetUpPaymentDateToStringForPartAdmitPaid() {
            ...
            RespondToClaim respondToAdmittedClaim = RespondToClaim.builder()
                    .howMuchWasPaid(null)
        ...
        void shouldSetUpPaymentDateForResponseDateToString() {
            ...
            given(workingDayIndicator.isWorkingDay(any())).willReturn(true);
            LocalDate whenWillPay = LocalDate.now();
            given(deadlineCalculatorService.calculateExtendedDeadline(any(LocalDate.class), anyInt()))
                    .willReturn(whenWillPay);
    ...
    class MidEventCallbackValidateAmountPaidFlag {
        ...
        void shouldReturnError_whenPartialAmountPaid() {
            ...
            CCJPaymentDetails ccjPaymentDetails =
                    CCJPaymentDetails.builder().ccjPaymentPaidSomeOption(YES).build();
            ...
            assertThat(response.getErrors())
                    .contains("This feature is currently not available, please see guidance below");
        }
        ...
        @Test
        void shouldCheckValidateAmountPaid_withCcJPaymentDetailsWhenNoFixedCosts_BulkAdmissionsEnabled_sanity() {
    ...
    class MidEventCallbackSetUpCcjSummaryPage {
        ...
        void shouldSetTheJudgmentSummaryDetailsToProceedOnJoOnPartAdmitClaim() {
            ...
            CaseData caseData = CaseDataBuilder.builder().atStateNotificationAcknowledged().build().toBuilder()
                    ...
                    .totalInterest(interestAmount)
                    .respondent1ClaimResponseTypeForSpec(PART_ADMISSION)
                    .respondToAdmittedClaimOwingAmountPounds(BigDecimal.valueOf(4000))
                    .build();
            CallbackParams params = callbackParamsOf(V_1, caseData, MID, PAGE_ID);
    ...
    class MidEventCallbackSetMediationShowFlag {
        ...
        void shouldSetMediationShowFlag_whenGivenConditionMeets() {
            ...
            given(respondentMediationService.setMediationRequired(any()))
                    .willReturn(DefendantResponseShowTag.CLAIMANT_MEDIATION_ONE_V_ONE);
            CallbackParams params = callbackParamsOf(V_1, caseData, MID, PAGE_ID);

            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
            Set<DefendantResponseShowTag> showConditionFlags =
                    getCaseData(response).getShowConditionFlags();
        ...
        void shouldSetVulnerability_whenGivenConditionMeets() {
            given(respondentMediationService.setMediationRequired(any()))
                    .willReturn(DefendantResponseShowTag.VULNERABILITY);
            CaseData caseData = CaseDataBuilder.builder()
                    .atStateSpec1v1ClaimSubmitted()
                    .respondent1ClaimResponseTypeForSpec(PART_ADMISSION)
                    .applicant1AcceptAdmitAmountPaidSpec(YesOrNo.NO)
    ...
    class InstalmentsValidationCallback {
        ...
        void shouldReturnError_whenAmountIsZero() {
            ...
            CallbackParams params = callbackParamsOf(V_1, caseData, MID, PAGE_ID);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
            assertThat(response.getErrors().get(0)).isEqualTo("Enter an amount of £1 or more");
        }
        ...
        void shouldReturnError_whenAmountIsLarger() {
            ...
            CallbackParams params = callbackParamsOf(V_1, caseData, MID, PAGE_ID);
            var response = (AboutToStartOrSubmitCallbackResponse) handler.handle(params);
            assertThat(response.getErrors().get(0)).isEqualTo("Enter a valid amount for equal instalments");
        }
    ...
    class MidEventPaymentDate {
        ...
        void shouldReturnError_whenDateIsBefore() {
            ...
            assertThat(paymentDate)
                    .isEqualTo(formatLocalDateTime(LocalDateTime.now().plusDays(30), DATE));
        }
    }
    ...
    class MidValidateMediationUnavailabiltyDates {
        ...
        public void testValidateApplicantUnavailableDateWhenAvailabilityIsNo() {
            ...
            CaseData updatedCaseData = caseData.toBuilder()
                    .app1MediationAvailability(MediationAvailability.builder()
