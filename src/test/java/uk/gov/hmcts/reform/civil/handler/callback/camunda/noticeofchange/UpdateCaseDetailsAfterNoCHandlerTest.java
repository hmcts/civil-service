...
public class UpdateCaseDetailsAfterNoCHandlerTest extends BaseCallbackHandlerTest {
    ...
    private static final ContactInformation CONTACT_INFORMATION = ContactInformation.builder()
            ...
            .postCode("AB1 2XY")
            .county("My county")
            .dxAddress(List.of(DxAddress.builder().dxNumber("DX 12345").build()))
            .build();
    ...
    void setUp() {
        ...
        handler = new UpdateCaseDetailsAfterNoCHandler(
                mapper, coreCaseUserService, featureToggleService, organisationService);
    ...
    class AboutToSubmit {
        ...
        void shouldUpdateSolicitorDetails_afterNoCSubmittedByApplicantSolicitor1v1() {
            ...
            assertThat(updatedCaseData.getApplicantSolicitor1ServiceAddress()).isNull();
            ...
            assertThat(updatedCaseData.getApplicantSolicitor1PbaAccountsIsEmpty())
                    .isEqualTo(YES);
            ...
            assertThat(updatedCaseData.getApplicantSolicitor1UserDetails())
                    .isEqualTo(IdamUserDetails.builder()
            ...
            assertThat(updatedCaseData.getQmRespondentSolicitor1Queries().getPartyName())
                    .isEqualTo("Defendant");
        }
        ...
        void shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor1v1() {
            ...
            assertThat(updatedCaseData.getChangeOrganisationRequestField()).isNull();
            assertThat(updatedCaseData.getRespondentSolicitor1OrganisationDetails())
                    .isNull();
            assertThat(updatedCaseData.getRespondentSolicitor1ServiceAddress()).isNull();
            ...
            assertThat(updatedCaseData.getUnassignedCaseListDisplayOrganisationReferences())
                    .isEmpty();
            assertThat(updatedCaseData.getRespondentSolicitor1EmailAddress()).isEqualTo("requester@example.com");
        ...
        void shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor2In1v2DiffSolicitorToDiffSolicitor() {
            ...
            assertThat(updatedCaseData.getChangeOrganisationRequestField()).isNull();
            assertThat(updatedCaseData.getRespondentSolicitor2OrganisationDetails())
                    .isNull();
            assertThat(updatedCaseData.getRespondentSolicitor2ServiceAddress()).isNull();
            ...
            assertThat(updatedCaseData.getUnassignedCaseListDisplayOrganisationReferences())
                    .isEmpty();
            assertThat(updatedCaseData.getRespondentSolicitor2EmailAddress()).isEqualTo("requester@example.com");
        ...
        void shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor1v1Spec() {
            ...
            assertThat(updatedCaseData.getChangeOrganisationRequestField()).isNull();
            assertThat(updatedCaseData.getSpecAoSRespondentCorrespondenceAddressdetails())
                    .isNull();
        ...
        void shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor1v1LiPSpecForLiPNoC() {
            ...
            CaseData caseData = CaseDataBuilder.builder()
                    ...
                    .systemGeneratedCaseDocuments(wrapElements(
                            CaseDocument.builder().documentType(SEALED_CLAIM).build(),
            ...
            assertThat(updatedCaseData.getRespondentSolicitor1EmailAddress()).isEqualTo("requester@example.com");
            assertThat(updatedCaseData.getAnyRepresented()).isEqualTo(YES);
            assertThat(updatedCaseData.getRespondentSolicitorDetails().getOrgName())
                    .isEqualTo(ORGANISATION.getName());
            assertThat(updatedCaseData
                            .getRespondentSolicitorDetails()
                            .getAddress()
                            .getAddressLine1())
                    .isEqualTo(ORGANISATION.getContactInformation().get(0).getAddressLine1());
            assertThat(updatedCaseData
                            .getRespondentSolicitorDetails()
                            .getAddress()
                            .getAddressLine2())
                    .isEqualTo(ORGANISATION.getContactInformation().get(0).getAddressLine2());
            assertThat(updatedCaseData
                            .getRespondentSolicitorDetails()
                            .getAddress()
                            .getAddressLine2())
            ...
            assertThat(updatedCaseData
                            ...
                            .getAddress()
                            .getPostCode())
                    .isEqualTo(ORGANISATION.getContactInformation().get(0).getPostCode());
            assertThat(updatedCaseData
                            .getRespondentSolicitorDetails()
                            .getAddress()
                            .getCounty())
                    .isEqualTo(ORGANISATION.getContactInformation().get(0).getCounty());
            assertThat(updatedCaseData.getSystemGeneratedCaseDocuments().size()).isEqualTo(1);
        }

        @Test
        void
                shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor2In1v2DiffSolicitorToDiffSolicitorSpec() {
            CaseData caseData = CaseDataBuilder.builder()
                    .atStateClaimIssued()
                    .caseAccessCategory(CaseCategory.SPEC_CLAIM)
                    .multiPartyClaimTwoDefendantSolicitors()
        ...
        @Test
        void
                shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor2In1v2DiffSolicitorToSameSolicitorSpec() {
            CaseData caseData = CaseDataBuilder.builder()
                    .atStateClaimIssued()
                    .caseAccessCategory(CaseCategory.SPEC_CLAIM)
                    .multiPartyClaimTwoDefendantSolicitors()
        ...
        @Test
        void
                shouldUpdateSolicitorDetails_afterNoCSubmittedByRespondentSolicitor2In1v2SameSolicitorToDiffSolicitorSpec() {
            CaseData caseData = CaseDataBuilder.builder()
                    .caseAccessCategory(CaseCategory.SPEC_CLAIM)
                    .atStateClaimIssued()
                    .multiPartyClaimOneDefendantSolicitor()
        ...
        private void assertSolicitorReferences(
                boolean isApplicant,
                boolean isRespondent1,
                boolean respondent2Exists,
                CaseData caseData,
