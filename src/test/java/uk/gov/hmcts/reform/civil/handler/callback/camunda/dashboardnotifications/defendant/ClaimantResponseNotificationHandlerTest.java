    ...
    class AboutToSubmitCallback {
        ...
        void shouldRecordScenario_whenInvokedInJudicialReferralState(CaseState caseState, DashboardScenarios dashboardScenarios) {
            ...
            CallbackParams params = CallbackParamsBuilder.builder().of(ABOUT_TO_SUBMIT, caseData).request(
                CallbackRequest.builder().eventId(CREATE_DEFENDANT_DASHBOARD_NOTIFICATION_FOR_CLAIMANT_RESPONSE.name()).build()
            ).build();
            Map<String, Object> scenarioParams = new HashMap<>();
            scenarioParams.put("defendantAdmittedAmount", 100);
            scenarioParams.put("whenWillThisAmountBePaid", "11 January 2024");
        ...
        private static Stream<Arguments> provideCaseStateAndScenarioArguments() {
            return Stream.of(
                Arguments.of(CaseState.JUDICIAL_REFERRAL, DashboardScenarios.SCENARIO_AAA7_CLAIMANT_INTENT_PART_ADMIT_DEFENDANT)
