...
class GenerateAcknowledgementOfClaimSpecCallbackHandlerTest extends BaseCallbackHandlerTest {
    ...
    void setup() {
        ...
        when(toggleService.isLrSpecEnabled()).thenReturn(true);
    }
    ...
    void shouldReturnCorrectActivityId_whenRequested() {
        ...
        assertThat(handler.camundaActivityId(params))
            .isEqualTo("AcknowledgeClaimGenerateAcknowledgementOfClaimForSpec");
    }
}
