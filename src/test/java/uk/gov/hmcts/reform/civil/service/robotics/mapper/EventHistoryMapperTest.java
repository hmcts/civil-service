...
class EventHistoryMapperTest {
    ...
    class RespondentFullAdmission {
        ...
        @Test
        void shouldPrepareExpectedEvent_whenRespondent1AcknowledgesRespondent2AlreadyAcknowledged() {
            CaseData caseData = CaseDataBuilder.builder()
        ...
        @Test
        void shouldPrepareExpectedEvent_whenRespondent1AcknowledgesRespondent2NotAcknowledged() {
            CaseData caseData = CaseDataBuilder.builder()
        ...
        @Test
        void shouldPrepareExpectedEvent_whenRespondent2AcknowledgesRespondent1Acknowledged() {
            CaseData caseData = CaseDataBuilder.builder()
                .atStateNotificationAcknowledgedRespondent2()
                .addRespondent2(YES)
                .respondent2SameLegalRepresentative(NO)
                ...
                .respondent2AcknowledgeNotificationDate(LocalDateTime.now())
                .respondent1AcknowledgeNotificationDate(LocalDateTime.now().minusDays(2))
                .respondent1ResponseDeadline(LocalDateTime.now().plusDays(12))
                .respondent2ResponseDeadline(LocalDateTime.now().plusDays(14))
                .build();
