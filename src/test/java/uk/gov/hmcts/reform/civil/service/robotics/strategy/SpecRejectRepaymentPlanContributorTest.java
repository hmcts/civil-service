...
class SpecRejectRepaymentPlanContributorTest {
    ...
    private SpecRejectRepaymentPlanContributor contributor;
    ...
    void setUp() {
        ...
        contributor = new SpecRejectRepaymentPlanContributor(
            sequenceGenerator,
            formatter,
    ...
    void contributeAddsManualDeterminationEvent() {
        ...
        contributor.contribute(builder, base, null);
