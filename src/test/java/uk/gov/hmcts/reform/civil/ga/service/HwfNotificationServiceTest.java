...
public class HwfNotificationServiceTest {
    ...
    private static final String EMAIL_TEMPLATE_INVALID_HWF_REFERENCE =
            "test-hwf-invalidrefnumber-id";
    private static final String EMAIL_TEMPLATE_UPDATE_REF_NUMBER = "test-hwf-updaterefnumber-id";
    private static final String EMAIL_TEMPLATE_HWF_PARTIAL_REMISSION =
    ...
    private static final String EMAIL_TEMPLATE_MORE_INFO_HWF_BILINGUAL =
            "test-hwf-more-info-bilingual-id";
    private static final String EMAIL_TEMPLATE_INVALID_HWF_REFERENCE_BILINGUAL =
            "test-hwf-invalidrefnumber-bilingual-id";
    private static final String EMAIL_TEMPLATE_UPDATE_REF_NUMBER_BILINGUAL =
            "test-hwf-updaterefnumber-bilingual-id";
    private static final String EMAIL_TEMPLATE_HWF_PARTIAL_REMISSION_BILINGUAL =
            "test-hwf-partialRemission-bilingual-id";
    private static final String EMAIL_TEMPLATE_NO_REMISSION_BILINGUAL =
            "test-hwf-noremission-bilingual-id";
    private static final String EMAIL_TEMPLATE_HWF_PAYMENT_OUTCOME_WLESH =
            "test-hwf-paymentoutcome-welsh-id";
    ...
    @InjectMocks private HwfNotificationService service;

    private static final GeneralApplicationCaseData GA_CASE_DATA =
            GeneralApplicationCaseDataBuilder.builder()
                    ...
                    .generalAppApplnSolicitor(new GASolicitorDetailsGAspec().setEmail(EMAIL))
                    .build()
                    .copy()
                    ...
                    .generalAppHelpWithFees(
                            new HelpWithFees().setHelpWithFeesReferenceNumber(HWF_REFERENCE))
    ...
    private static final GeneralApplicationCaseData ADDITIONAL_CASE_DATA =
            GeneralApplicationCaseDataBuilder.builder()
                    .generalAppParentCaseLink(new GeneralAppParentCaseLink().setCaseReference("1"))
    ...
    private static final GeneralApplicationCaseData CIVIL_WELSH_CLA =
            new GeneralApplicationCaseData().claimantBilingualLanguagePreference("WELSH").build();
    private static final GeneralApplicationCaseData CIVIL_WELSH_DEF =
    ...
    void shouldNotifyApplicant_HwfOutcome_MoreInformation_Ga() {
        // Given
        HelpWithFeesDetails hwfeeDetails =
                new HelpWithFeesDetails().setHwfCaseEvent(MORE_INFORMATION_HWF_GA);
        ...
        HashMap<String, String> properties =
                new HashMap<>(
                        Map.of(
                                ...
                                HWF_MORE_INFO_DOCUMENTS_WELSH,
                                        getMoreInformationDocumentListStringWelsh(),
    ...
    void shouldNotifyApplicant_HwfOutcome_RefNumberUpdated_ClaimIssued() {
        // Given
        HelpWithFeesDetails hwfeeDetails =
                new HelpWithFeesDetails().setHwfCaseEvent(UPDATE_HELP_WITH_FEE_NUMBER_GA);
        GeneralApplicationCaseData caseData =
                GA_CASE_DATA
                        .copy()
                        .gaHwfDetails(hwfeeDetails)
    ...
    void shouldNotifyApplicant_HwfOutcome_InvalidRefNumber_ClaimIssued() {
        // Given
        HelpWithFeesDetails hwfeeDetails =
                new HelpWithFeesDetails().setHwfCaseEvent(INVALID_HWF_REFERENCE_GA);
        GeneralApplicationCaseData caseData =
                GA_CASE_DATA
                        .copy()
                        .gaHwfDetails(hwfeeDetails)
        ...
        HashMap<String, String> properties =
                new HashMap<>(
                        Map.of(
                                ...
                                GA_REFERENCE,
                                TYPE_OF_FEE,
                                FeeType.APPLICATION.getLabel(),
                                TYPE_OF_FEE_WELSH,
                                FeeType.APPLICATION.getLabelInWelsh(),
                                HWF_REFERENCE_NUMBER,
                                HWF_REFERENCE,
                                FEE_AMOUNT,
                                "5.00",
                                NO_REMISSION_REASONS,
                                NoRemissionDetailsSummary.INCORRECT_EVIDENCE.getLabel(),
                                NO_REMISSION_REASONS_WELSH,
                                NoRemissionDetailsSummary.INCORRECT_EVIDENCE.getLabelWelsh()));
        properties.put(
                NotificationDataGA.WELSH_CONTACT, "E-bost: ymholiadaucymraeg@justice.gov.uk");
        properties.put(
                NotificationDataGA.WELSH_HMCTS_SIGNATURE,
        ...
        HashMap<String, String> properties =
                new HashMap<>(
                        Map.of(
                                ...
                                GA_REFERENCE,
                                TYPE_OF_FEE,
                                FeeType.ADDITIONAL.getLabel(),
                                TYPE_OF_FEE_WELSH,
                                FeeType.ADDITIONAL.getLabelInWelsh(),
                                HWF_REFERENCE_NUMBER,
                                HWF_REFERENCE,
                                FEE_AMOUNT,
                                "5.00",
        ...
        HashMap<String, String> properties =
                new HashMap<>(
                        Map.of(
                                ...
                                feeType.getLabel(),
                                TYPE_OF_FEE_WELSH,
                                feeType.getLabelInWelsh(),
                                HWF_REFERENCE_NUMBER,
                                HWF_REFERENCE,
                                CASE_TITLE,
                                "Mr. John Rambo v Mr. Joe Doe",
                                APPLICANT_NAME,
                                "Mr. John Rambo"));
        properties.put(
                NotificationDataGA.WELSH_CONTACT, "E-bost: ymholiadaucymraeg@justice.gov.uk");
    ...
    private void mockNotificationPropertiesEnglish() {
        when(notificationsProperties.getNotifyApplicantForHwFMoreInformationNeeded())
                .thenReturn(EMAIL_TEMPLATE_MORE_INFO_HWF);
        when(notificationsProperties.getNotifyApplicantForHwfUpdateRefNumber())
                .thenReturn(EMAIL_TEMPLATE_UPDATE_REF_NUMBER);
        when(notificationsProperties.getNotifyApplicantForHwfInvalidRefNumber())
                .thenReturn(EMAIL_TEMPLATE_INVALID_HWF_REFERENCE);
        when(notificationsProperties.getNotifyApplicantForHwfPartialRemission())
                .thenReturn(EMAIL_TEMPLATE_HWF_PARTIAL_REMISSION);
        when(notificationsProperties.getNotifyApplicantForNoRemission())
                .thenReturn(EMAIL_TEMPLATE_NO_REMISSION);
        when(notificationsProperties.getNotifyApplicantForHwfPaymentOutcome())
                .thenReturn(EMAIL_TEMPLATE_HWF_PAYMENT_OUTCOME);
    }
    ...
    private void mockNotificationPropertiesBilingual() {
        when(notificationsProperties.getLipGeneralAppApplicantEmailTemplateInWelsh())
                .thenReturn(EMAIL_TEMPLATE_HWF_PAYMENT_OUTCOME_WLESH);
        when(notificationsProperties.getNotifyApplicantForHwFMoreInformationNeededWelsh())
                .thenReturn(EMAIL_TEMPLATE_MORE_INFO_HWF_BILINGUAL);
        when(notificationsProperties.getNotifyApplicantForHwfUpdateRefNumberBilingual())
                .thenReturn(EMAIL_TEMPLATE_UPDATE_REF_NUMBER_BILINGUAL);
        when(notificationsProperties.getNotifyApplicantForHwfInvalidRefNumberBilingual())
                .thenReturn(EMAIL_TEMPLATE_INVALID_HWF_REFERENCE_BILINGUAL);
        when(notificationsProperties.getNotifyApplicantForHwfPartialRemissionBilingual())
                .thenReturn(EMAIL_TEMPLATE_HWF_PARTIAL_REMISSION_BILINGUAL);
        when(notificationsProperties.getNotifyApplicantForHwfNoRemissionWelsh())
                .thenReturn(EMAIL_TEMPLATE_NO_REMISSION_BILINGUAL);
    }
}
