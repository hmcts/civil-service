...
public class HearingProcessRespSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private HearingProcessRespSolOneEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldAddCustomProperties() {
        ...
        hearingProcessHelperMockedStatic.when(() -> getRespSolOneReference(caseData))
            .thenReturn("REF123");
