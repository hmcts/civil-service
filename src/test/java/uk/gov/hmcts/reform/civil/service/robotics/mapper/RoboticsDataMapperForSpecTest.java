...
class RoboticsDataMapperForSpecTest {
    ...
    @Autowired
    RoboticsDataMapperForSpec mapper;
    ...
    void shouldMapToRoboticsCaseData_whenOrganisationPolicyIsPresentWithProvidedServiceAddress() {
        ...
        ContactInformation contactInformation = CONTACT_INFORMATION.toBuilder().addressLine1("line 1").build();
    ...
    void shouldMapToRoboticsCaseDataWhen2ndClaimantIsPresent() {
        ...
        RoboticsCaseDataSpec roboticsCaseData = mapper.toRoboticsCaseData(caseData);
        CustomAssertions.assertThat(roboticsCaseData).isEqualTo(caseData);
        assertThat(roboticsCaseData.getLitigiousParties()).hasSize(2);
    }
