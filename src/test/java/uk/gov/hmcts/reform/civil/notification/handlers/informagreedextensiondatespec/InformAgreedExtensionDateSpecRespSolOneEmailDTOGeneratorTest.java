...
class InformAgreedExtensionDateSpecRespSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private InformAgreedExtensionDateSpecRespSolOneEmailDTOGenerator generator;
    ...
    void shouldAddCustomProperties() {
        ...
        try (MockedStatic<NotificationUtils> notificationUtils = Mockito.mockStatic(NotificationUtils.class);
            ...
            assertThat(updatedProperties)
                ...
                .containsEntry(AGREED_EXTENSION_DATE, "01 September 2025");
        }
    }
}
