...
public class ClaimantResponseConfirmsNotToProceedRespSolTwoEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    private ClaimantResponseConfirmsNotToProceedRespSolTwoEmailDTOGenerator emailDTOGenerator;
