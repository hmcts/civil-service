...
class NotificationMediationUnsuccessfulClaimantLRHandlerTest extends BaseCallbackHandlerTest {
    ...
    class AboutToSubmitCallback {
        ...
        private static final String CARM_LIP_MAIL_TEMPLATE = "carm-test-notification-id";
        ...
        @Test
        void shouldSendNotificationToClaimantLr_1v2SS_forCARM_whenEventIsCalled() {
            when(featureToggleService.isCarmEnabledForCase(any())).thenReturn(true);
            //Given
            CaseData caseData = CaseData.builder()
                .respondent1(Party.builder().type(Party.Type.COMPANY).companyName(DEFENDANT_PARTY_NAME).build())
        ...
        @Test
        void shouldSendNotificationToClaimantLr_1v2DS_forCARM_whenEventIsCalled() {
            when(featureToggleService.isCarmEnabledForCase(any())).thenReturn(true);
            //Given
            CaseData caseData = CaseData.builder()
                .respondent1(Party.builder().type(Party.Type.COMPANY).companyName(DEFENDANT_PARTY_NAME).build())
        ...
        @Test
        void shouldSendNotificationToClaimantLIP_1v1_forCARM_whenEventIsCalled() {
            when(featureToggleService.isCarmEnabledForCase(any())).thenReturn(true);
            //Given
            CaseData caseData = CaseData.builder()
        ...
        @Test
        void shouldNotSendNotificationToClaimantLr_ReasonDoesNotMatchList() {
            when(featureToggleService.isCarmEnabledForCase(any())).thenReturn(true);
            //Given
            CaseData caseData = CaseData.builder()
                .applicant1(Party.builder().type(Party.Type.COMPANY).companyName(APPLICANT_PARTY_NAME)
