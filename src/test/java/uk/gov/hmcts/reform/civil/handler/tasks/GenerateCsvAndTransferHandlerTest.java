    ...
    private CaseData getCaseData(Long ccdId, LocalDate claimMovedDate) {
        return CaseData.builder()
            ...
            .applicant1(new Party()
                            ...
                            .setCompanyName("Applicant company name")
                            .setPartyName("Applicant party name")
                            .setPartyPhone("0011001100")
                            .setPartyEmail("applicant@company.com"))
            .respondent1(new Party()
                             .setType(Party.Type.COMPANY)
                             .setCompanyName("Respondent company name")
                             .setPartyName("Respondent party name")
                             .setPartyPhone("0022002200")
