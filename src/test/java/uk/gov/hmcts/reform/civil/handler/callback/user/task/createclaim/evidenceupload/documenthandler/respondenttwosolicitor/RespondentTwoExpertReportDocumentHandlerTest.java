...
public class RespondentTwoExpertReportDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentTwoExpertReportDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldRenameDocumentsThroughHandleDocuments() {
        ...
        CaseData caseData = CaseData.builder()
                .documentExpertReportRes2(List.of(
