...
public class BundleCreationAppSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private BundleCreationAppSolOneEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("bundle-created-applicant-notification-%s");
    }
