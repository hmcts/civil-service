...
public class ApplicantOneScheduleOfCostsDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantOneScheduleOfCostsDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyScheduleOfCostsDocumentsToLegalRep2() {
        ...
        UploadEvidenceDocumentType uploadEvidenceDocumentType = UploadEvidenceDocumentType.builder()
                ...
                .bundleName("ScheduleOfCostsBundle")
                .documentUpload(document)
                .build();

        CaseData caseData = CaseData.builder()
                .documentCosts(List.of(
        ...
        assertEquals(1, builder.build().getDocumentCostsApp2().size());
    }
