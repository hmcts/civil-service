...
class RecordJudgmentCallbackHandlerTest extends BaseCallbackHandlerTest {
    ...
    void setup() {
        ...
        RecordJudgmentOnlineMapper recordJudgmentOnlineMapper = new RecordJudgmentOnlineMapper();
        handler = new RecordJudgmentCallbackHandler(objectMapper, recordJudgmentOnlineMapper);
    }
