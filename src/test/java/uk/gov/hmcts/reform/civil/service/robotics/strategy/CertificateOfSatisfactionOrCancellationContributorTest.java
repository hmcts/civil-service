...
class CertificateOfSatisfactionOrCancellationContributorTest {
    ...
    private CertificateOfSatisfactionOrCancellationContributor contributor;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        contributor = new CertificateOfSatisfactionOrCancellationContributor(featureToggleService, sequenceGenerator);
    }
