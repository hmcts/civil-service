...
public class ApplicantOneWitnessSummaryDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantOneWitnessSummaryDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyWitnessSummaryDocumentsToLegalRep2() {
        ...
        CaseData caseData = CaseData.builder()
                .documentWitnessSummary(List.of(
        ...
        assertEquals(1, builder.build().getDocumentWitnessSummaryApp2().size());
    }
