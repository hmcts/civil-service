...
import static uk.gov.hmcts.reform.civil.handler.callback.user.DefaultJudgementSpecHandler.*;
...
public class DefaultJudgementSpecHandlerTest extends BaseCallbackHandlerTest {
    ...
    class SubmittedCallback {
        ...
        @Test
        void shouldReturnJudgementRequestedResponse_whenJudgmentBufferAndJudgmentOnlineEnabledAndLrVLip() {
            when(featureToggleService.isJudgmentBufferEnabled()).thenReturn(true);
            when(featureToggleService.isJudgmentOnlineLive()).thenReturn(true);
