...
class GenerateCUIResponseSealedFormCallBackHandlerTest extends BaseCallbackHandlerTest {
    ...
    void shouldGenerateForm_whenIsLipVLipEnabledStitchingEnabled() {
        ...
        when(systemGeneratedDocumentService.getSystemGeneratedDocumentsWithAddedDocument(any(CaseDocument.class), any(CaseData.class))).thenReturn(documents);
        ...
        when(formGenerator.generate(any(CaseData.class), anyString())).thenReturn(FORM);
