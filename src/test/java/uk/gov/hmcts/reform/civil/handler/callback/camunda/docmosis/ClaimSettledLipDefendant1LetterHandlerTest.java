...
public class ClaimSettledLipDefendant1LetterHandlerTest extends BaseCallbackHandlerTest {
    ...
    void handleEventsReturnsTheExpectedCallbackEvent() {
        assertThat(handler.handledEvents()).contains(SEND_UNSPEC_CLAIM_SETTLED_LETTER_TO_LIP_DEFENDANT1);
    }

    @Test
    void shouldReturnCorrectCamundaActivityId_whenInvoked() {
        assertThat(handler.camundaActivityId(CallbackParamsBuilder.builder().request(CallbackRequest.builder().eventId(
                SEND_UNSPEC_CLAIM_SETTLED_LETTER_TO_LIP_DEFENDANT1.name()).build())
