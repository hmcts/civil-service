...
class NotifyClaimantHwFOutcomeRespSolOneEmailDTOGeneratorTest {

    private NotifyClaimantHwFOutcomeRespSolOneEmailDTOGenerator generator;
...
//        NotifyClaimantHwFOutcomeHelper helper = mock(NotifyClaimantHwFOutcomeHelper.class);
        generator = new NotifyClaimantHwFOutcomeRespSolOneEmailDTOGenerator(notificationsProperties);
    }
