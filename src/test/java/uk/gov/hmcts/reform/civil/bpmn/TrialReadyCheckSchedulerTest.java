...
class TrialReadyCheckSchedulerTest extends BpmnBaseTest {

    public static final String TOPIC_NAME = "TRIAL_READY_CHECK";

    public TrialReadyCheckSchedulerTest() {
        super("trial_ready_check_scheduler.bpmn", "TRIAL_READY_CHECK_SCHEDULER");
    }

    @Test
    void schedulerShouldRaiseTrialReadyCheckExternalTask_whenStarted() throws ParseException {
        ...
        String cronString = "0 30 0 * * ?";
        assertThat(jobDefinitions.get(0).getJobConfiguration()).isEqualTo("CYCLE: " + cronString);
        assertCronTriggerFiresAtExpectedTime(
            new CronExpression(cronString),
            LocalDateTime.of(2024, 11, 30, 0, 30, 0),
            LocalDateTime.of(2024, 12, 1, 0, 30, 0)
        );
