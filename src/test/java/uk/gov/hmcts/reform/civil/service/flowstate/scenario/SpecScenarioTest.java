...
class SpecScenarioTest {
    ...
    void appliesOnlyToSpec() {
        ...
        assertThat(scenario.appliesTo(spec, true)).isTrue();
        assertThat(scenario.appliesTo(spec, false)).isTrue();
        assertThat(scenario.appliesTo(unspec, true)).isTrue();
        assertThat(scenario.appliesTo(unspec, false)).isFalse();
    }
