...
import uk.gov.hmcts.reform.civil.handler.callback.user.createsdo.fieldsnihl.TrialWindowDateToNihlFieldValidator;
...
class TrialWindowDateToNihlFieldValidatorTest {

    @Mock
    private FieldsNihlUtils fieldsNihlUtils;

    @InjectMocks
    private TrialWindowDateToNihlFieldValidator validator;
    ...
    void shouldAddErrorWhenDateIsInThePast() {
        ...
        when(fieldsNihlUtils.validateFutureDate(caseData.getSdoR2Trial().getSdoR2TrialWindow().getDateTo()))
