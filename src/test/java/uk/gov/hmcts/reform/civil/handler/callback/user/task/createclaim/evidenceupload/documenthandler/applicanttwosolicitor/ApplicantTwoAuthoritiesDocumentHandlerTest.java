...
public class ApplicantTwoAuthoritiesDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantTwoAuthoritiesDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldNotRenameDocumentsIndirectlyThroughHandleDocuments() {
        ...
        CaseData caseData = CaseData.builder()
                .documentAuthoritiesApp2(List.of(
