...
class GaEventEmitterServiceTest {
    ...
    @Mock private RemoteProcessEngineException mockedRemoteProcessEngineException;

    @Mock private RuntimeService runtimeService;

    @Mock private MessageCorrelationBuilder messageCorrelationBuilder;
    ...
    void setup() {
        ...
        when(messageCorrelationBuilder.setVariable(any(), any()))
    ...
    void shouldSendMessageAndTriggerEvent_whenInvoked_withTenantId() {
        ...
        GeneralApplication generalApplication =
                new GeneralApplication().setBusinessProcess(businessProcess);
        ...
        verify(applicationEventPublisher)
                .publishEvent(new DispatchBusinessProcessEvent(1L, businessProcess));
    }
