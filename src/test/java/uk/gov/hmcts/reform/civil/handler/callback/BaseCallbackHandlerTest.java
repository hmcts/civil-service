...
public abstract class BaseCallbackHandlerTest {
    ...
    public CallbackParams callbackParamsOf(CaseData caseData,
        ...
        return new CallbackParams()
            ...
            .pageId(pageId)
            .request(CallbackRequest.builder()
                         .caseDetails(CaseDetails.builder().data(new HashMap<>()).id(CASE_ID).caseTypeId("CIVIL").build())
                         .caseDetailsBefore(CaseDetails.builder().data(new HashMap<>()).id(CASE_ID).caseTypeId("CIVIL").build())
                         .build())
            .caseData(caseData)
            .version(version)
            .params(params);
    ...
    public CallbackParams callbackParamsOf(CaseData caseData,
        ...
        return new CallbackParams()
            ...
            .pageId(pageId)
            .request(CallbackRequest.builder()
                         .caseDetails(CaseDetails.builder().data(new HashMap<>()).state(currentState.name()).id(CASE_ID).caseTypeId("CIVIL").build())
                         .caseDetailsBefore(CaseDetails.builder().data(new HashMap<>()).id(CASE_ID).caseTypeId("CIVIL").build())
                         .build())
            .caseData(caseData)
            .version(version)
