...
public class ClaimantResponseConfirmsNotToProceedRespSolOneEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    private ClaimantResponseConfirmsNotToProceedRespSolOneEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldAddCustomPropertiesWhenCaseIsSpecAndPartAdmitPayImmediatelyAccepted() {
        ...
        assertThat(updatedProperties.size()).isEqualTo(2);
        assertThat(updatedProperties).containsEntry(CLAIM_LEGAL_ORG_NAME_SPEC, legalOrg);
        assertThat(updatedProperties).containsEntry(CLAIM_DEFENDANT_LEGAL_ORG_NAME_SPEC, legalOrg);
    }
}
