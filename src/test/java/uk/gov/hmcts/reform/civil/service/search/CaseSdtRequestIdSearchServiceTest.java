...
class CaseSdtRequestIdSearchServiceTest {
    ...
    @InjectMocks
    private CaseSdtRequestIdSearchService caseSdtRequestIdSearchService;

    private SearchResult searchResult;

    private static final String REFERENCE = "ABC";
    private static final Query EXPECTED_QUERY =
        new Query(boolQuery().must(matchQuery("data.sdtRequestId", REFERENCE)), List.of(), 0);
    ...
    @Test
    void shouldReturnFalse_whenCaseIsNotFound() {
