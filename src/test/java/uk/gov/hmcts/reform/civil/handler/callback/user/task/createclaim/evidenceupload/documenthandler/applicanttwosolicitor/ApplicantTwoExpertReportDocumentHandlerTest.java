...
public class ApplicantTwoExpertReportDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantTwoExpertReportDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldRenameDocumentsThroughHandleDocuments() {
        ...
        CaseData caseData = CaseData.builder()
                .documentExpertReportApp2(List.of(
