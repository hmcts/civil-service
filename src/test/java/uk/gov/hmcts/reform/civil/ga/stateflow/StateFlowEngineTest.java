...
public class StateFlowEngineTest {
    ...
    @InjectMocks private GaStateFlowEngine stateFlowEngine;
    ...
    void shouldReturnApplicationSubmittedWhenPBAPaymentIsFailed() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder().buildPaymentFailureCaseData().build();
    ...
    void shouldReturnApplicationSubmittedWhenPBAPaymentIsSuccess() {
        ...
        assertThat(stateFlow.getStateHistory())
                ...
                .containsExactly(
                        DRAFT.fullName(),
                        APPLICATION_SUBMITTED.fullName(),
    ...
    void shouldReturn_Listed_For_Hearing_WhenJudgeMadeDecision() {
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .buildPaymentSuccessfulCaseData()
                        .copy()
    ...
    @Test
    void
            shouldReturnApplicationSubmittedWhenPBAPaymentIsSuccess_SetWelshFlowFlagForRespondentLip() {
        when(featureToggleService.isGaForWelshEnabled()).thenReturn(true);
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .withNoticeCaseData()
    ...
    @Test
    void
            shouldReturnApplicationSubmittedWhenPBAPaymentIsSuccess_DontSetWelshFlowFlagForRespondentLip() {
        when(featureToggleService.isGaForWelshEnabled()).thenReturn(true);
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .withNoticeCaseData()
    ...
    @Test
    void
            shouldReturnApplicationSubmittedWhenPBAPaymentIsSuccess_DontSetWelshFlowFlagForApplicantLip() {
        when(featureToggleService.isGaForWelshEnabled()).thenReturn(true);
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .withNoticeCaseData()
