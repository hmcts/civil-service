...
public class RespondToApplicationHandlerTest extends BaseCallbackHandlerTest {
    ...
    void shouldReturn_Awaiting_Respondent_Response_1Def_2Responses() {
        ...
        when(caseDetailsConverter.toCaseDataGA(civil))
        ...
        when(caseDetailsConverter.toCaseDataGA(ga))
                .thenReturn(caseData);
    ...
    public CaseData getCivilCaseData(String applicantEmail, String respondent1SolEmail, String respondent2SolEmail) {
