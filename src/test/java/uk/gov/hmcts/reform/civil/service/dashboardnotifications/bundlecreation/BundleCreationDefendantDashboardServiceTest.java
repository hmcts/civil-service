...
class BundleCreationDefendantDashboardServiceTest {
    ...
    @InjectMocks
    private BundleCreationDefendantDashboardService service;
    ...
    void shouldRecordScenarioForLipDefendant() {
        ...
        service.notifyBundleCreated(caseData, AUTH_TOKEN);

        verify(dashboardScenariosService).recordScenarios(
            eq(AUTH_TOKEN),
            eq(SCENARIO_AAA6_BUNDLE_CREATED_TRIAL_READY_DEFENDANT.getScenario()),
            eq("1234"),
