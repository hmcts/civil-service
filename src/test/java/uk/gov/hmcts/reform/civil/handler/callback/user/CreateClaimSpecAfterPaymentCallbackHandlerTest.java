...
class CreateClaimSpecAfterPaymentCallbackHandlerTest extends BaseCallbackHandlerTest {
    ...
    void setUp() {
        ...
        handler = new CreateClaimSpecAfterPaymentCallbackHandler(objectMapper);
    }
    ...
    void shouldRespondWithStateChanged() {
        ...
        assertThat(updatedData.getBusinessProcess().getCamundaEvent()).isEqualTo(CREATE_CLAIM_SPEC_AFTER_PAYMENT.name());
