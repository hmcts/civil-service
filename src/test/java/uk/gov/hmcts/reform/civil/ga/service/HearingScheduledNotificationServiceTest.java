...
public class HearingScheduledNotificationServiceTest {
    ...
    @InjectMocks private HearingScheduledNotificationService hearingScheduledNotificationService;
    ...
    private Map<String, String> getNotificationDataMap(boolean customEmailReference) {
        ...
        properties.put(
                NotificationDataGA.GA_HEARING_DATE,
                DateFormatHelper.formatLocalDate(GA_HEARING_DATE_SAMPLE, DateFormatHelper.DATE));
        properties.put(NotificationDataGA.GA_HEARING_TIME, GA_HEARING_TIME_SAMPLE.toString());
        properties.put(
                NotificationDataGA.PARTY_REFERENCE,
                customEmailReference ? CUSTOM_PARTY_REFERENCE : PARTY_REFERENCE);
        properties.put(
    ...
    void notificationShouldSendToDefendantsWhenInvoked() {
        ...
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .hearingScheduledApplication(YesOrNo.NO)
                        .build();
    ...
    void notificationShouldSendEmailReferenceWhenSolicitorReferenceisPresent() {
        ...
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        .hearingScheduledApplication(YesOrNo.NO)
                        .emailPartyReference(
                                "Claimant Reference: ABC limited - Defendant Reference: Defendant"
                                    + " Ltd")
                        .build();
        when(caseDetailsConverter.toGeneralApplicationCaseData(any()))
                .thenReturn(
