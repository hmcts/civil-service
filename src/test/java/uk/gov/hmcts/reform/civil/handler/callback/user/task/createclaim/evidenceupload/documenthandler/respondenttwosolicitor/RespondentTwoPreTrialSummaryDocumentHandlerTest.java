...
public class RespondentTwoPreTrialSummaryDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentTwoPreTrialSummaryDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldHandleDocumentsWithoutRenaming() {
        ...
        CaseData caseData = CaseData.builder()
                .documentCaseSummaryRes2(List.of(
