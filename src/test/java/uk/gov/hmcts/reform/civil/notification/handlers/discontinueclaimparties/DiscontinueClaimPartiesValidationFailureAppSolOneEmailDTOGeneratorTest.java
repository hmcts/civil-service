...
public class DiscontinueClaimPartiesValidationFailureAppSolOneEmailDTOGeneratorTest {
    ...
    private DiscontinueClaimPartiesValidationFailureAppSolOneEmailDTOGenerator generator;
    ...
    void setUp() {
        ...
        generator = new DiscontinueClaimPartiesValidationFailureAppSolOneEmailDTOGenerator(notificationsProperties, organisationService);
    ...
    void shouldReturnReferenceTemplate() {
        ...
        assertThat(result).isEqualTo("claimant-notify-validation-failure-%s");
    }
