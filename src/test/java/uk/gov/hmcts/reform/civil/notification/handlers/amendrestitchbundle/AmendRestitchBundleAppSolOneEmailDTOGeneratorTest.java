...
public class AmendRestitchBundleAppSolOneEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    private AmendRestitchBundleAppSolOneEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("amend-restitch-bundle-claimant-notification-%s");
    }
