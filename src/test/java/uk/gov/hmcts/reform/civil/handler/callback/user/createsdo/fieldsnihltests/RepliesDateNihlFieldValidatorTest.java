...
import uk.gov.hmcts.reform.civil.handler.callback.user.createsdo.fieldsnihl.RepliesDateNihlFieldValidator;
...
class RepliesDateNihlFieldValidatorTest {

    @Mock
    private FieldsNihlUtils fieldsNihlUtils;

    @InjectMocks
    private RepliesDateNihlFieldValidator validator;
    ...
    void shouldAddErrorWhenDateIsInThePast() {
        ...
        when(fieldsNihlUtils.validateFutureDate(caseData.getSdoR2EvidenceAcousticEngineer().getSdoRepliesDate()))
    ...
    void shouldNotAddErrorWhenDateIsInTheFuture() {
        CaseData caseData = CaseData.builder()
                .sdoR2EvidenceAcousticEngineer(SdoR2EvidenceAcousticEngineer.builder()
                        .sdoRepliesDate(LocalDate.now().plusDays(1))
                        .build())
                .build();
