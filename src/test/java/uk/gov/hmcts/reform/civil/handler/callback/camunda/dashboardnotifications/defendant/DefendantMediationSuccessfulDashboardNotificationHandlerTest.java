...
class DefendantMediationSuccessfulDashboardNotificationHandlerTest extends BaseCallbackHandlerTest {
    ...
    static final String TASK_ID = "GenerateDashboardNotificationDefendantMediationSuccessful";
    ...
    void createDashboardNotificationsWhenCarmIsDisabled() {
        ...
        CaseData caseData = CaseDataBuilder.builder().build();
        caseData.setLegacyCaseReference("reference");
        caseData.setCcdCaseReference(567L);
        caseData.setRespondent1Represented(YesOrNo.NO);
