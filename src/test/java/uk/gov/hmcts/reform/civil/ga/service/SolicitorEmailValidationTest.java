...
public class SolicitorEmailValidationTest {
    ...
    @InjectMocks private SolicitorEmailValidation solicitorEmailValidation;
    ...
    void shouldMatchIfThereIsNoChangeInGAApplicantEmailAndCivilApplicantEmail_1V1() {
        ...
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(DUMMY_EMAIL, DUMMY_EMAIL, DUMMY_EMAIL, null, null),
    ...
    void shouldMatchIfThereIsNoChangeInGARespondentEmailAndCivilRespondentEmail_1V1() {
        ...
        assertThat(
                        caseData.getGeneralAppRespondentSolicitors().stream()
                                .findFirst()
                                .get()
                                .getValue()
                                .getEmail())
    ...
    void shouldMatchRespondentOneEmailId_LRvsLIP() {
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(
                                DUMMY_EMAIL, DUMMY_EMAIL, DUMMY_EMAIL, null, CLAIM_DEF_LIP_EMAIL),
    ...
    void shouldMatchApplicantEmailId_LIPvsLR() {
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(
                                DUMMY_EMAIL, DUMMY_EMAIL, DUMMY_EMAIL, CLAIM_CL_LIP_EMAIL, null),
    ...
    void shouldMatchALlEmailId_LIPvsLIP_DEF() {
        ...
        assertThat(caseData.getGeneralAppApplnSolicitor().getEmail())
                .isEqualTo(CLAIM_DEF_LIP_EMAIL);
        assertThat(
                        caseData.getGeneralAppRespondentSolicitors().stream()
                                .findFirst()
    ...
    void shouldMatchIfThereIsNoChangeInGARespondentEmailAndCivilRespondentEmail_1V1_LIP() {
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(DUMMY_EMAIL, DUMMY_EMAIL, DUMMY_EMAIL, null, DUMMY_EMAIL),
                        getGaCaseData(NO, YES, NO, NO));
    ...
    void shouldMatchIfThereIsChangeInGAApplicantEmailAndCivilApplicantEmail_1V1() {
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(
                                "civilApplicant@gmail.com", DUMMY_EMAIL, DUMMY_EMAIL, null, null),
                        getGaCaseData(NO, YES, NO, NO));

        assertThat(caseData.getGeneralAppApplnSolicitor().getEmail())
                .isEqualTo("civilApplicant@gmail.com");
        assertThat(
                        caseData.getGeneralAppRespondentSolicitors().stream()
                                .findFirst()
                                .get()
    ...
    void shouldMatchIfThereIsChangeInGARespondentEmailAndCivilRespondentEmail_1V1() {
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(
                                DUMMY_EMAIL, "civilrespondent1@gmail.com", DUMMY_EMAIL, null, null),
                        getGaCaseData(NO, YES, NO, NO));
    ...
    void shouldMatchIfThereIsChangeInGARespondent1EmailAndCivilRespondentEmail_1V2() {
        ...
        assertThat(caseData.getGeneralAppApplnSolicitor().getEmail()).isEqualTo(DUMMY_EMAIL);
        assertThat(
                        checkIfThereIsMatchOrgIdAndEmailId(
                                caseData.getGeneralAppRespondentSolicitors(),
                                "2",
                                "civilrespondent1@gmail.com"))
                .isEqualTo(true);
    }
    ...
    void shouldMatchIfThereIsChangeInGARespondent2EmailAndCivilRespondentEmail_1V2() {
        GeneralApplicationCaseData caseData =
                solicitorEmailValidation.validateSolicitorEmail(
                        getCivilCaseData(
                                DUMMY_EMAIL, DUMMY_EMAIL, "civilrespondent2@gmail.com", null, null),
                        getGaCaseData(YES, YES, NO, NO));
        ...
        assertThat(
                        checkIfThereIsMatchOrgIdAndEmailId(
                                caseData.getGeneralAppRespondentSolicitors(),
                                "3",
                                "civilrespondent2@gmail.com"))
                .isEqualTo(true);
    }

    public boolean checkIfThereIsMatchOrgIdAndEmailId(
            List<Element<GASolicitorDetailsGAspec>> generalAppRespondentSolicitors,
            String orgID,
            String email) {

        return generalAppRespondentSolicitors.stream()
                .anyMatch(
                        rs ->
                                rs.getValue().getOrganisationIdentifier().equals(orgID)
                                        && rs.getValue().getEmail().equals(email));
    }

    private GeneralApplicationCaseData getCivilCaseData(
        ...
        if (Objects.nonNull(lipClEmail)) {
            builder.claimantUserDetails(new IdamUserDetails().setId("123").setEmail(lipClEmail));
        }
        if (Objects.nonNull(lipDefEmail)) {
            builder.defendantUserDetails(new IdamUserDetails().setId("1").setEmail(lipDefEmail));
        }
        return builder.build();
    }

    private GeneralApplicationCaseData getGaCaseData(
