...
class SummaryJudgmentContributorTest {
    ...
    private SummaryJudgmentContributor contributor;
    ...
    void setUp() {
        ...
        contributor = new SummaryJudgmentContributor(sequenceGenerator, formatter, timelineHelper);
