...
class SetAsideJudgmentContributorTest {
    ...
    private SetAsideJudgmentContributor contributor;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        contributor = new SetAsideJudgmentContributor(featureToggleService, sequenceGenerator);
    }
