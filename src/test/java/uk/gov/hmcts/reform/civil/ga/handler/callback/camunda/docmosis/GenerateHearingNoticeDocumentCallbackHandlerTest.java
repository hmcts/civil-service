...
class GenerateHearingNoticeDocumentCallbackHandlerTest
        extends GeneralApplicationBaseCallbackHandlerTest {

    @InjectMocks private GenerateHearingNoticeDocumentCallbackHandler handler;
    @Mock private GaHearingFormGenerator hearingFormGenerator;
    ...
    @Mock private SendFinalOrderPrintService sendFinalOrderPrintService;
    ...
    void shouldReturnCorrectActivityId_whenRequested() {
        assertThat(handler.camundaActivityId(new CallbackParams()))
                .isEqualTo("GenerateHearingNoticeDocument");
    }
    ...
    void shouldGenerateHearingNoticeDocumentWithCoverLetterTwice() {
        ...
        GeneralApplicationCaseData caseData =
                GeneralApplicationCaseDataBuilder.builder()
                        ...
                        .generalAppParentCaseLink(
                                new GeneralAppParentCaseLink().setCaseReference("1234"))
                        .build();
        CallbackParams params = callbackParamsOf(caseData, ABOUT_TO_SUBMIT);
        ...
        verify(sendFinalOrderPrintService, times(2))
                .sendJudgeFinalOrderToPrintForLIP(any(), any(), any(), any(), any());
    }
