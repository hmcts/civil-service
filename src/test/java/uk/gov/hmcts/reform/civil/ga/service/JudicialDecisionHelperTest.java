...
public class JudicialDecisionHelperTest {
    ...
    @InjectMocks private JudicialDecisionHelper helper;
    ...
    class IsApplicationCloakedTests {
        ...
        void isApplicationCloaked_shouldReturnNoWhenRespondentAgreementIsNull() {
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData().generalAppRespondentAgreement(null).build();
        ...
        void isApplicationCloaked_shouldReturnNoWhenRespondentAgreementHasAgreed() {
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
                            ...
                            .build();
            assertThat(helper.isApplicationCreatedWithoutNoticeByApplicant(caseData))
                    .isEqualTo(YES);
        }

        @Test
        void
                isApplicationCloaked_shouldReturnNoWhenRespondentAgreementHasNotAgreedButNotificationDetailsNotSet() {
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
                            .generalAppRespondentAgreement(
        ...
        void isLipApplicationCloaked_shouldReturnNoWhenGeneralAppInformOtherPartyIsNull() {
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
                            ...
                            .generalAppInformOtherParty(null)
                            .build();
            assertThat(helper.isLipApplicationCreatedWithoutNoticeByApplicant(caseData))
                    .isEqualTo(YES);
        }
    ...
    class IsApplicantAndRespondentLocationPrefSame {
        ...
        private DynamicList getDynamicLocationsList(
                String chosenValue, DynamicListElement... elements) {
    ...
    class IsApplicationUncloakedWithAdditionalFee {
        ...
        void shouldReturnFalse_WhenApplicationIsWithNoticeTypeRequestMoreInformation() {
            GeneralApplicationCaseData caseData =
                    GeneralApplicationCaseDataBuilder.builder()
                            .judicialDecisionWithUncloakRequestForInformationApplication(
                                    REQUEST_MORE_INFORMATION, NO, NO)
                            .build();
            assertThat(helper.isApplicationUncloakedWithAdditionalFee(caseData)).isFalse();
        }
