...
import uk.gov.hmcts.reform.civil.handler.callback.user.createsdo.fieldsnihl.JointMeetingOfExpertsDateNihlFieldValidator;
...
class JointMeetingOfExpertsDateNihlFieldValidatorTest {

    @Mock
    private FieldsNihlUtils fieldsNihlUtils;

    @InjectMocks
    private JointMeetingOfExpertsDateNihlFieldValidator validator;
    ...
    void shouldAddErrorWhenDateIsInThePast() {
        ...
        when(fieldsNihlUtils.validateFutureDate(caseData.getSdoR2PermissionToRelyOnExpert().getSdoJointMeetingOfExpertsDate()))
    ...
    void shouldNotAddErrorWhenDateIsInTheFuture() {
        CaseData caseData = CaseData.builder()
                .sdoR2PermissionToRelyOnExpert(SdoR2PermissionToRelyOnExpert.builder()
                        .sdoJointMeetingOfExpertsDate(LocalDate.now().plusDays(1))
                        .build())
                .build();
    ...
    void shouldNotAddErrorWhenDateIsNull() {
        CaseData caseData = CaseData.builder()
                .sdoR2PermissionToRelyOnExpert(SdoR2PermissionToRelyOnExpert.builder()
                        .sdoJointMeetingOfExpertsDate(null)
                        .build())
                .build();
