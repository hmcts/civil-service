...
import uk.gov.hmcts.reform.civil.ga.handler.callback.camunda.dashboardnotifications.applicationresponded.ApplicationRespondedDashboardTask;
import uk.gov.hmcts.reform.civil.ga.handler.callback.camunda.dashboardnotifications.applicationresponded.ApplicationRespondedDashboardTaskContributor;
...
import uk.gov.hmcts.reform.civil.ga.handler.callback.camunda.dashboardnotifications.finalorder.FinalOrderApplicantDashboardTask;
import uk.gov.hmcts.reform.civil.ga.handler.callback.camunda.dashboardnotifications.finalorder.GaFinalOrderDashboardTaskContributor;
import uk.gov.hmcts.reform.civil.ga.handler.callback.camunda.dashboardnotifications.finalorder.FinalOrderRespondentDashboardTask;
...
class GaDashboardTaskContributorsTest {
    ...
    void shouldRegisterGaContributorsWithExpectedTaskIds() {
        List<ContributorSpec> specs = List.of(
            ...
            new ContributorSpec(
                new GaFinalOrderDashboardTaskContributor(
                    mock(FinalOrderApplicantDashboardTask.class),
            ...
            new ContributorSpec(
                new ApplicationRespondedDashboardTaskContributor(
                    mock(ApplicationRespondedDashboardTask.class)
                ),
