...
import uk.gov.hmcts.reform.civil.notification.handlers.trialready.applicantnotifyotherstrialready.ApplicantNotifyOthersTrialReadyNotifier;
...
public class ApplicantNotifyOthersTrialReadyNotifierTest {
    ...
    @InjectMocks
    private ApplicantNotifyOthersTrialReadyNotifier applicantNotifyOthersTrialReadyNotifier;
    ...
    void shouldNotifyRespondent1_whenInvoked() {
        ...
        applicantNotifyOthersTrialReadyNotifier.notifyParties(caseData, "NOTIFY_EVENT", "ApplicantNotifyOthersTrialReadyNotifier");
    ...
    @Test
    void shouldNotifyRespondent1AndRespondent2_whenInvoked() {
