...
class GAJudgeRevisitTaskHandlerTest {
    ...
    void throwException_whenUnprocessableEntity() {
        ...
        assertEquals("GAJudgeRevisitTaskHandler failed: java.lang.IllegalArgumentException: "
                         ...
                         + "uk.gov.hmcts.reform.civil.model.CaseData$CaseDataBuilderImpl[\"generalAppConsentOrder\"])",
    ...
    void throwException_whenUnprocessableEntity_directionOrder() {
        ...
        assertThat(logsList.get(0).getMessage())
                .contains("Error GAJudgeRevisitTaskHandler::getDirectionOrderCaseReadyToJudgeRevisit")
                .contains("java.lang.IllegalArgumentException: Cannot deserialize value of type")
                .contains("uk.gov.hmcts.reform.civil.enums.YesOrNo")
                .contains("from String \"maybe\"")
                .contains("generalAppConsentOrder");
        logsList.get(0).getMessage();
        assertEquals(Level.ERROR, logsList.get(0).getLevel());
        listAppender.stop();
    }
