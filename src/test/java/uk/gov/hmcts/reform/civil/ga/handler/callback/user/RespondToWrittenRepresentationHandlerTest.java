...
public class RespondToWrittenRepresentationHandlerTest
    ...
    @InjectMocks private RespondToWrittenRepresentationHandler handler;

    @Mock private IdamClient idamClient;
    @Mock private RespondToWrittenRepresentationGenerator respondToWrittenRepresentationGenerator;
    ...
    class AboutToSubmit {
        ...
        void setup() {
            when(idamClient.getUserInfo(anyString()))
                    .thenReturn(UserInfo.builder().sub(DUMMY_EMAIL).uid(APP_UID).build());
        }
        ...
        void shouldPopulateDocListAndReturnNullWrittenRepUpload() {
            ...
            Document document1 =
                    new Document()
                            .setDocumentFileName(TEST_STRING)
                            .setDocumentUrl(TEST_STRING)
            ...
            Map<String, Object> dataMap =
                    objectMapper.convertValue(caseData, new TypeReference<>() {});
        ...
        void shouldNotCreateDashboardNotificationIfTranslationRequired() {
            ...
            handler.handle(params);
            verify(docUploadDashboardNotificationService, never())
                    .createDashboardNotification(
                            any(GeneralApplicationCaseData.class),
                            anyString(),
                            anyString(),
    ...
    private GeneralApplicationCaseData getCase(
            List<Element<Document>> generalAppWrittenRepUpload,
