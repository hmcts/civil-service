...
public class CreateApplicationTaskHandlerTest {
    ...
    @Mock private ExternalTask mockTask;
    ...
    @Mock private GaStateFlowEngine gaStateFlowEngine;

    @InjectMocks private CreateApplicationTaskHandler createApplicationTaskHandler;
    ...
    void init() {
        ...
        Map<String, Object> variables =
                Map.of("caseId", CASE_ID, "caseEvent", CREATE_GENERAL_APPLICATION_CASE.name());
        ...
        when(gaStateFlowEngine.evaluate(any(GeneralApplicationCaseData.class)))
    ...
    class CreateGAFor2V1and1V2SameSol {
        ...
        void shouldAddWithOutNoticeGaApplnToExistingClaimantCollection() {
            ...
            GeneralApplicationCaseData data =
                    buildDataWithExistingCollection(generalApplication, YES, NO);
        ...
        void shouldAddWithNoticeApplnToClaimantAndVisibleToAllCollections1V2() {
            ...
            GeneralApplicationCaseData data =
                    buildDataWithExistingCollection(generalApplication, NO, NO);
        ...
        void shouldAddWithoutNoticeApplnToRespondentOneCollection1V2SameSol() {
            GeneralApplication generalApplication =
                    getGeneralApplication("respondent1", NO, NO, NO, NO);
            GeneralApplicationCaseData data =
                    buildDataWithExistingCollection(generalApplication, NO, YES);
        ...
        private GeneralApplication getGeneralApplication(
            ...
            return builder.setParentClaimantIsApplicant(parentClaimantIsApplicant)
                    .setGeneralAppRespondentAgreement(
                            new GARespondentOrderAgreement().setHasAgreed(isRespAgreed))
                    ...
                    .setGeneralAppInformOtherParty(
                            new GAInformOtherParty()
                                    .setIsWithNotice(isWithoutNotice)
                                    .setReasonsForWithoutNotice(STRING_CONSTANT))
                    .setGeneralAppDateDeadline(DUMMY_DATE)
                    ...
                    .setIsMultiParty(YES)
                    .setIsDocumentVisibleGA(isDocumentVisible)
                    .setBusinessProcess(
                            new BusinessProcess()
                                    .setStatus(STARTED)
    ...
    class CreateGeneralApplication {
        ...
        void shouldAddApplicantSolListForWithoutNoticeAppln() {
            ...
            assertThat(data.getClaimantGaAppDetails()).hasSize(1);
            assertThat(data.getClaimantGaAppDetails())
                    .allMatch(element -> element.getValue().getParentClaimantIsApplicant() != null);
            assertThat(data.getRespondentSolTwoGaAppDetails()).isEmpty();
        ...
        void shouldAddRespondentOneSolListForWithoutNoticeAppln1v1Scenario() {
            ...
            assertThat(data.getRespondentSolGaAppDetails()).hasSize(1);
            assertThat(data.getRespondentSolGaAppDetails())
                    .allMatch(element -> element.getValue().getParentClaimantIsApplicant() != null);
            assertThat(data.getClaimantGaAppDetails()).isEmpty();
            assertThat(data.getRespondentSolTwoGaAppDetails()).isEmpty();
            assertThat(data.getGaDetailsMasterCollection()).isEmpty();
        ...
        void shouldAddApplicantSolListForWithoutNoticeApplnAndGeneralRespAgreed() {
            ...
            GeneralApplicationCaseData caseData =
                    buildOnlyData(generalApplication, NO, NO)
                            .copy()
                            .respondent1OrganisationPolicy(
                                    new OrganisationPolicy().setOrganisation(null))
                            .respondent1OrganisationIDCopy("respondent1")
                            .build();
            ...
            when(coreCaseDataService.caseDataContentFromStartEventResponse(
                            any(StartEventResponse.class), anyMap()))
            ...
            map.put(
                    ...
                    generalApplication.getGeneralAppDateDeadline());
            map.put("isDocumentVisible", generalApplication.getIsDocumentVisibleGA());
            ...
            GeneralApplicationCaseData data =
                    coreCaseDataService.submitUpdate(CASE_ID, caseDataContent);
        ...
        private GeneralApplication getGeneralApplication(
            ...
            return builder.setParentClaimantIsApplicant(parentClaimantIsApplicant)
                    .setGeneralAppRespondentAgreement(
                            new GARespondentOrderAgreement().setHasAgreed(isGeneralAppAgreed))
                    .setGeneralAppApplnSolicitor(
                            new GASolicitorDetailsGAspec()
                                    .setOrganisationIdentifier(organisationIdentifier))
                    .setGeneralAppInformOtherParty(
    ...
    class CreateGeneralApplicationCCDEvent {
        ...
        void shouldNotTriggerCCDEvent() {
            ...
            variables.putValue(
                    uk.gov.hmcts.reform.civil.handler.tasks.BaseExternalTaskHandler.FLOW_STATE,
                    "MAIN.DRAFT");
            ...
            verify(coreCaseDataService, times(1))
                    .startUpdate(CASE_ID, CREATE_GENERAL_APPLICATION_CASE);
        ...
        private GeneralApplication getGeneralApplication() {
            ...
            return builder.setGeneralAppInformOtherParty(
                            new GAInformOtherParty()
                                    .setIsWithNotice(NO)
                                    .setReasonsForWithoutNotice(STRING_CONSTANT))
                    .setGeneralAppDateDeadline(DUMMY_DATE)
                    ...
                    .setGeneralAppUrgencyRequirement(
                            new GAUrgencyRequirement()
                                    ...
                                    .setUrgentAppConsiderationDate(APP_DATE_EPOCH))
                    .setIsMultiParty(NO)
                    .setIsDocumentVisibleGA(NO)
                    .setParentClaimantIsApplicant(YES)
                    .setCaseNameGaInternal("applicant v respondent")
                    .setBusinessProcess(
                            new BusinessProcess()
                                    .setStatus(STARTED)
                                    .setProcessInstanceId(PROCESS_INSTANCE_ID)
    ...
    public List<Element<GeneralApplication>> getGeneralApplications(
            GeneralApplication generalApplication) {
        return wrapElements(generalApplication);
    }

    public GeneralApplicationCaseData buildDataWithExistingCollection(
            GeneralApplication generalApplication,
            YesOrNo addApplicant2,
    ...
    public GeneralApplicationCaseData buildData(
            GeneralApplication generalApplication,
            YesOrNo addApplicant2,
            YesOrNo respondent2SameLegalRepresentative,
    ...
    public GeneralApplicationCaseData buildData(
            ...
            YesOrNo respondent2SameLegalRepresentative,
            boolean addEvidenceDoc,
            boolean claimantBilingual,
            boolean defendantBilingual) {
        generalApplications = getGeneralApplications(generalApplication);
        generalApplicationsDetailsList = Lists.newArrayList();
        gaDetailsMasterCollection = Lists.newArrayList();
        gaDetailsRespondentSolList = Lists.newArrayList();
                ...
                new GeneralApplicationCaseDataBuilder()
                        ...
                        .businessProcess(
                                new BusinessProcess()
                                        ...
                                        .setProcessInstanceId(PROCESS_INSTANCE_ID))
                        .build();
        caseData = caseData.copy().generalAppEvidenceDocument(generalAppEvidenceDocument).build();
        caseData =
                caseData.copy()
    ...
    public GeneralApplicationCaseData buildOnlyData(
            GeneralApplication generalApplication,
            YesOrNo addApplicant2,
            YesOrNo respondent2SameLegalRepresentative) {
        generalApplications = getGeneralApplications(generalApplication);
