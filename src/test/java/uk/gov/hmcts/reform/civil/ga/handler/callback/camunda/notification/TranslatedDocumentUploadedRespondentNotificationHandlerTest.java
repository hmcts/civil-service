...
public class TranslatedDocumentUploadedRespondentNotificationHandlerTest
        extends GeneralApplicationBaseCallbackHandlerTest {

    @InjectMocks private TranslatedDocumentUploadedRespondentNotificationHandler handler;
    ...
    class AboutToSubmitCallback {
        ...
        void shouldSendNotificationLiPRespondentConsent_WhenParentCaseInEnglish() {
            ...
            verify(notificationService)
                    .sendMail(eq("respondent@gmail.com"), eq("template-id"), anyMap(), anyString());
        }
        ...
        void shouldSendNotificationLiPRespondentConsent_WhenParentCaseInWelsh() {
            ...
            when(notificationsProperties
                            .getNotifyRespondentLiPTranslatedDocumentUploadedWhenParentCaseInBilingual())
                    .thenReturn("template-id");
            CallbackParams params =
                    CallbackParamsBuilder.builder()
                            .of(ABOUT_TO_SUBMIT, caseData)
