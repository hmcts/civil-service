...
class ClaimantResponseContributorTest {
    ...
    @InjectMocks
    private ClaimantResponseContributor contributor;
    ...
    void shouldAddProceedEventsForUnspecClaim() {
        ...
        contributor.contribute(builder, caseData, "auth-token");
    ...
    void shouldAddMediationTextsForSmallClaimMediationScenario() {
        ...
        EventHistory.EventHistoryBuilder builder = EventHistory.builder();
        contributor.contribute(builder, caseData, "token");
