...
public class GaFeePaymentOutcomeHWFCallBackHandlerTest
        extends GeneralApplicationBaseCallbackHandlerTest {

    @Spy private ObjectMapper mapper = ObjectMapperFactory.instance();

    @InjectMocks private GaFeePaymentOutcomeHWFCallBackHandler handler;

    @Mock private GaPaymentRequestUpdateCallbackService service;
    @Mock private HwfNotificationService hwfNotificationService;
    ...
    class AboutToStartCallbackHandling {
        ...
        @Test
        void
                updateFeeType_shouldSetAdditionalFeeTypeWithEmptyRef_whenCaseStateIsApplicationAddPayment() {
            // Arrange
            ...
            assertThat(updatedData.getFeePaymentOutcomeDetails().getHwfNumberAvailable())
                    .isEqualTo(YesOrNo.NO);
        }

        @Test
        void
                updateFeeType_shouldSetAdditionalFeeTypeWithRef_whenCaseStateIsApplicationAddPayment() {
            // Arrange
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
                            .ccdState(CaseState.APPLICATION_ADD_PAYMENT)
                            ...
                            .generalAppHelpWithFees(
                                    new HelpWithFees().setHelpWithFeesReferenceNumber("123"))
                            .build();
            ...
            assertThat(updatedData.getFeePaymentOutcomeDetails().getHwfNumberForFeePaymentOutcome())
                    .isEqualTo("123");
        }

        @Test
        void
                updateFeeType_shouldSetApplicationFeeTypeWithEmptyRef_whenCaseStateIsNotApplicationAddPayment() {
            // Arrange
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
        ...
        @Test
        void
                updateFeeType_shouldSetApplicationFeeTypeWithRef_whenCaseStateIsNotApplicationAddPayment() {
            // Arrange
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
                            .ccdState(CaseState.AWAITING_RESPONDENT_RESPONSE)
    ...
    class MidCallback {
        ...
        void shouldValidationFeePaymentOutcomeGa_withInvalidOutstandingFee() {
            ...
            Assertions.assertThat(response.getErrors())
                    .containsExactly("Incorrect remission type selected");
        }
                    ...
                    new GeneralApplicationCaseData()
                            .feePaymentOutcomeDetails(
                                    new FeePaymentOutcomeDetails()
                                            .setHwfNumberAvailable(YesOrNo.YES)
                                            .setHwfNumberForFeePaymentOutcome("HWF-1C4-E34")
                                            .setHwfFullRemissionGrantedForAdditionalFee(
                                                    YesOrNo.YES))
                            .hwfFeeType(FeeType.ADDITIONAL)
    ...
    class AboutToSubmitCallback {
        ...
        void shouldTrigger_after_payment_GaFee() {
                                    ...
                                    new GeneralApplicationPbaDetails()
                                            .setFee(
                                                    new Fee()
                                                            ...
                                                            .setCode("OOOCM002")))
                            .generalAppHelpWithFees(
                                    new HelpWithFees().setHelpWithFeesReferenceNumber("ref"))
            ...
            when(service.processHwf(any(GeneralApplicationCaseData.class)))
                    .thenAnswer(
                            (Answer<GeneralApplicationCaseData>)
            ...
            verify(hwfNotificationService, times(1))
                    .sendNotification(any(), eq(FEE_PAYMENT_OUTCOME_GA));
            assertThat(updatedData.getBusinessProcess().getCamundaEvent())
                    .isEqualTo(INITIATE_GENERAL_APPLICATION_AFTER_PAYMENT.toString());
        }
        ...
        void shouldTrigger_after_payment_GaFee_shouldTriggerCosc() {
            ...
            verify(hwfNotificationService, times(1))
                    .sendNotification(any(), eq(FEE_PAYMENT_OUTCOME_GA));
            assertThat(updatedData.getBusinessProcess().getCamundaEvent())
                    .isEqualTo(INITIATE_COSC_APPLICATION_AFTER_PAYMENT.toString());
        }
        ...
        void shouldTrigger_modify_state_additioanlFee() {
            ...
            verify(hwfNotificationService, times(1))
                    .sendNotification(any(), eq(FEE_PAYMENT_OUTCOME_GA));
            assertThat(updatedData.getBusinessProcess().getCamundaEvent())
                    .isEqualTo(UPDATE_GA_ADD_HWF.toString());
        }
    }
}
