...
class TakenOfflineSpecDefendantNocContributorTest {
    ...
    @InjectMocks
    private TakenOfflineSpecDefendantNocContributor contributor;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        contributor = new TakenOfflineSpecDefendantNocContributor(
            sequenceGenerator,
