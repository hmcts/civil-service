...
public class ApplicantOneWitnessReferredDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantOneWitnessReferredDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyWitnessReferredDocumentsToLegalRep2() {
        ...
        UploadEvidenceDocumentType uploadEvidenceDocumentType = UploadEvidenceDocumentType.builder()
                ...
                .bundleName("WitnessReferredBundle")
                .documentUpload(document)
                .build();

        CaseData caseData = CaseData.builder()
                .documentReferredInStatement(List.of(
        ...
        assertEquals(1, builder.build().getDocumentReferredInStatementApp2().size());
    }
