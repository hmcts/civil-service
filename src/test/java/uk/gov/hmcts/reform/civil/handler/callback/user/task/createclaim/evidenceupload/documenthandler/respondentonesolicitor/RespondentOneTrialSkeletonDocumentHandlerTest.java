...
public class RespondentOneTrialSkeletonDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new RespondentOneTrialSkeletonDocumentHandler(documentTypeBuilder, uploadDocumentRetriever);
    }
    ...
    void shouldCopyTrialSkeletonDocumentsToLegalRep2() {
        ...
        CaseData caseData = CaseData.builder()
                .documentSkeletonArgumentRes(List.of(
        ...
        assertEquals(1, builder.build().getDocumentSkeletonArgumentRes2().size());
    }
    ...
    void shouldNotRenameDocuments() {
        ...
        assertEquals("OriginalName.pdf", caseData.getDocumentSkeletonArgumentRes().get(0).getValue().getDocumentUpload().getDocumentFileName());
    }
}