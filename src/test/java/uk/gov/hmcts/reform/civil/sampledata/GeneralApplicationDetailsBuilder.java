...
public class GeneralApplicationDetailsBuilder {
    ...
    public CaseData getTestCaseDataForUrgencyCheckMidEvent(CaseData caseData, boolean isApplicationUrgent,
        ...
        if (isApplicationUrgent) {
            ...
            gaUrgencyRequirement.setReasonsForUrgency(STRING_CONSTANT);
        } else {
            gaUrgencyRequirement.setGeneralAppUrgency(NO);
        }
        gaUrgencyRequirement.setUrgentAppConsiderationDate(urgencyConsiderationDate);
    ...
    public CaseData getTestCaseDataForApplicationFee(CaseData caseData, boolean isConsented,
        ...
        if (!isConsented) {
            caseDataBuilder.generalAppRespondentAgreement(new GARespondentOrderAgreement().setHasAgreed(NO))
                .generalAppInformOtherParty(new GAInformOtherParty().setIsWithNotice(isWithNotice ? YES : NO)
    ...
    private GeneralApplicationsDetails getGADetails(String applicationId, String caseState) {
        return new GeneralApplicationsDetails()
            ...
            .setCaseLink(new CaseLink().setCaseReference(applicationId))
    ...
    public CaseData getTestCaseDataWithEmptyCollectionOfApps(CaseData caseData) {
        ...
        return caseData.toBuilder()
            ...
            .solicitorReferences(SolicitorReferences.builder().applicantSolicitor1Reference("AppSol1Ref").respondentSolicitor1Reference(
                "RespSol1ref").build())
            ...
            .applicant1DQ(new Applicant1DQ()
                              .setApplicant1DQRequestedCourt(new RequestedCourt()
                                                                 ...
                                                                 .setCaseLocation(CaseLocationCivil.builder()
                                                                                      .region("2")
                                                                                      .baseLocation("00000")
                                                                                      .build())))
    ...
    public GeneralApplication getGeneralApplication(String key) {
        return getGeneralApplication().copy()
            .setCaseLink(new CaseLink().setCaseReference(key));
    }
    ...
    public GeneralApplication getGeneralApplication() {
        return new GeneralApplication()
            ...
            .setCaseLink(new CaseLink().setCaseReference("1234"))
            .setGeneralAppRespondentAgreement(new GARespondentOrderAgreement()
                                                  .setHasAgreed(NO))
            .setGeneralAppInformOtherParty(new GAInformOtherParty()
                                               .setIsWithNotice(YES)
            ...
            .setGeneralAppRespondentAgreement(new GARespondentOrderAgreement()
                                                  .setHasAgreed(NO))
            .setGeneralAppPBADetails(new GAPbaDetails()
                                         .setFee(Fee.builder().code("FEE_CODE").calculatedAmountInPence(BigDecimal.valueOf(
                                                 10800L))
                                                     .version("1").build()))
            .setGeneralAppDetailsOfOrder(STRING_CONSTANT)
            .setGeneralAppReasonsOfOrder(STRING_CONSTANT)
    ...
    public DynamicList getPreferredLoc() {
        DynamicList dynamicList = fromList(List.of(
            "ABCD - RG0 0AL",
            "PQRS - GU0 0EE",
            "WXYZ - EW0 0HE",
            "LMNO - NE0 0BH"
