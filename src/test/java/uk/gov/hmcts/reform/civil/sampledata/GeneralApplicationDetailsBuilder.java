...
public class GeneralApplicationDetailsBuilder {
        ...
        return caseData.toBuilder()
            ...
            .generalAppType(GAApplicationType.builder()
                ...
                .generalAppHearingDetails(GAHearingDetails.builder()
                        ...
                        .generalAppUnavailableDates(wrapElements(new GAUnavailabilityDates().setUnavailableTrialDateFrom(APP_DATE_EPOCH).setUnavailableTrialDateTo(APP_DATE_EPOCH)))
    ...
    public CaseData getTestCaseDataForApplicationFee(CaseData caseData, boolean isConsented,
        ...
        return caseDataBuilder
            ...
            .generalAppType(GAApplicationType.builder()
                ...
                .generalAppDetailsOfOrder(STRING_CONSTANT)
                .generalAppReasonsOfOrder(STRING_CONSTANT)
                .generalAppUrgencyRequirement(new GAUrgencyRequirement().setGeneralAppUrgency(YES).setReasonsForUrgency(STRING_CONSTANT))
                .generalAppStatementOfTruth(new GAStatementOfTruth().setName(STRING_CONSTANT).setRole(STRING_CONSTANT))
                .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
                .generalAppHearingDetails(GAHearingDetails.builder()
                        .judgeName(STRING_CONSTANT)
        ...
        return caseData.toBuilder()
            ...
            .respondent2OrganisationPolicy(new OrganisationPolicy()
                ...
                .generalAppHearingDetails(GAHearingDetails.builder()
                        ...
                        .trialRequiredYesOrNo(YES)
                        .hearingDetailsEmailID(STRING_CONSTANT)
                        .generalAppUnavailableDates(wrapElements(new GAUnavailabilityDates().setUnavailableTrialDateTo(APP_DATE_EPOCH).setUnavailableTrialDateFrom(APP_DATE_EPOCH)))
                        .supportRequirementOther(STRING_CONSTANT)
                        .hearingPreferredLocation(getPreferredLoc())
                        .hearingDetailsTelephoneNumber(STRING_NUM_CONSTANT)
                        .reasonForPreferredHearingType(STRING_CONSTANT)
        ...
        return caseData.toBuilder()
            ...
            .generalAppHearingDetails(GAHearingDetails.builder()
                                          ...
                                          .generalAppUnavailableDates(wrapElements(
                                              new GAUnavailabilityDates().setUnavailableTrialDateTo(APP_DATE_EPOCH).setUnavailableTrialDateFrom(APP_DATE_EPOCH)))
                                          .supportRequirementOther(STRING_CONSTANT)
                                          .hearingDetailsTelephoneNumber(STRING_NUM_CONSTANT)
                                          .reasonForPreferredHearingType(STRING_CONSTANT)
                                          .telephoneHearingPreferredType(STRING_CONSTANT)
    ...
    public CaseData getTestCaseDataForCaseManagementLocation(CaseCategory caseType, CaseState caseState) {
        return CaseData.builder()
            ...
            .generalAppHearingDetails(GAHearingDetails.builder()
                                          ...
                                          .trialRequiredYesOrNo(YES)
                                          .hearingDetailsEmailID(STRING_CONSTANT)
                                          .generalAppUnavailableDates(wrapElements(new GAUnavailabilityDates()
        ...
        CaseData.CaseDataBuilder<?, ?> builder = CaseData.builder()
            ...
            .generalAppHearingDetails(GAHearingDetails.builder()
                                          ...
                                          .generalAppUnavailableDates(
                                              wrapElements(new GAUnavailabilityDates().setUnavailableTrialDateFrom(APP_DATE_EPOCH).setUnavailableTrialDateTo(APP_DATE_EPOCH)))
                                          .supportRequirementOther(STRING_CONSTANT)
                                          .hearingPreferredLocation(DynamicList.builder().build())
                                          .hearingDetailsTelephoneNumber(STRING_NUM_CONSTANT)
                                          .reasonForPreferredHearingType(STRING_CONSTANT)
    ...
    public GeneralApplication getGeneralApplication() {
        ...
        return builder.generalAppType(GAApplicationType.builder()
                        ...
                        .build())
                .caseManagementLocation(new uk.gov.hmcts.reform.civil.model.genapplication.CaseLocationCivil()
                    .setBaseLocation("34567")
                    .setRegion("4"))
                .isCcmccLocation(YES)
                .caseLink(new CaseLink("1234"))
                .generalAppRespondentAgreement(GARespondentOrderAgreement.builder()
                        .hasAgreed(NO)
                        .build())
                .generalAppInformOtherParty(GAInformOtherParty.builder()
                ...
                .generalAppRespondentAgreement(GARespondentOrderAgreement.builder()
                        .hasAgreed(NO)
                        .build())
                .generalAppPBADetails(new GAPbaDetails().setFee(new Fee().setCode("FEE_CODE").setCalculatedAmountInPence(BigDecimal.valueOf(10800L))
                                .setVersion("1")))
                .generalAppDetailsOfOrder(STRING_CONSTANT)
                .generalAppReasonsOfOrder(STRING_CONSTANT)
                .generalAppInformOtherParty(GAInformOtherParty.builder()
