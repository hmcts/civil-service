...
public class GeneralApplicationDetailsBuilder {
    ...
    public CaseData getTestCaseDataForApplicationFee(CaseData caseData, boolean isConsented,
        ...
        if (!isConsented) {
            ...
            caseDataBuilder.generalAppRespondentAgreement(new GARespondentOrderAgreement().setHasAgreed(YES))
    ...
    public CaseData getTestCaseDataWithEmptyPreferredLocation(CaseData caseData) {
        ...
        return caseData.toBuilder()
            ...
            .generalAppHearingDetails(new GAHearingDetails()
                                          ...
                                          .setTrialRequiredYesOrNo(YES)
                                          .setHearingDetailsEmailID(STRING_CONSTANT)
                                          .setGeneralAppUnavailableDates(wrapElements(
    ...
    public CaseData getCaseDataForWorkAllocation(CaseState state,
        ...
        CaseData.CaseDataBuilder<?, ?> builder = CaseData.builder()
                ...
                .respondent1(new Party().setType(claimant1Type).setCompanyName("Respondent1"))
                .addApplicant2(YES)
                .applicant2(new Party().setType(Party.Type.COMPANY).setCompanyName("Applicant2"))
                .addRespondent2(YES)
                .respondent2(new Party().setType(Party.Type.COMPANY).setCompanyName("Respondent2"))
    ...
    public CaseData getCaseDataForWorkAllocation1V1(CaseState state,
        ...
        CaseData.CaseDataBuilder<?, ?> builder = CaseData.builder()
            ...
            .applicant1(new Party().setType(Party.Type.SOLE_TRADER).setCompanyName("Applicant1"))
            .respondent1(new Party().setType(respondent1Type).setCompanyName("Respondent1"))
            .addApplicant2(NO)
            .addRespondent2(NO)
            .generalAppType(new GAApplicationType().setTypes(singletonList(EXTEND_TIME)))
            .generalAppRespondentAgreement(new GARespondentOrderAgreement().setHasAgreed(NO))
            ...
            .generalAppHearingDetails(new GAHearingDetails()
                                          ...
                                          .setGeneralAppUnavailableDates(
                                              wrapElements(new GAUnavailabilityDates()
                                                               .setUnavailableTrialDateFrom(APP_DATE_EPOCH)
                                                               .setUnavailableTrialDateTo(APP_DATE_EPOCH)))
                                          .setSupportRequirementOther(STRING_CONSTANT)
                                          .setHearingPreferredLocation(new DynamicList())
    ...
    public CaseData getTestCaseDataCollectionOfApps(CaseData caseData) {
        GeneralApplication application = new GeneralApplication()
                                             ...
                                             .setGeneralAppUrgencyRequirement(new GAUrgencyRequirement()
                                                                                  ...
                                                                                  .setReasonsForUrgency(STRING_CONSTANT)
                                                                                  .setUrgentAppConsiderationDate(APP_DATE_EPOCH))
                                             .setGeneralAppStatementOfTruth(new GAStatementOfTruth().setName(STRING_CONSTANT).setRole(STRING_CONSTANT))
                                             .setGeneralAppEvidenceDocument(wrapElements(new Document()
                        .setDocumentUrl(STRING_CONSTANT)
                        .setDocumentBinaryUrl(STRING_CONSTANT)
                        .setDocumentFileName(STRING_CONSTANT)
                        .setDocumentHash(STRING_CONSTANT)))
    ...
    public GeneralApplication getGeneralApplication(String key) {
        return getGeneralApplication().copy()
                .setCaseLink(new CaseLink(key));
    }
    ...
    public GeneralApplication getGeneralApplication() {
        return new GeneralApplication()
                ...
                .setCaseManagementLocation(new uk.gov.hmcts.reform.civil.model.genapplication.CaseLocationCivil()
                ...
                .setGeneralAppRespondentAgreement(new GARespondentOrderAgreement().setHasAgreed(NO))
                .setGeneralAppPBADetails(new GAPbaDetails()
                                             .setFee(new Fee().setCode("FEE_CODE").setCalculatedAmountInPence(BigDecimal.valueOf(10800L))
                                .setVersion("1")))
                .setGeneralAppDetailsOfOrder(STRING_CONSTANT)
                .setGeneralAppReasonsOfOrder(STRING_CONSTANT)
                .setGeneralAppInformOtherParty(new GAInformOtherParty()
    ...
    public CaseData getTestCaseDataWithGeneralOrderPDFDocument(CaseData caseData) {
        ...
        return caseData.toBuilder()
            ...
            .generalAppType(new GAApplicationType().setTypes(singletonList(EXTEND_TIME)))
            .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
            .generalOrderDocument(singletonList(new Element<CaseDocument>().setId(UUID.fromString(uid)).setValue(pdfDocument)))
            .build();
    }
    ...
    public CaseData getTestCaseDataWithGeneralOrderStaffPDFDocument(CaseData caseData) {
        ...
        return caseData.toBuilder()
                ...
                .generalAppType(new GAApplicationType().setTypes(singletonList(EXTEND_TIME)))
                .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
                .generalOrderDocStaff(singletonList(new Element<CaseDocument>().setId(UUID.fromString(uid)).setValue(pdfDocument)))
                .build();
    }
    ...
    public CaseData getTestCaseDataWithDismissalOrderPDFDocument(CaseData caseData) {
        return caseData.toBuilder()
            ...
            .generalAppType(new GAApplicationType().setTypes(singletonList(EXTEND_TIME)))
            .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
            .dismissalOrderDocument(singletonList(new Element<CaseDocument>().setValue(pdfDocument)))
            .build();
    }
    ...
    public CaseData getTestCaseDataWithDismissalOrderStaffPDFDocument(CaseData caseData) {
        return caseData.toBuilder()
                ...
                .generalAppType(new GAApplicationType().setTypes(singletonList(EXTEND_TIME)))
                .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
                .dismissalOrderDocStaff(singletonList(new Element<CaseDocument>().setValue(pdfDocument)))
                .build();
    }
    ...
    public CaseData getTestCaseDataWithDirectionOrderPDFDocument(CaseData caseData) {
        ...
        return caseData.toBuilder()
            ...
            .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
            .generalOrderDocument(singletonList(new Element<CaseDocument>().setId(UUID.fromString(uid)).setValue(pdfDocument)))
            .directionOrderDocument(singletonList(new Element<CaseDocument>().setId(UUID.fromString(uid1)).setValue(pdfDocument)))
            .build();
    }
    ...
    public CaseData getTestCaseDataWithDirectionResponseDocument(CaseData caseData) {
        ...
        return caseData.toBuilder()
            ...
            .generalAppEvidenceDocument(wrapElements(new Document().setDocumentUrl(STRING_CONSTANT)))
            .generalOrderDocument(singletonList(new Element<CaseDocument>().setId(UUID.fromString(uid)).setValue(pdfDocument)))
            .gaRespDocument(singletonList(new Element<Document>().setId(UUID.fromString(uid1)).setValue(pdfDocument1)))
            .build();
    }
        ...
        return CaseData
                ...
                .respondent1OrganisationPolicy(new OrganisationPolicy()
                        .setOrganisation(new Organisation()
                                .setOrganisationID(STRING_CONSTANT))
                        .setOrgPolicyReference(STRING_CONSTANT))
                .generalAppType(new GAApplicationType().setTypes(singletonList(VARY_PAYMENT_TERMS_OF_JUDGMENT)))
                .generalAppRespondentAgreement(new GARespondentOrderAgreement().setHasAgreed(YES))
                .generalAppPBADetails(new GAPbaDetails())
                .generalAppDetailsOfOrder(STRING_CONSTANT)
                .generalAppReasonsOfOrder(STRING_CONSTANT)
