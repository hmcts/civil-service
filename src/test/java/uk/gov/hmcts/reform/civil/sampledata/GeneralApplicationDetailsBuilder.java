...
public class GeneralApplicationDetailsBuilder {
    ...
    public CaseData getTestCaseDataForConsentUnconsentCheck(GARespondentOrderAgreement respondentOrderAgreement) {
        return CaseData.builder()
            ...
            .ccdCaseReference(1234L)
            .respondent2OrganisationPolicy(organisationPolicy(STRING_CONSTANT, CaseRole.RESPONDENTSOLICITORTWO.getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .applicant1(Party.builder().type(Party.Type.COMPANY).companyName("Applicant1").build())
            .applicant1DQ(new Applicant1DQ()
                        .setApplicant1DQRequestedCourt(new RequestedCourt()
                                .setResponseCourtCode("applicant1DQRequestedCourt")
                ...
                .applicantSolicitor1UserDetails(IdamUserDetails.builder()
                        .id(STRING_CONSTANT)
                        .email(APPLICANT_EMAIL_ID_CONSTANT).build())
                .applicant1OrganisationPolicy(organisationPolicy(STRING_CONSTANT, CaseRole.APPLICANTSOLICITORONE.getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
                .respondent1OrganisationPolicy(organisationPolicy(STRING_CONSTANT, CaseRole.RESPONDENTSOLICITORONE.getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
                .respondentSolicitor1EmailAddress(RESPONDENT_EMAIL_ID_CONSTANT)
    ...
    public CaseData getTestCaseDataSPEC(CaseCategory claimType) {
        ...
        return CaseData.builder()
            ...
            .respondent2OrganisationPolicy(organisationPolicy(STRING_CONSTANT, CaseRole.RESPONDENTSOLICITORTWO
                                                                              .getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .applicant1(Party.builder().type(Party.Type.COMPANY).companyName("Applicant1").build())
            .respondent1(Party.builder().type(Party.Type.COMPANY).companyName("Respondent1").build())
            .addApplicant2(YES)
            .applicant2(Party.builder().type(Party.Type.COMPANY).companyName("Applicant2").build())
            ...
            .applicantSolicitor1UserDetails(IdamUserDetails.builder()
                                                .id(STRING_CONSTANT)
                                                .email(APPLICANT_EMAIL_ID_CONSTANT).build())
            .applicant1OrganisationPolicy(organisationPolicy(STRING_CONSTANT, CaseRole.APPLICANTSOLICITORONE
                                                                             .getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .respondent1OrganisationPolicy(organisationPolicy(STRING_CONSTANT, CaseRole.RESPONDENTSOLICITORONE
                                                                              .getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .respondentSolicitor1EmailAddress(RESPONDENT_EMAIL_ID_CONSTANT)
            .caseManagementLocation(caseManagementLoc)
            .build();
    ...
    public CaseData getCaseDataForWorkAllocation1V1(CaseState state,
        ...
        CaseData.CaseDataBuilder<?, ?> builder = CaseData.builder()
            ...
            .applicantSolicitor1UserDetails(IdamUserDetails.builder()
                                                .id(STRING_CONSTANT)
                                                .email(APPLICANT_EMAIL_ID_CONSTANT).build())
            .applicant1OrganisationPolicy(organisationPolicy(STRING_CONSTANT,
                                                  CaseRole.APPLICANTSOLICITORONE.getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .respondent1OrganisationPolicy(organisationPolicy(STRING_CONSTANT,
                                                   CaseRole.RESPONDENTSOLICITORONE.getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .respondentSolicitor1EmailAddress(RESPONDENT_EMAIL_ID_CONSTANT)
            .applicant1DQ(applicant1DQ)
            .respondent1DQ(respondent1DQ)
            .ccdState(state);
    ...
    public CaseData getMultiCaseDataForWorkAllocationForOne_V_Two(CaseState state,
        ...
        CaseData.CaseDataBuilder<?, ?> builder = CaseData.builder()
            ...
            .respondent2OrganisationPolicy(organisationPolicy(STRING_CONSTANT,
                                                   CaseRole.RESPONDENTSOLICITORTWO.getFormattedName()).setOrgPolicyReference(STRING_CONSTANT))
            .applicant1(Party.builder().type(claimant1Type).companyName("Applicant1").build())
            .respondent1(Party.builder().type(claimant1Type).companyName("Respondent1").build())
            .addRespondent2(YES)
            .respondent2(Party.builder().type(Party.Type.COMPANY).companyName("Respondent2").build())
