...
public class ApplyForHwFDashboardNotificationHandlerTest
    ...
    class AboutToSubmitCallback {
        ...
        void setup() {
            ...
            handler =
                    new ApplyForHwFDashboardNotificationHandler(
                            objectMapper, dashboardApiClient, mapper);
        }
            ...
            caseData =
                    caseData.copy()
                            ...
                            .generalAppHelpWithFees(
                                    new HelpWithFees()
                                            .setHelpWithFeesReferenceNumber("HWF-234-456"))
                    ...
                    CallbackParamsBuilder.builder()
                            ...
                            .request(
                                    CallbackRequest.builder()
                                            .eventId(NOTIFY_HELP_WITH_FEE.name())
                                            .build())
                            .build();
        ...
        void shouldRecordApplicantScenario_ApplyForHwFAdditionalApplicationFee_whenInvoked() {
            ...
            caseData =
                    caseData.copy()
                            ...
                            .generalAppHelpWithFees(
                                    new HelpWithFees()
                                            .setHelpWithFeesReferenceNumber("HWF-111-222"))
                            .isGaApplicantLip(YesOrNo.YES)
                            .build();
            ...
            GeneralApplicationCaseData updatedData =
                    objectMapper.convertValue(response.getData(), GeneralApplicationCaseData.class);
            assertEquals(
                    "additional", updatedData.getAdditionalHwfDetails().getHwfFeeType().getLabel());
            assertEquals(
                    "HWF-111-222", updatedData.getAdditionalHwfDetails().getHwfReferenceNumber());
