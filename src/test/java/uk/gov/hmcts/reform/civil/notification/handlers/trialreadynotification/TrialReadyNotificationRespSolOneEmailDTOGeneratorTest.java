...
class TrialReadyNotificationRespSolOneEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private TrialReadyNotificationRespSolOneEmailDTOGenerator emailDTOGenerator;
    ...
    void shouldReturnCorrectReferenceTemplate() {
        ...
        assertThat(referenceTemplate).isEqualTo("trial-ready-respondent-notification-%s");
    }
