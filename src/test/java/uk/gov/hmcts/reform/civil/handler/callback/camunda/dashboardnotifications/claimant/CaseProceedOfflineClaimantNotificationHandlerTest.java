...
class CaseProceedOfflineClaimantNotificationHandlerTest extends BaseCallbackHandlerTest {
    ...
    class AboutToSubmitCallback {
        ...
        @Test
        void shouldRecordScenarioForLipVsLr_whenInvokedInCaseProgression() {
            // Given
            CaseData caseData = CaseDataBuilder.builder().atStateRespondentFullAdmissionSpec().build();
            caseData.setRespondent1Represented(YesOrNo.YES);
            caseData.setApplicant1Represented(YesOrNo.NO);
        ...
        @Test
        void shouldRecordScenarioForLRvLip_whenInvokedInCaseProgression() {
            // Given
            CaseData caseData = CaseDataBuilder.builder().atStateRespondentFullAdmissionSpec().build();
            caseData.setRespondent1Represented(YesOrNo.NO);
        ...
        @Test
        void shouldRecordScenarioForLRvLip_whenInvokedWithoutCPEnabled() {
            // Given
            CaseData caseData = CaseDataBuilder.builder().atStateRespondentFullAdmissionSpec().build();
            caseData.setRespondent1Represented(YesOrNo.NO);
            caseData.setApplicant1Represented(YesOrNo.YES);
