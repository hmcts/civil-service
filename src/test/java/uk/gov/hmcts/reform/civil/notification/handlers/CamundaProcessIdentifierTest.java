...
class CamundaProcessIdentifierTest {
    ...
    void shouldContainAllExpectedEnumValues() {
        ...
        assertThat(values).hasSize(72)
            .contains(
                ...
                CamundaProcessIdentifier.TranslatedOrderNoticeUploadedNotifyParties
        );
    }
    ...
    void shouldGetEnumByOrdinal() {
        ...
        assertThat(values)
            ...
            .satisfies(v -> assertThat(v[70]).isEqualTo(CamundaProcessIdentifier.STANDARD_DIRECTION_ORDER_DJ_NOTIFY_PARTIES));
    }
}
