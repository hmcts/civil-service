...
class InformAgreedExtensionDateRespSolTwoEmailDTOGeneratorTest {
    ...
    @InjectMocks
    private InformAgreedExtensionDateRespSolTwoEmailDTOGenerator generator;
    ...
    void shouldAddCustomProperties() {
        LocalDateTime responseDeadline = LocalDateTime.of(2025, 8, 5, 9, 30);
        ...
        try (MockedStatic<NotificationUtils> notificationUtils = Mockito.mockStatic(NotificationUtils.class);
            ...
            assertThat(updatedProperties)
                ...
                .containsEntry(AGREED_EXTENSION_DATE, "05 August 2025")
