...
import uk.gov.hmcts.reform.civil.handler.callback.user.createsdo.fieldsnihl.InstructionOfTheExpertDateNihlFieldValidator;
...
class InstructionOfTheExpertDateNihlFieldValidatorTest {

    @Mock
    private FieldsNihlUtils fieldsNihlUtils;

    @InjectMocks
    private InstructionOfTheExpertDateNihlFieldValidator validator;
    ...
    void shouldAddErrorWhenDateIsInThePast() {
        ...
        when(fieldsNihlUtils.validateFutureDate(caseData.getSdoR2EvidenceAcousticEngineer().getSdoInstructionOfTheExpertDate()))
    ...
    void shouldNotAddErrorWhenDateIsInTheFuture() {
        CaseData caseData = CaseData.builder()
                .sdoR2EvidenceAcousticEngineer(SdoR2EvidenceAcousticEngineer.builder()
                        .sdoInstructionOfTheExpertDate(LocalDate.now().plusDays(1))
                        .build())
                .build();
    ...
    void shouldNotAddErrorWhenDateIsNull() {
        CaseData caseData = CaseData.builder()
                .sdoR2EvidenceAcousticEngineer(SdoR2EvidenceAcousticEngineer.builder()
                        .sdoInstructionOfTheExpertDate(null)
                        .build())
                .build();
        List<String> errors = new ArrayList<>();
