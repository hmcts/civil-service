...
public class TranslatedDocumentUploadedApplicantNotificationHandlerTest
        extends GeneralApplicationBaseCallbackHandlerTest {

    @InjectMocks private TranslatedDocumentUploadedApplicantNotificationHandler handler;
    ...
    class AboutToSubmitCallback {
        ...
        void shouldSendNotificationLiPApplicantConsent_WhenParentCaseInEnglish() {
            ...
            GeneralApplicationCaseData caseData =
                    new GeneralApplicationCaseData()
                            ...
                            .generalAppApplnSolicitor(
                                    new GASolicitorDetailsGAspec().setEmail("applicant@gmail.com"))
                            .isGaApplicantLip(YES)
                            .build();
            CaseDetails civil =
                    CaseDetails.builder().id(123L).data(Map.of("case_data", caseData)).build();
            ...
            verify(notificationService)
                    .sendMail(eq("applicant@gmail.com"), eq("template-id"), anyMap(), anyString());
        }
        ...
        void shouldSendNotificationLiPApplicantConsent_WhenParentCaseInWelsh() {
            ...
            when(caseDetailsConverter.toGeneralApplicationCaseData(any())).thenReturn(caseData);
            when(gaForLipService.isLipApp(caseData)).thenReturn(true);
            when(notificationsProperties
                            .getNotifyApplicantLiPTranslatedDocumentUploadedWhenParentCaseInBilingual())
                    .thenReturn("template-id");
            CallbackParams params =
                    CallbackParamsBuilder.builder()
                            .of(ABOUT_TO_SUBMIT, caseData)
        ...
        void shouldSendNotificationApplicantConsentForLR() {
            ...
            when(organisationService.findOrganisationById(any()))
                    .thenReturn(Optional.of(new Organisation().setName("LegalRep")));
            when(notificationsProperties.getNotifyLRTranslatedDocumentUploaded())
                    .thenReturn("template-id");
            CallbackParams params =
                    CallbackParamsBuilder.builder()
                            .of(ABOUT_TO_SUBMIT, caseData)
