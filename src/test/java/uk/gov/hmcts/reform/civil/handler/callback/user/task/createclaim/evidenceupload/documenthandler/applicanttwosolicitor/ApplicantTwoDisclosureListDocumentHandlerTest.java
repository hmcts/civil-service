...
public class ApplicantTwoDisclosureListDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantTwoDisclosureListDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldHandleDocumentsWithoutRenaming() {
        ...
        CaseData caseData = CaseData.builder()
                .documentDisclosureListApp2(List.of(
