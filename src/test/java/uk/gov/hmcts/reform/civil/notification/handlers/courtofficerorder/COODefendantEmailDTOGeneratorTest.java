...
import static uk.gov.hmcts.reform.civil.notification.handlers.courtofficerorder.COODefendantEmailDTOGenerator.COO_DEFENDANT_REFERENCE_TEMPLATE;

class COODefendantEmailDTOGeneratorTest {

    @Mock
    private NotificationsProperties notificationsProperties;

    @InjectMocks
    COODefendantEmailDTOGenerator emailGenerator;
