...
class ClaimantMediationUnsuccessfulDashboardNotificationHandlerTest extends BaseCallbackHandlerTest {

    @Mock
    private FeatureToggleService featureToggleService;

    @InjectMocks
    private ClaimantMediationUnsuccessfulDashboardNotificationHandler handler;
        ...
        assertThat(handler.camundaActivityId(
            CallbackParamsBuilder.builder()
                .request(CallbackRequest.builder()
                             .eventId(CREATE_DASHBOARD_NOTIFICATION_FOR_MEDIATION_UNSUCCESSFUL_FOR_APPLICANT.name())
                             .build())
                .build()))
            .isEqualTo(TASK_ID);
    }
