...
class GenerateDJFormRequestedRespSolOneEmailDTOGeneratorTest {

    public static final String TEMPLATE_ID = "template-id";
    private static final String DEFENDANT_LEGAL_ORG_NAME = "Test Legal Org";

    private GenerateDJFormRequestedRespSolOneEmailDTOGenerator generator;
    ...
    void setUp() {
        ...
        generator = new GenerateDJFormRequestedRespSolOneEmailDTOGenerator(
