...
public class ApplicantTwoWitnessStatementDocumentHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        handler = new ApplicantTwoWitnessStatementDocumentHandler(uploadDocumentRetriever);
    }
    ...
    void shouldHandleDocumentsWithRenaming() {
        ...
        CaseData caseData = CaseData.builder()
                .documentWitnessStatementApp2(List.of(
