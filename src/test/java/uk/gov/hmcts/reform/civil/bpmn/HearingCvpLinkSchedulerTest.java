...
class HearingCvpLinkSchedulerTest extends BpmnBaseTest {

    public static final String TOPIC_NAME = "HEARING_CVP_LINK";

    public HearingCvpLinkSchedulerTest() {
        super("hearing_cvp_link_scheduler.bpmn", "HEARING_CVP_LINK_SCHEDULER");
    }

    @Test
    void hearingCvpLinkSchedulerShouldFireCaseDismissedExternalTask_whenStarted() throws ParseException {
        ...
        String cronString = "0 50 0 * * ?";
        assertThat(jobDefinitions.get(0).getJobConfiguration()).isEqualTo("CYCLE: " + cronString);
        assertCronTriggerFiresAtExpectedTime(
            new CronExpression(cronString),
            LocalDateTime.of(2020, 1, 1, 0, 50, 0),
            LocalDateTime.of(2020, 1, 2, 0, 50, 0)
        );
