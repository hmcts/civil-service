...
public class RespondToJudgeAddlnInfoHandlerTest extends GeneralApplicationBaseCallbackHandlerTest {
    ...
    @InjectMocks private RespondToJudgeAddlnInfoHandler handler;

    @Mock IdamClient idamClient;
    @Mock RespondForInformationGenerator respondForInformationGenerator;
    @Mock DocUploadDashboardNotificationService docUploadDashboardNotificationService;
    ...
    private GeneralApplicationCaseData getCase(
            List<Element<Document>> generalAppAddlnInfoUpload,
