...
class HearingFeeUnpaidDefendantNotificationServiceTest {
    ...
    @Test
    void shouldRecordFastTrackScenarioWhenTrialReadyRespondentIsNull() {
    ...
    @Test
    void shouldRecordTrialReadyScenarioWhenTrialReadyRespondentIsNotNull() {
        CaseData caseData = CaseDataBuilder.builder().build();
        caseData.setRespondent1Represented(YesOrNo.NO);
        caseData.setCcdCaseReference(1234L);
        caseData.setDrawDirectionsOrderRequired(YesOrNo.NO);
