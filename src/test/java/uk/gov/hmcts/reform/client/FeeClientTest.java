...
@TestPropertySource(properties = {"fees.api.service=civil","fees.api.jurisdiction1=jurisdiction1","fees.api.jurisdiction2=jurisdiction2"})
class FeeClientTest {
    ...
    void shouldReturnFeeData_whenValidClaimValueWhenFeatureIsEnabled() {
        ...
        verify(feesApi).lookupFee("civil", "jurisdiction1", "jurisdiction2", CHANNEL, EVENT, "MoneyClaim", new BigDecimal("50.00"));
        assertThat(feeDto).isEqualTo(expectedFeeDto);
        //verify(feesClient).lookupFee(CHANNEL, EVENT, new BigDecimal("50.00"));
        //assertThat(feeDto).isEqualTo(expectedFeeDto);
    }
