...
public class DashboardNotificationServiceTest {
    ...
    class DeleteTests {
        ...
        void deleteNotificationsByNameAndReferenceAndCitizenRole() {
            ...
            dashboardNotificationService.deleteByNameAndReferenceAndCitizenRole(templateName, reference, role);
            var inOrder = Mockito.inOrder(dashboardNotificationsRepository);
            inOrder.verify(dashboardNotificationsRepository).deleteActionsByNameAndReferenceAndCitizenRole(templateName, reference, role);
            inOrder.verify(dashboardNotificationsRepository).deleteByNameAndReferenceAndCitizenRole(templateName, reference, role);
        }
    }
