...
import { heading, subheadings } from './second-defendant-solicitor-organisation-content';

@AllMethodsStep()
export default class SecondDefendantSolicitorOrganisationPage extends ExuiPage(BasePage) {
