export const heading = 'Do all of these statements apply to the Defendant?';

export const paragraphs = {
  descriptionText: 'Select if the statements all apply to the defendant',
};
...
export const checkboxes = {
  certifyStatement: {
    ...
    selector: '#CPRAcceptance_acceptance-CERTIFIED',
  },
};
