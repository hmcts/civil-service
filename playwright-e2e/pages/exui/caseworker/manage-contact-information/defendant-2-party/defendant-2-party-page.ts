...
export default class Defendant2PartyPage extends ExuiPage(BasePage) {
  ...
  async updateDefendant2Details(defendant2PartyType: ClaimantDefendantPartyType) {
    switch (defendant2PartyType.type) {
      ...
      case claimantDefendantPartyTypes.SOLE_TRADER.type:
        ...
        break;
      default:
        throw new Error(`Unsupported defendant party type: ${defendant2PartyType.type}`);
    }
