...
module.exports = {
  ...
  fields: {
    ...
    selectFacilitiesLaptop: '//input[@value="Laptop"]',
    selectFacilitiesCustodyCell: '//input[@value="Custody Cell"]',
    ...
    additionalInstructionsLink: '#additionalInstruction',
    additionalInstructionsTextArea: '#additionalInstructionsTextarea',
    paperHearingLink: '#paperHearing',
  ...
  async updateHearingValues() {
    ...
    await I.click(this.fields.selectFacilitiesLaptop);
    ...
    await I.click(this.fields.paperHearingLink);
    await I.see('Participant attendance');
    await I.clickContinue();
    ...
    await I.clickHearingHyperLinkOrButton(this.fields.additionalInstructionsLink);
    await I.see('Enter any additional instructions for the hearing');
    await I.fillField(this.fields.additionalInstructionsTextArea, 'Updated text generated by automation test');
    await I.clickContinue();
    await I.runAccessibilityTest();
  },
