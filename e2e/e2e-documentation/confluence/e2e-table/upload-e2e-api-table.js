...
const defaultPath = path.join(__dirname, '..', '..', 'results', 'e2e-data', 'e2e-api-data.json');
const jsonPath = jsonPathArg ? path.resolve(process.cwd(), jsonPathArg) : defaultPath;

updateConfluencePage({ jsonPath, targetHeadingText: 'API Tests', generateConfluenceTable });
