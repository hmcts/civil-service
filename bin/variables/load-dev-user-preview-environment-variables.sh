...
export CIVIL_SERVICE_URL="https://civil-service-${user}.preview.platform.hmcts.net"
...
export CCD_DEF_CASE_SERVICE_BASE_URL="https://civil-service-${user}.preview.platform.hmcts.net"
