...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=http://civil-damages-service-definition-store-staging-aat.service.core-compute-aat.internal"
echo "export CAMUNDA_BASE_URL=http://civil-damages-service-camunda-staging-aat.service.core-compute-aat.internal"
