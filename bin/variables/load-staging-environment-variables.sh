...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://civil-service-definition-store-staging-aat.service.core-compute-aat.internal"
...
echo "export CCD_DEF_GEN_APP_SERVICE_BASE_URL=http://civil-service-staging-java"
