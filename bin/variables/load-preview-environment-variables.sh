...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-ucmc-service-pr-${pr}.service.core-compute-preview.internal"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://ucmc-service-pr-${pr}.service.core-compute-preview.internal"
